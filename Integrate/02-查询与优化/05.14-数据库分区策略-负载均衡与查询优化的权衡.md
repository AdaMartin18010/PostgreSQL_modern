...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'orders') THEN
            RAISE WARNING '表 orders 不存在，无法查看分区信息';
            RETURN;
        END IF;
        RAISE NOTICE '开始查看分区信息';
    EXCEPTION
        WHEN OTHERS THEN
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'orders') THEN
            RAISE WARNING '表 orders 不存在，无法分析分区裁剪';
            RETURN;
        END IF;
        RAISE NOTICE '开始分析分区裁剪';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '查询准备失败: %', SQLERRM;
    END;
...
BEGIN
    BEGIN
        ...
        ELSE
            ...
            RAISE NOTICE '成功创建列表分区表 sales';
        END IF;
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '创建列表分区表失败: %', SQLERRM;
    END;
END $$;
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'sales') THEN
            RAISE EXCEPTION '主表 sales 不存在，无法创建分区';
        END IF;
        
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'sales_north') THEN
            CREATE TABLE sales_north PARTITION OF sales
            FOR VALUES IN ('North', 'Northeast', 'Northwest');
        END IF;
        
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'sales_south') THEN
            CREATE TABLE sales_south PARTITION OF sales
            FOR VALUES IN ('South', 'Southeast', 'Southwest');
        END IF;
        
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'sales_east') THEN
            CREATE TABLE sales_east PARTITION OF sales
            FOR VALUES IN ('East', 'Northeast', 'Southeast');
        END IF;
        
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'sales_west') THEN
            CREATE TABLE sales_west PARTITION OF sales
            FOR VALUES IN ('West', 'Northwest', 'Southwest');
        END IF;
        
        RAISE NOTICE '成功创建列表分区';
    EXCEPTION
        WHEN OTHERS THEN
...
BEGIN
    BEGIN
        ...
        ELSE
            ...
            RAISE NOTICE '成功创建哈希分区表 users';
        END IF;
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '创建哈希分区表失败: %', SQLERRM;
    END;
END $$;
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'users') THEN
            RAISE EXCEPTION '主表 users 不存在，无法创建分区';
        END IF;
        
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'users_0') THEN
            CREATE TABLE users_0 PARTITION OF users
            FOR VALUES WITH (MODULUS 4, REMAINDER 0);
        END IF;
        
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'users_1') THEN
            CREATE TABLE users_1 PARTITION OF users
            FOR VALUES WITH (MODULUS 4, REMAINDER 1);
        END IF;
        
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'users_2') THEN
            CREATE TABLE users_2 PARTITION OF users
            FOR VALUES WITH (MODULUS 4, REMAINDER 2);
        END IF;
        
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'users_3') THEN
            CREATE TABLE users_3 PARTITION OF users
            FOR VALUES WITH (MODULUS 4, REMAINDER 3);
        END IF;
        
        RAISE NOTICE '成功创建哈希分区';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '创建分区失败: %', SQLERRM;
    END;
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'users') THEN
            RAISE WARNING '表 users 不存在，无法查看数据分布';
            RETURN;
        END IF;
        RAISE NOTICE '开始查看哈希分区数据分布';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '查询准备失败: %', SQLERRM;
    END;
...
BEGIN
    BEGIN
        ...
        ELSE
            ...
            RAISE NOTICE '成功创建范围分区表 orders';
        END IF;
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '创建范围分区表失败: %', SQLERRM;
    END;
END $$;
...
BEGIN
    BEGIN
        ...
        RAISE NOTICE '成功创建月份分区';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '创建月份分区失败: %', SQLERRM;
    END;
END $$;
