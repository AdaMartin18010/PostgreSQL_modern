...
BEGIN
    ...
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '查询索引统计信息准备失败: %', SQLERRM;
            RAISE;
    END;
END $$;
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'employees') THEN
            RAISE WARNING '表 employees 不存在，无法查看索引使用效率';
            RETURN;
        END IF;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '查询索引使用效率准备失败: %', SQLERRM;
            RAISE;
    END;
END $$;
...
FROM pg_settings
WHERE name IN ('autovacuum', 'autovacuum_analyze_threshold', 'autovacuum_analyze_scale_factor');
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'employees') THEN
            RAISE WARNING '表 employees 不存在，无法演示顺序扫描代价';
            RETURN;
        END IF;
        RAISE NOTICE '开始演示顺序扫描代价估算';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '顺序扫描代价演示准备失败: %', SQLERRM;
            RAISE;
    END;
END $$;
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'employees') THEN
            RAISE WARNING '表 employees 不存在，无法演示索引扫描代价';
            RETURN;
        END IF;
        RAISE NOTICE '开始演示索引扫描代价估算';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '索引扫描代价演示准备失败: %', SQLERRM;
            RAISE;
    END;
END $$;
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'employees') THEN
            RAISE WARNING '表 employees 不存在，无法演示位图扫描代价';
            RETURN;
        END IF;
        RAISE NOTICE '开始演示位图扫描代价估算';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '位图扫描代价演示准备失败: %', SQLERRM;
            RAISE;
    END;
END $$;
    ...
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'employees') OR
           NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'departments') THEN
            RAISE WARNING '必需的表不存在，无法演示嵌套循环连接代价';
            RETURN;
        END IF;
        RAISE NOTICE '开始演示嵌套循环连接代价估算';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '嵌套循环连接代价演示准备失败: %', SQLERRM;
            RAISE;
    END;
END $$;
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'employees') OR
           NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'departments') THEN
            RAISE WARNING '必需的表不存在，无法演示哈希连接代价';
            RETURN;
        END IF;
        RAISE NOTICE '开始演示哈希连接代价估算';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '哈希连接代价演示准备失败: %', SQLERRM;
            RAISE;
    END;
END $$;
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'employees') OR
           NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'departments') THEN
            RAISE WARNING '必需的表不存在，无法演示合并连接代价';
            RETURN;
        END IF;
        RAISE NOTICE '开始演示合并连接代价估算';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '合并连接代价演示准备失败: %', SQLERRM;
            RAISE;
    END;
END $$;
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'employees') THEN
            RAISE WARNING '表 employees 不存在，无法演示哈希聚合代价';
            RETURN;
        END IF;
        RAISE NOTICE '开始演示哈希聚合代价估算';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '哈希聚合代价演示准备失败: %', SQLERRM;
            RAISE;
    END;
END $$;
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'employees') THEN
            RAISE WARNING '表 employees 不存在，无法演示排序聚合代价';
            RETURN;
        END IF;
        RAISE NOTICE '开始演示排序聚合代价估算';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '排序聚合代价演示准备失败: %', SQLERRM;
            RAISE;
    END;
END $$;
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'products') THEN
            RAISE WARNING '表 products 不存在，无法收集统计信息';
            RETURN;
        END IF;
        ANALYZE products;
        RAISE NOTICE '表 products 统计信息收集成功';
    EXCEPTION
        WHEN undefined_table THEN
            RAISE WARNING '表 products 不存在';
        WHEN OTHERS THEN
            RAISE WARNING '收集统计信息失败: %', SQLERRM;
            RAISE;
    END;
END $$;

-- 查看虚拟生成列的统计信息（带错误处理和性能测试）
DO $$
DECLARE
    stats_count INT;
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'products') THEN
            RAISE WARNING '表 products 不存在，无法查看虚拟生成列统计信息';
            RETURN;
        END IF;

        SELECT COUNT(*) INTO stats_count FROM pg_stats WHERE tablename = 'products' AND attname = 'final_price';
        IF stats_count = 0 THEN
            RAISE WARNING '虚拟生成列 final_price 的统计信息不存在';
            RETURN;
        END IF;
        RAISE NOTICE '找到虚拟生成列 final_price 的统计信息';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '查看虚拟生成列统计信息准备失败: %', SQLERRM;
            RAISE;
    END;
END $$;
...
-- 使用虚拟生成列进行查询优化（带错误处理和性能测试）
DO $$
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'products') THEN
            RAISE WARNING '表 products 不存在，无法演示虚拟生成列查询优化';
            RETURN;
        END IF;
        RAISE NOTICE '开始演示使用虚拟生成列进行查询优化';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '虚拟生成列查询优化演示准备失败: %', SQLERRM;
            RAISE;
    END;
END $$;
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'products') THEN
            RAISE WARNING '表 products 不存在，无法收集扩展统计信息';
            RETURN;
        END IF;
        ANALYZE products;
        RAISE NOTICE '表 products 扩展统计信息收集成功';
    EXCEPTION
        WHEN undefined_table THEN
            RAISE WARNING '表 products 不存在';
        WHEN OTHERS THEN
            RAISE WARNING '收集扩展统计信息失败: %', SQLERRM;
            RAISE;
    END;
END $$;

-- 查看多变量统计信息（带错误处理和性能测试）
DO $$
DECLARE
    stats_count INT;
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'products') THEN
            RAISE WARNING '表 products 不存在，无法查看多变量统计信息';
            RETURN;
        END IF;

        SELECT COUNT(*) INTO stats_count FROM pg_statistic_ext WHERE stxrelid = 'products'::regclass;
        IF stats_count = 0 THEN
            RAISE WARNING '表 products 没有多变量统计信息';
            RETURN;
        END IF;
        RAISE NOTICE '找到 % 个多变量统计信息', stats_count;
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '查看多变量统计信息准备失败: %', SQLERRM;
            RAISE;
    END;
END $$;
...
-- 查询优化器利用多变量统计信息（带错误处理和性能测试）
DO $$
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'products') THEN
            RAISE WARNING '表 products 不存在，无法演示多变量统计信息查询优化';
            RETURN;
        END IF;
        RAISE NOTICE '开始演示查询优化器利用多变量统计信息';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '多变量统计信息查询优化演示准备失败: %', SQLERRM;
            RAISE;
    END;
END $$;
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'products') THEN
            RAISE WARNING '表 products 不存在，无法查看直方图统计信息';
            RETURN;
        END IF;

        SELECT COUNT(*) INTO stats_count FROM pg_stats WHERE tablename = 'products' AND attname = 'price';
        IF stats_count = 0 THEN
            RAISE WARNING '列 price 的统计信息不存在';
            RETURN;
        END IF;
        RAISE NOTICE '找到列 price 的直方图统计信息';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '查看直方图统计信息准备失败: %', SQLERRM;
            RAISE;
    END;
END $$;
...
-- 配置更高的统计目标以获得更精细的直方图（带错误处理）
DO $$
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'products') THEN
            RAISE WARNING '表 products 不存在，无法配置统计目标';
            RETURN;
        END IF;
        ...
        IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema = 'public' AND table_name = 'products' AND column_name = 'price') THEN
            RAISE WARNING '列 price 不存在';
            RETURN;
        END IF;

        ALTER TABLE products ALTER COLUMN price SET STATISTICS 1000;
        RAISE NOTICE '列 price 的统计目标已设置为1000';
    EXCEPTION
        WHEN undefined_table THEN
            RAISE WARNING '表 products 不存在';
        WHEN undefined_column THEN
            RAISE WARNING '列 price 不存在';
        WHEN OTHERS THEN
            RAISE WARNING '配置统计目标失败: %', SQLERRM;
            RAISE;
    END;
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'products') THEN
            RAISE WARNING '表 products 不存在，无法查看更精细的直方图';
            RETURN;
        END IF;
        ...
        IF stats_count = 0 THEN
            ...
            RETURN;
        END IF;
        RAISE NOTICE '找到列 price 的更精细直方图统计信息';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '查看更精细直方图准备失败: %', SQLERRM;
            RAISE;
    END;
END $$;
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'products') THEN
            RAISE WARNING '表 products 不存在，无法查看表的修改统计';
            RETURN;
        END IF;

        SELECT COUNT(*) INTO table_count FROM pg_stat_user_tables WHERE tablename = 'products';
        IF table_count = 0 THEN
            RAISE WARNING '表 products 的统计信息不存在';
            RETURN;
        END IF;
        RAISE NOTICE '找到表 products 的修改统计信息';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '查看表的修改统计准备失败: %', SQLERRM;
            RAISE;
    END;
END $$;
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'products') THEN
            RAISE WARNING '表 products 不存在，无法配置自动统计信息更新阈值';
            RETURN;
        END IF;
        ...
        RAISE NOTICE '表 products 的自动统计信息更新阈值已配置';
    EXCEPTION
        WHEN undefined_table THEN
            RAISE WARNING '表 products 不存在';
        WHEN OTHERS THEN
            RAISE WARNING '配置自动统计信息更新阈值失败: %', SQLERRM;
            RAISE;
    END;
END $$;

-- 监控统计信息更新频率（带错误处理和性能测试）
DO $$
DECLARE
    table_count INT;
BEGIN
    BEGIN
        ...
        IF table_count = 0 THEN
            RAISE WARNING '未找到public schema下的表统计信息';
            RETURN;
        END IF;
        RAISE NOTICE '找到 % 个表的统计信息', table_count;
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '监控统计信息更新频率准备失败: %', SQLERRM;
            RAISE;
    END;
END $$;
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'large_table') THEN
            RAISE WARNING '表 large_table 不存在，无法演示统计信息收集性能对比';
            RETURN;
        END IF;
        RAISE NOTICE '开始演示大表统计信息收集性能对比';
        RAISE NOTICE '提示：传统同步I/O可能需要60秒，异步I/O（PostgreSQL 18）可能只需要20-30秒';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '统计信息收集性能对比演示准备失败: %', SQLERRM;
            RAISE;
    END;
END $$;
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'large_table') THEN
            RAISE WARNING '表 large_table 不存在，无法执行ANALYZE';
            RETURN;
        END IF;
        -- ANALYZE large_table;  -- 假设需要60秒（实际执行时取消注释）
        RAISE NOTICE '传统同步I/O ANALYZE large_table（假设需要60秒）';
    EXCEPTION
        WHEN undefined_table THEN
            RAISE WARNING '表 large_table 不存在';
        WHEN OTHERS THEN
            RAISE WARNING '执行ANALYZE失败: %', SQLERRM;
            RAISE;
    END;
END $$;

-- 异步I/O（PostgreSQL 18，带错误处理）
...
BEGIN
    BEGIN
        ...
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'large_table') THEN
            ...
            RETURN;
        END IF;
        -- ANALYZE large_table;  -- 性能提升2-3倍（实际执行时取消注释）
        RAISE NOTICE '异步I/O ANALYZE large_table（性能提升2-3倍，可能只需要20-30秒）';
    EXCEPTION
        WHEN undefined_table THEN
            RAISE WARNING '表 large_table 不存在';
        WHEN OTHERS THEN
...
BEGIN
    ...
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '监控统计信息收集性能准备失败: %', SQLERRM;
            RAISE;
    END;
END $$;
...
BEGIN
    BEGIN
        ...
        IF stats_count = 0 THEN
            RAISE WARNING '未找到public schema下的统计信息';
            RETURN;
        END IF;
        RAISE NOTICE '找到 % 条统计信息，开始质量评估', stats_count;
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '统计信息质量评估准备失败: %', SQLERRM;
            RAISE;
    END;
END $$;
...
BEGIN
    ...
    IF table_name !~ '^[a-zA-Z_][a-zA-Z0-9_]*$' THEN
        RAISE EXCEPTION '表名格式无效: %', table_name;
    END IF;
    ...
    EXCEPTION
        ...
        WHEN insufficient_privilege THEN
            RAISE EXCEPTION '权限不足，无法执行ANALYZE: %', table_name;
        WHEN OTHERS THEN
            RAISE EXCEPTION '更新统计信息失败: % (错误: %)', table_name, SQLERRM;
    END;
EXCEPTION
    WHEN OTHERS THEN
        RAISE EXCEPTION 'update_table_stats执行失败: %', SQLERRM;
END;
$$ LANGUAGE plpgsql;
        ...
        LOOP
            ...
            EXCEPTION
                WHEN OTHERS THEN
                    ...
                    RAISE WARNING '更新表 % 的统计信息失败: %', r.tablename, SQLERRM;
            END;
        END LOOP;

        RAISE NOTICE '批量更新统计信息完成: 成功 %, 失败 %', success_count, error_count;
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '批量更新统计信息失败: %', SQLERRM;
            RAISE;
    END;
END $$;
```
...
BEGIN
    ...
    EXCEPTION
        WHEN OTHERS THEN
            RAISE EXCEPTION '监控统计信息失败: %', SQLERRM;
    END;
EXCEPTION
    WHEN OTHERS THEN
        RAISE EXCEPTION 'monitor_stats执行失败: %', SQLERRM;
END;
$$;
...
BEGIN
    BEGIN
        ...
        IF result_count = 0 THEN
            RAISE WARNING '监控函数未返回任何结果';
        ELSE
            RAISE NOTICE '监控函数返回 % 条记录', result_count;
        END IF;
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '调用监控函数失败: %', SQLERRM;
            RAISE;
    END;
END $$;
...
BEGIN
    BEGIN
        ...
        ELSE
            ...
            RAISE NOTICE '表 large_table 创建成功';
        END IF;
    EXCEPTION
        WHEN duplicate_table THEN
            RAISE WARNING '表 large_table 已存在';
        WHEN OTHERS THEN
            RAISE WARNING '创建表 large_table 失败: %', SQLERRM;
            RAISE;
    END;
END $$;
...
BEGIN
    BEGIN
        ...
        IF partition_count = 0 THEN
            RAISE WARNING '未找到 log_entries 的分区表';
            RETURN;
        END IF;

        RAISE NOTICE '找到 % 个分区表，开始收集统计信息', partition_count;
        ...
        LOOP
            ...
            EXCEPTION
                WHEN undefined_table THEN
                    error_count := error_count + 1;
                    RAISE WARNING '分区表 %.% 不存在', r.schemaname, r.tablename;
                WHEN insufficient_privilege THEN
                    error_count := error_count + 1;
                    RAISE WARNING '权限不足，无法分析分区表 %.%', r.schemaname, r.tablename;
                WHEN OTHERS THEN
                    error_count := error_count + 1;
                    RAISE WARNING '分析分区表 %.% 失败: %', r.schemaname, r.tablename, SQLERRM;
            END;
        END LOOP;

        RAISE NOTICE '分区表统计信息收集完成: 成功 %, 失败 %', success_count, error_count;
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '为分区表收集统计信息失败: %', SQLERRM;
            RAISE;
    END;
END $$;
```
...
BEGIN
    ...
    IF p_target IS NULL THEN
        RAISE EXCEPTION '统计目标值不能为空';
    END IF;

    IF p_target < 0 OR p_target > 10000 THEN
        RAISE EXCEPTION '统计目标值必须在0-10000之间: %', p_target;
    END IF;
    ...
    BEGIN
        ...
        EXCEPTION
            ...
            WHEN undefined_column THEN
                RAISE EXCEPTION '列不存在: %.%', p_table_name, p_column_name;
            WHEN OTHERS THEN
                RAISE EXCEPTION '设置统计目标失败: %', SQLERRM;
        END;
        ...
        EXCEPTION
            WHEN insufficient_privilege THEN
                RAISE EXCEPTION '权限不足，无法执行ANALYZE: %', p_table_name;
            WHEN OTHERS THEN
                RAISE WARNING '执行ANALYZE失败: % (错误: %), 统计目标已设置', p_table_name, SQLERRM;
        END;

        RAISE NOTICE '统计目标调整成功: %.% = %', p_table_name, p_column_name, p_target;
    EXCEPTION
        WHEN OTHERS THEN
            RAISE EXCEPTION 'adjust_stats_target执行失败: %', SQLERRM;
    END;
EXCEPTION
    WHEN OTHERS THEN
        RAISE EXCEPTION 'adjust_stats_target执行失败: %', SQLERRM;
...
```sql
-- 1. 为关键列设置合适的统计目标（带错误处理）
DO $$
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'products') THEN
            RAISE WARNING '表 products 不存在，无法设置统计目标';
            RETURN;
        END IF;
        ...
        ELSE
            ...
            RAISE NOTICE '列 price 的统计目标已设置为500';
        END IF;
        ...
        IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema = 'public' AND table_name = 'products' AND column_name = 'category_id') THEN
            RAISE WARNING '列 category_id 不存在';
        ELSE
            ALTER TABLE products ALTER COLUMN category_id SET STATISTICS 100;
            RAISE NOTICE '列 category_id 的统计目标已设置为100';
        END IF;
    EXCEPTION
        WHEN undefined_table THEN
            RAISE WARNING '表 products 不存在';
        WHEN undefined_column THEN
            RAISE WARNING '指定列不存在';
        WHEN OTHERS THEN
            RAISE WARNING '设置统计目标失败: %', SQLERRM;
            RAISE;
    END;
END $$;

-- 2. 创建多变量统计信息用于复合查询（带错误处理）
DO $$
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'products') THEN
        ...
        IF EXISTS (SELECT 1 FROM pg_statistic_ext WHERE stxrelid = 'products'::regclass AND stxname = 'products_multi_stats') THEN
            RAISE NOTICE '多变量统计信息 products_multi_stats 已存在';
        ELSE
            CREATE STATISTICS products_multi_stats (dependencies, ndistinct)
            ON price, category_id, discount
            FROM products;
            RAISE NOTICE '多变量统计信息 products_multi_stats 创建成功';
        END IF;
    EXCEPTION
        WHEN duplicate_object THEN
            RAISE WARNING '多变量统计信息 products_multi_stats 已存在';
        WHEN undefined_table THEN
            RAISE WARNING '表 products 不存在';
        WHEN OTHERS THEN
            RAISE WARNING '创建多变量统计信息失败: %', SQLERRM;
...
BEGIN
    BEGIN
        ...
        RAISE NOTICE '表 products 统计信息收集成功（包括虚拟生成列）';
    EXCEPTION
        WHEN undefined_table THEN
            RAISE WARNING '表 products 不存在';
        WHEN OTHERS THEN
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'products') THEN
            RAISE WARNING '表 products 不存在，无法配置自适应统计信息更新';
            RETURN;
        END IF;
        ...
        RAISE NOTICE '表 products 的自适应统计信息更新已配置';
    EXCEPTION
        WHEN undefined_table THEN
            RAISE WARNING '表 products 不存在';
        WHEN OTHERS THEN
            RAISE WARNING '配置自适应统计信息更新失败: %', SQLERRM;
            RAISE;
    END;
END $$;

-- 5. 利用异步I/O提升大表统计信息收集性能（带错误处理）
-- 在postgresql.conf中配置
...
BEGIN
    BEGIN
        ...
        IF stats_count = 0 THEN
            ...
            RETURN;
        END IF;
        RAISE NOTICE '找到 % 条统计信息，开始质量监控', stats_count;
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '监控统计信息质量准备失败: %', SQLERRM;
            RAISE;
    END;
END $$;
...
- ⭐⭐ [数据模型设计](../../00-归档-项目管理文档/README.md) - 统计分析实践
- ⭐⭐ [性能调优实践](../../11-部署架构/单机部署/05.02-性能调优实践.md) - 性能调优详细指南
- ⭐ [监控与诊断](../../00-归档-项目管理文档/README.md) - 统计信息监控
