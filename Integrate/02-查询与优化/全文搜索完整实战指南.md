...
- [PostgreSQL全文搜索完整实战指南](#postgresql全文搜索完整实战指南)
  ...
  - [9. 实战案例](#9-实战案例)
    ...
    - [9.2 电商产品搜索](#92-电商产品搜索)
    - [9.3 文档管理系统](#93-文档管理系统)
  - [📚 参考资源](#-参考资源)
  - [📝 更新日志](#-更新日志)
...
-- <-> (FOLLOWED BY) - 相邻
SELECT to_tsquery('english', 'postgresql <-> database');  -- "postgresql database"相邻

-- <N> (距离N) - 距离N个词
SELECT to_tsquery('english', 'postgresql <2> database');  -- 距离2个词以内
```
...
USING GIN (location, tsv);  -- 注意：GIN不支持组合索引，需要分别创建
```
