...
- [PostgreSQL 版本对比与迁移指南](#postgresql-版本对比与迁移指南)
  ...
  - [五、从 PostgreSQL 17 迁移到 18](#五从-postgresql-17-迁移到-18)
    ...
    - [5.2 迁移步骤](#52-迁移步骤)
  - [五.五、从 PostgreSQL 18.1 迁移到 18.1 ⭐ 新增](#五五从-postgresql-181-迁移到-181--新增)
    - [5.5.1 版本信息](#551-版本信息)
    - [5.5.2 主要变化](#552-主要变化)
      - [5.5.2.1 安全修复 🔴 重要](#5521-安全修复--重要)
      - [5.5.2.2 Bug修复](#5522-bug修复)
      - [5.5.2.3 性能改进](#5523-性能改进)
    - [5.5.3 升级步骤](#553-升级步骤)
      - [方法1: 使用pg\_upgrade (推荐)](#方法1-使用pg_upgrade-推荐)
      - [方法2: 使用包管理器升级 (最简单)](#方法2-使用包管理器升级-最简单)
      - [方法3: 使用逻辑复制 (零停机升级)](#方法3-使用逻辑复制-零停机升级)
    - [5.5.4 升级后验证](#554-升级后验证)
    - [5.5.5 客户端库升级 ⚠️ 重要](#555-客户端库升级-️-重要)
    - [5.5.6 兼容性说明](#556-兼容性说明)
    - [5.5.7 回滚方案](#557-回滚方案)
    - [5.5.8 推荐行动](#558-推荐行动)
    - [5.5.9 相关文档](#559-相关文档)
