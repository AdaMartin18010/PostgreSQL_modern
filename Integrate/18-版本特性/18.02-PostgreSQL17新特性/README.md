...
> **📋 文档来源**: `PostgreSQL培训\16-PostgreSQL17新特性\README.md`
> **📅 复制日期**: 2025-12-22
...
- [PostgreSQL 17 新特性详解](#postgresql-17-新特性详解)
  - [📑 概述](#-概述)
  - [🗺️ PostgreSQL 17 新特性体系思维导图](#️-postgresql-17-新特性体系思维导图)
  - [📚 目录](#-目录)
    - [PostgreSQL 17 新特性知识体系](#postgresql-17-新特性知识体系)
    - [PostgreSQL 16 vs 17 特性对比矩阵](#postgresql-16-vs-17-特性对比矩阵)
    - [PostgreSQL 版本升级决策思维导图](#postgresql-版本升级决策思维导图)
  - [🎯 核心价值](#-核心价值)
  - [📚 文档索引](#-文档索引)
    - [1. SQL 语言增强](#1-sql-语言增强)
    - [2. 逻辑复制增强](#2-逻辑复制增强)
    - [3. 查询优化器改进](#3-查询优化器改进)
    - [4. 分区表增强](#4-分区表增强)
    - [5. JSON/JSONB 改进](#5-jsonjsonb-改进)
    - [6. 并发控制优化](#6-并发控制优化)
    - [7. 监控和诊断](#7-监控和诊断)
    - [8. 其他改进](#8-其他改进)
  - [🔄 迁移指南](#-迁移指南)
