...
> **📋 文档来源**: `PostgreSQL培训\16-PostgreSQL17新特性\备份恢复改进.md`
> **📅 复制日期**: 2025-12-22
...
- [PostgreSQL 17 备份恢复改进](#postgresql-17-备份恢复改进)
  ...
  - [1. 备份恢复改进概述](#1-备份恢复改进概述)
    - [1.0 PostgreSQL 17 备份恢复改进知识体系思维导图](#10-postgresql-17-备份恢复改进知识体系思维导图)
...
### 1.0 PostgreSQL 17 备份恢复改进知识体系思维导图

```mermaid
mindmap
  root((PostgreSQL 17备份恢复改进))
    备份性能优化
      pg_basebackup优化
        备份优化
        性能提升
