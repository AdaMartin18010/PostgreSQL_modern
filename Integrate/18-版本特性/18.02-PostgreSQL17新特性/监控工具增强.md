...
> **📋 文档来源**: `PostgreSQL培训\16-PostgreSQL17新特性\监控工具增强.md`
> **📅 复制日期**: 2025-12-22
...
- [PostgreSQL 17 监控工具增强](#postgresql-17-监控工具增强)
  ...
  - [1. 监控工具增强概述](#1-监控工具增强概述)
    - [1.0 PostgreSQL 17 监控工具增强知识体系思维导图](#10-postgresql-17-监控工具增强知识体系思维导图)
...
### 1.0 PostgreSQL 17 监控工具增强知识体系思维导图

```mermaid
mindmap
  root((PostgreSQL 17监控工具增强))
    新监控视图
      pg_stat_io视图
        I/O统计
        I/O分析
      pg_stat_progress_copy增强
        复制进度
        复制监控
