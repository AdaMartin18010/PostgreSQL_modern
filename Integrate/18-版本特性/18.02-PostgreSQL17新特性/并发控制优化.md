...
> **📋 文档来源**: `PostgreSQL培训\16-PostgreSQL17新特性\并发控制优化.md`
> **📅 复制日期**: 2025-12-22
...
- [PostgreSQL 17 并发控制优化](#postgresql-17-并发控制优化)
  ...
  - [1. 并发控制优化概述](#1-并发控制优化概述)
    - [1.0 PostgreSQL 17 并发控制优化知识体系思维导图](#10-postgresql-17-并发控制优化知识体系思维导图)
...
### 1.0 PostgreSQL 17 并发控制优化知识体系思维导图

```mermaid
mindmap
  root((PostgreSQL 17并发控制优化))
    锁机制改进
      锁性能优化
        获取优化
        释放优化
...
- **M** = (mvcc, locking, isolation) 是并发控制机制，
mvcc ∈ {true, false}，locking ∈ {true, false}，isolation ∈ {read_committed, repeatable_read, serializable}
