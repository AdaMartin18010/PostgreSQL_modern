...
> **📋 文档来源**: `PostgreSQL培训\16-PostgreSQL17新特性\查询优化器增强.md`
> **📅 复制日期**: 2025-12-22
...
- [PostgreSQL 17 查询优化器增强](#postgresql-17-查询优化器增强)
  ...
  - [1. 查询优化器增强概述](#1-查询优化器增强概述)
    - [1.0 PostgreSQL 17 查询优化器增强知识体系思维导图](#10-postgresql-17-查询优化器增强知识体系思维导图)
  ...
  - [8. 常见问题（FAQ）](#8-常见问题faq)
    - [8.1 查询优化器基础常见问题](#81-查询优化器基础常见问题)
      - [Q1: PostgreSQL 17的查询优化器有哪些增强？](#q1-postgresql-17的查询优化器有哪些增强)
      - [Q2: 如何利用扩展统计信息优化查询？](#q2-如何利用扩展统计信息优化查询)
    - [8.2 连接顺序优化常见问题](#82-连接顺序优化常见问题)
      - [Q3: 如何优化连接顺序？](#q3-如何优化连接顺序)
    - [8.3 并行查询优化常见问题](#83-并行查询优化常见问题)
      - [Q4: 如何启用并行查询优化？](#q4-如何启用并行查询优化)
  - [📚 参考资料](#-参考资料)
    - [8.3 参考资料](#83-参考资料)
      - [8.3.1 官方文档](#831-官方文档)
      - [10.1.2 技术论文](#1012-技术论文)
      - [10.1.3 技术博客](#1013-技术博客)
      - [10.1.4 社区资源](#1014-社区资源)
      - [10.1.5 相关文档](#1015-相关文档)

---

## 1. 查询优化器增强概述

### 1.0 PostgreSQL 17 查询优化器增强知识体系思维导图

```mermaid
mindmap
  root((PostgreSQL 17查询优化器增强))
    连接顺序优化
      连接顺序选择改进
        算法改进
        性能提升
...
#### Q1: PostgreSQL 17的查询优化器有哪些增强？

**问题描述**：不确定PostgreSQL 17的查询优化器有哪些具体增强。
...
-- PostgreSQL 17支持扩展统计信息
```

#### Q2: 如何利用扩展统计信息优化查询？

**问题描述**：不知道如何利用扩展统计信息优化查询性能。
...
-- ✅ 好：查看统计信息
SELECT * FROM pg_stats_ext
WHERE stxname = 'stats_correlation';
-- 查看扩展统计信息详情
```
