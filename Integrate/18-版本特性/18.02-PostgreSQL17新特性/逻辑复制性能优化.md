...
> **📋 文档来源**: `PostgreSQL培训\16-PostgreSQL17新特性\逻辑复制性能优化.md`
> **📅 复制日期**: 2025-12-22
...
- [PostgreSQL 17 逻辑复制性能优化](#postgresql-17-逻辑复制性能优化)
  ...
  - [1. 逻辑复制性能优化概述](#1-逻辑复制性能优化概述)
    - [1.0 PostgreSQL 17 逻辑复制性能优化知识体系思维导图](#10-postgresql-17-逻辑复制性能优化知识体系思维导图)
...
### 1.0 PostgreSQL 17 逻辑复制性能优化知识体系思维导图

```mermaid
mindmap
  root((PostgreSQL 17逻辑复制性能优化))
    并行应用优化
      并行应用原理
        依赖检测
        并行执行
...
- [复制与高可用](../../13-高可用架构/复制与高可用.md)
- [逻辑复制详解](../../09-逻辑复制/README.md)
