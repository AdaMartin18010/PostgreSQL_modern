...
> **📋 文档来源**: `PostgreSQL培训\17-PostgreSQL18新特性\迁移指南_17到18.md`
> **📅 复制日期**: 2025-12-22
...
- [PostgreSQL 17 到 18 迁移指南](#postgresql-17-到-18-迁移指南)
  ...
  - [📚 目录](#-目录)
  - [1. 迁移概述](#1-迁移概述)
    - [1.0 PostgreSQL 17到18迁移知识体系思维导图](#10-postgresql-17到18迁移知识体系思维导图)
  ...
  - [10. 常见问题（FAQ）](#10-常见问题faq)
    - [10.1 迁移准备常见问题](#101-迁移准备常见问题)
      - [Q1: 迁移前需要做哪些准备？](#q1-迁移前需要做哪些准备)
      - [Q2: 应该使用哪种迁移方法？](#q2-应该使用哪种迁移方法)
    - [10.2 迁移执行常见问题](#102-迁移执行常见问题)
      - [Q3: pg\_upgrade迁移失败怎么办？](#q3-pg_upgrade迁移失败怎么办)
    - [10.3 迁移后常见问题](#103-迁移后常见问题)
      - [Q4: 迁移后需要做哪些优化？](#q4-迁移后需要做哪些优化)
      - [Q5: 迁移后性能下降怎么办？](#q5-迁移后性能下降怎么办)
  - [📚 参考资料](#-参考资料)
    - [10.1 官方文档](#101-官方文档)
    - [技术博客](#技术博客)
    - [社区资源](#社区资源)
  - [10. Python 代码示例](#10-python-代码示例)
    - [10.1 迁移检查工具](#101-迁移检查工具)
  - [📊 总结](#-总结)
...
### 1.0 PostgreSQL 17到18迁移知识体系思维导图

```mermaid
mindmap
  root((PostgreSQL 17到18迁移))
    迁移前准备
      环境检查
        版本检查
        依赖检查
...
EXPLAIN (ANALYZE, BUFFERS, TIMING) SELECT * FROM large_table WHERE id = 123;
...
| 方法 | 优点 | 缺点 | 适用场景 |
| --- | --- | --- | --- |
| **pg_upgrade** | 快速、保留数据目录 | 需要停机 | 单机升级 |
| **逻辑复制** | 零停机、可回滚 | 配置复杂 | 高可用环境 |
| **dump/restore** | 简单、可靠 | 慢、需要停机 | 小数据库 |
...
class MigrationChecker:
    ...
    def check_extensions(self) -> List[Dict]:
        """检查扩展兼容性"""
        sql = """
        SELECT
            extname,
...
if __name__ == "__main__":
    ...
    # 检查版本
    version = checker.check_version()
    print(f"PostgreSQL版本: {version}")

    # 检查扩展
    extensions = checker.check_extensions()
    print(f"已安装扩展: {len(extensions)} 个")
