...
> **📋 文档来源**: `docs\01-PostgreSQL18\38-CTE与递归查询完全指南.md`
> **📅 复制日期**: 2025-12-22
...
- [PostgreSQL CTE与递归查询完全指南](#postgresql-cte与递归查询完全指南)
  - [📑 目录](#-目录)
  - [1. CTE基础](#1-cte基础)
    - [1.1 简单CTE](#11-简单cte)
    - [1.2 多个CTE](#12-多个cte)
  ...
  - [4. 数列生成](#4-数列生成)
    ...
    - [4.2 日期序列](#42-日期序列)
  - [5. 性能优化](#5-性能优化)
    - [5.1 避免无限递归](#51-避免无限递归)
    - [5.2 优化循环检测](#52-优化循环检测)
  - [6. 实战案例](#6-实战案例)
    - [6.1 物料清单（BOM）](#61-物料清单bom)
    - [6.2 评论回复树](#62-评论回复树)
