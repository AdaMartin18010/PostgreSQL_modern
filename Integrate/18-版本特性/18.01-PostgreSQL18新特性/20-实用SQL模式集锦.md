...
- [PostgreSQL实用SQL模式集锦](#postgresql实用sql模式集锦)
  - [📑 目录](#-目录)
  - [1. 去重模式](#1-去重模式)
    - [1.1 保留最新记录](#11-保留最新记录)
  - [2. 累计计算](#2-累计计算)
    - [2.1 累计和](#21-累计和)
    - [2.2 累计统计](#22-累计统计)
  - [3. 时间间隙分析](#3-时间间隙分析)
    - [3.1 查找时间间隙](#31-查找时间间隙)
  - [4. 排行榜模式](#4-排行榜模式)
    - [4.1 实时排行榜](#41-实时排行榜)
  - [5. 批量操作模式](#5-批量操作模式)
    - [5.1 安全的批量删除](#51-安全的批量删除)
    - [5.2 批量更新with进度](#52-批量更新with进度)
  - [6. 时序分析模式](#6-时序分析模式)
    - [6.1 同比环比](#61-同比环比)
    - [6.2 趋势检测](#62-趋势检测)
  - [7. 数据清洗模式](#7-数据清洗模式)
    ...
    - [7.2 异常值处理](#72-异常值处理)
  - [8. 分页优化](#8-分页优化)
    - [8.1 Keyset分页](#81-keyset分页)
  - [9. 审计模式](#9-审计模式)
    - [9.1 审计表设计](#91-审计表设计)
  - [10. 缓存表模式](#10-缓存表模式)
    - [10.1 自动刷新缓存](#101-自动刷新缓存)
  - [11. 数据版本控制](#11-数据版本控制)
    - [11.1 Temporal表](#111-temporal表)
  - [12. 队列处理模式](#12-队列处理模式)
    - [12.1 任务队列](#121-任务队列)
  - [13. 全文搜索模式](#13-全文搜索模式)
    - [13.1 加权搜索](#131-加权搜索)
  - [14. 性能模式](#14-性能模式)
    - [14.1 预计算汇总](#141-预计算汇总)
