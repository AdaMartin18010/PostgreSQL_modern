...
> **📋 文档来源**: `docs\01-PostgreSQL18\25-性能基准测试与调优实战指南.md`
> **📅 复制日期**: 2025-12-22
...
测试流程:
  ...
  8. 记录详细指标（EXPLAIN (ANALYZE, BUFFERS, TIMING), BUFFERS, WAL）
```
...
flowchart TD
    ...
    Check1 -->|慢查询| Slow[EXPLAIN (ANALYZE, BUFFERS, TIMING)]
...
步骤1-分析:
  ...
  - EXPLAIN (ANALYZE, BUFFERS, TIMING)分析执行计划
  - 检查wait_event识别瓶颈
