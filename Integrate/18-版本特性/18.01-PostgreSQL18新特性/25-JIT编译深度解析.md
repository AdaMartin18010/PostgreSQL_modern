...
- [PostgreSQL 18 JIT编译深度解析](#postgresql-18-jit编译深度解析)
  - [📑 目录](#-目录)
  - [1. JIT编译原理](#1-jit编译原理)
    - [1.1 传统解释执行 vs JIT](#11-传统解释执行-vs-jit)
  - [2. 启用JIT](#2-启用jit)
    - [2.1 配置](#21-配置)
  - [3. 适用场景](#3-适用场景)
    - [3.1 受益查询](#31-受益查询)
    - [3.2 不受益查询](#32-不受益查询)
  - [4. 性能测试](#4-性能测试)
    - [4.1 TPC-H Q1](#41-tpc-h-q1)
  - [5. JIT调优](#5-jit调优)
    - [5.1 阈值调整](#51-阈值调整)
    - [5.2 优化级别](#52-优化级别)
  - [6. 监控JIT](#6-监控jit)
    - [6.1 统计信息](#61-统计信息)
  - [7. PostgreSQL 18改进](#7-postgresql-18改进)
    - [7.1 JIT性能提升](#71-jit性能提升)
  - [8. 最佳实践](#8-最佳实践)
