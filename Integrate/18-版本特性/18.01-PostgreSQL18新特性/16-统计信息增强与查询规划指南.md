...
- [PostgreSQL 18 统计信息增强与查询规划指南](#postgresql-18-统计信息增强与查询规划指南)
  - [📑 目录](#-目录)
  - [1. 统计信息架构全景](#1-统计信息架构全景)
    - [1.1 统计信息在查询优化中的作用](#11-统计信息在查询优化中的作用)
    - [1.2 pg\_statistic表结构详解](#12-pg_statistic表结构详解)
  - [2. PostgreSQL 18统计信息增强](#2-postgresql-18统计信息增强)
    - [2.1 表达式统计支持](#21-表达式统计支持)
    - [2.2 改进的直方图算法](#22-改进的直方图算法)
    - [2.3 自适应采样率](#23-自适应采样率)
  - [3. 查询规划器工作原理](#3-查询规划器工作原理)
...
### 7.1 EXPLAIN (ANALYZE, BUFFERS, TIMING)深度解读
