...
- [PostgreSQL 18 新特性总结](#postgresql-18-新特性总结)
  - [📑 目录](#-目录)
  - [1. 性能提升](#1-性能提升)
    - [1.1 异步I/O（重大突破）](#11-异步io重大突破)
    - [1.2 Skip Scan优化](#12-skip-scan优化)
    - [1.3 GIN索引并行构建](#13-gin索引并行构建)
  - [2. SQL增强](#2-sql增强)
    - [2.1 UUIDv7原生支持](#21-uuidv7原生支持)
    - [2.2 EXPLAIN增强](#22-explain增强)
    - [2.3 约束增强](#23-约束增强)
  - [3. 复制与高可用](#3-复制与高可用)
    - [3.1 逻辑复制增强](#31-逻辑复制增强)
    - [3.2 流式复制改进](#32-流式复制改进)
  - [4. 安全增强](#4-安全增强)
    - [4.1 OAuth 2.0集成](#41-oauth-20集成)
    - [4.2 行级安全增强](#42-行级安全增强)
  - [5. 工具改进](#5-工具改进)
    - [5.1 pg\_upgrade增强](#51-pg_upgrade增强)
    - [5.2 VACUUM增强](#52-vacuum增强)
  - [6. 开发者体验](#6-开发者体验)
    - [6.1 查询优化器改进](#61-查询优化器改进)
    - [6.2 错误消息改进](#62-错误消息改进)
  - [7. 性能基准](#7-性能基准)
  - [8. 迁移指南](#8-迁移指南)
    - [8.1 升级准备](#81-升级准备)
    - [8.2 配置调整](#82-配置调整)
