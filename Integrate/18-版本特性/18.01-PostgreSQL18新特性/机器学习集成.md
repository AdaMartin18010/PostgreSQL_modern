...
> **📋 文档来源**: `PostgreSQL培训\17-PostgreSQL18新特性\机器学习集成.md`
> **📅 复制日期**: 2025-12-22
...
- [PostgreSQL 18 机器学习集成](#postgresql-18-机器学习集成)
  ...
  - [11. 常见问题（FAQ）](#11-常见问题faq)
    - [11.1 机器学习集成基础常见问题](#111-机器学习集成基础常见问题)
      - [Q1: PostgreSQL 18的机器学习集成有哪些特性？](#q1-postgresql-18的机器学习集成有哪些特性)
      - [Q2: 如何使用pg\_ai扩展？](#q2-如何使用pg_ai扩展)
    - [11.2 模型管理常见问题](#112-模型管理常见问题)
      - [Q3: 如何管理ML模型？](#q3-如何管理ml模型)
  - [📚 参考资料](#-参考资料)
    - [官方文档](#官方文档)
    - [技术论文](#技术论文)
    - [技术博客](#技术博客)
