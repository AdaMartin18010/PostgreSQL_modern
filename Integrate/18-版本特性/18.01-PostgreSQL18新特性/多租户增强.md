...
> **📋 文档来源**: `PostgreSQL培训\17-PostgreSQL18新特性\多租户增强.md`
> **📅 复制日期**: 2025-12-22
...
- [PostgreSQL 18 多租户增强](#postgresql-18-多租户增强)
  ...
  - [11. 常见问题（FAQ）](#11-常见问题faq)
    - [11.1 多租户基础常见问题](#111-多租户基础常见问题)
      - [Q1: PostgreSQL 18的多租户增强有哪些？](#q1-postgresql-18的多租户增强有哪些)
      - [Q2: 如何实现多租户隔离？](#q2-如何实现多租户隔离)
    - [11.2 行级安全常见问题](#112-行级安全常见问题)
      - [Q3: 如何优化行级安全性能？](#q3-如何优化行级安全性能)
  - [📚 参考资料](#-参考资料)
    - [官方文档](#官方文档)
    - [技术论文](#技术论文)
    - [技术博客](#技术博客)
