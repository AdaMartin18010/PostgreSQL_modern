...
> **📋 文档来源**: `docs\01-PostgreSQL18\24-全文检索深度实战.md`
> **📅 复制日期**: 2025-12-22
...
- [PostgreSQL 18 全文检索深度实战](#postgresql-18-全文检索深度实战)
  - [📑 目录](#-目录)
  - [1. 全文检索基础](#1-全文检索基础)
  ...
  - [2. 全文索引](#2-全文索引)
    - [2.1 GIN索引](#21-gin索引)
  - [3. 相关性排序](#3-相关性排序)
    - [3.1 ts\_rank函数](#31-ts_rank函数)
  - [4. 高亮显示](#4-高亮显示)
    - [4.1 ts\_headline](#41-ts_headline)
  - [5. 高级查询](#5-高级查询)
    - [5.1 短语搜索](#51-短语搜索)
    - [5.2 前缀搜索](#52-前缀搜索)
    - [5.3 布尔查询](#53-布尔查询)
  - [6. 多语言支持](#6-多语言支持)
    - [6.1 多语言表](#61-多语言表)
  - [7. 性能优化](#7-性能优化)
    - [7.1 GIN vs GiST](#71-gin-vs-gist)
    - [7.2 PostgreSQL 18 GIN并行构建](#72-postgresql-18-gin并行构建)
  - [8. 搜索建议](#8-搜索建议)
    - [8.1 自动补全](#81-自动补全)
  - [9. 与向量检索结合](#9-与向量检索结合)
    - [9.1 混合检索](#91-混合检索)
