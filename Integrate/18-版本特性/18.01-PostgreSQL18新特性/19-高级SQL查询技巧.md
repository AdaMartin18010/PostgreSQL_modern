...
> **📋 文档来源**: `docs\01-PostgreSQL18\19-高级SQL查询技巧.md`
> **📅 复制日期**: 2025-12-22
...
- [PostgreSQL 18 高级SQL查询技巧](#postgresql-18-高级sql查询技巧)
  - [📑 目录](#-目录)
  - [1. 递归查询（CTE）](#1-递归查询cte)
    - [1.1 组织结构树](#11-组织结构树)
    - [1.2 图遍历](#12-图遍历)
    - [1.3 数字序列](#13-数字序列)
  - [2. 窗口函数高级技巧](#2-窗口函数高级技巧)
    - [2.1 滑动窗口聚合](#21-滑动窗口聚合)
    - [2.2 连续计数](#22-连续计数)
  - [3. LATERAL JOIN](#3-lateral-join)
    - [3.1 相关子查询优化](#31-相关子查询优化)
    - [3.2 Top-N每组](#32-top-n每组)
  - [4. DISTINCT ON](#4-distinct-on)
    - [4.1 每组第一条](#41-每组第一条)
  - [5. 数组操作高级技巧](#5-数组操作高级技巧)
    - [5.1 数组聚合与展开](#51-数组聚合与展开)
    - [5.2 数组差集/交集/并集](#52-数组差集交集并集)
  - [6. FILTER子句](#6-filter子句)
    - [6.1 条件聚合](#61-条件聚合)
  - [7. GROUPING SETS](#7-grouping-sets)
    - [7.1 多维度汇总](#71-多维度汇总)
  - [8. JSON/JSONB高级查询](#8-jsonjsonb高级查询)
    - [8.1 JSONB路径查询](#81-jsonb路径查询)
    - [8.2 JSONB转表](#82-jsonb转表)
  - [9. 条件逻辑优化](#9-条件逻辑优化)
    - [9.1 CASE表达式](#91-case表达式)
    - [9.2 COALESCE与NULLIF](#92-coalesce与nullif)
  - [10. 性能查询模式](#10-性能查询模式)
    - [10.1 批量upsert](#101-批量upsert)
    - [10.2 批量EXISTS](#102-批量exists)
  - [11. 统计与分析](#11-统计与分析)
    - [11.1 百分位数](#111-百分位数)
    - [11.2 直方图](#112-直方图)
  - [12. 字符串处理](#12-字符串处理)
    - [12.1 正则表达式](#121-正则表达式)
    - [12.2 字符串聚合](#122-字符串聚合)
  - [13. 时间序列分析](#13-时间序列分析)
    - [13.1 时间桶（Time Bucket）](#131-时间桶time-bucket)
    - [13.2 时间间隙填充](#132-时间间隙填充)
  - [14. 数据透视](#14-数据透视)
    - [14.1 行转列](#141-行转列)
  - [15. 复杂子查询](#15-复杂子查询)
    - [15.1 相关子查询](#151-相关子查询)
    - [15.2 ANY/ALL](#152-anyall)
  - [16. 动态SQL](#16-动态sql)
    - [16.1 EXECUTE](#161-execute)
    - [16.2 动态列](#162-动态列)
