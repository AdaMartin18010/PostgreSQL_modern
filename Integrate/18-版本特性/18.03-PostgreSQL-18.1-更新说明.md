...
- [PostgreSQL 18.1 更新说明](#postgresql-181-更新说明)
  - [📋 目录](#-目录)
  - [📊 版本信息](#-版本信息)
    - [基本信息](#基本信息)
    - [版本特点](#版本特点)
  - [🔒 安全修复](#-安全修复)
    ...
    - [CVE-2025-12818: libpq内存分配整数溢出](#cve-2025-12818-libpq内存分配整数溢出)
      ...
      - [推荐行动](#推荐行动-1)
  - [🐛 Bug修复](#-bug修复)
    - [SQL/JSON函数修复](#sqljson函数修复)
      - [问题描述](#问题描述-2)
      - [修复内容](#修复内容-1)
      - [影响范围](#影响范围-2)
    - [并行查询修复](#并行查询修复)
      - [HashRightSemiJoin并行化竞争条件](#hashrightsemijoin并行化竞争条件)
      - [增量排序优化修复](#增量排序优化修复)
    - [BRIN索引修复](#brin索引修复)
      - [自动汇总失败修复](#自动汇总失败修复)
      - [整数溢出修复](#整数溢出修复)
    - [JIT编译修复](#jit编译修复)
      - [元组解构代码生成修复](#元组解构代码生成修复)
    - [其他修复](#其他修复)
  - [🚀 升级指南](#-升级指南)
    - [从PostgreSQL 18.0升级到18.1](#从postgresql-180升级到181)
      - [升级前准备](#升级前准备)
      - [升级步骤](#升级步骤)
      - [升级后验证](#升级后验证)
      - [回滚方案](#回滚方案)
  ...
  - [📚 参考资源](#-参考资源)
    ...
    - [安全公告](#安全公告)
    - [相关文档](#相关文档)
    - [国际参考与 PG 18.1 核对](#国际参考与-pg-181-核对)
  - [📝 更新日志](#-更新日志)
...
本文档与 [PostgreSQL 18 Release Notes](https://www.postgresql.org/docs/current/release-18.html) 及 18.1 维护版本说明对齐。PG 18 中与性能/存储相关的 GUC 与行为（如 `io_method`、`pg_aios`、`vacuum_truncate`、VACUUM/ANALYZE `ONLY`、autovacuum 新参数、EXPLAIN 增强等）的逐条核对要点见项目 [00-国际对齐与对标报告-2025-01.md](../00-国际对齐与对标报告-2025-01.md)。
