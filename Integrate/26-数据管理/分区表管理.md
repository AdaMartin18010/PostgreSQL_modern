...
BEGIN
    ...
    BEGIN
        IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'orders') THEN
            IF NOT EXISTS (SELECT 1 FROM pg_inherits WHERE inhrelid = 'orders_2024_q1'::regclass) THEN
                CREATE TABLE orders_2024_q1 PARTITION OF orders
                    FOR VALUES FROM ('2024-01-01') TO ('2024-04-01');
                RAISE NOTICE '分区 orders_2024_q1 创建成功';
            END IF;
            IF NOT EXISTS (SELECT 1 FROM pg_inherits WHERE inhrelid = 'orders_2024_q2'::regclass) THEN
                CREATE TABLE orders_2024_q2 PARTITION OF orders
                    FOR VALUES FROM ('2024-04-01') TO ('2024-07-01');
                RAISE NOTICE '分区 orders_2024_q2 创建成功';
            END IF;
            IF NOT EXISTS (SELECT 1 FROM pg_inherits WHERE inhrelid = 'orders_2024_q3'::regclass) THEN
                CREATE TABLE orders_2024_q3 PARTITION OF orders
                    FOR VALUES FROM ('2024-07-01') TO ('2024-10-01');
                RAISE NOTICE '分区 orders_2024_q3 创建成功';
            END IF;
            IF NOT EXISTS (SELECT 1 FROM pg_inherits WHERE inhrelid = 'orders_2024_q4'::regclass) THEN
...
BEGIN
    ...
    BEGIN
        IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'sales') THEN
            IF NOT EXISTS (SELECT 1 FROM pg_inherits WHERE inhrelid = 'sales_north'::regclass) THEN
                CREATE TABLE sales_north PARTITION OF sales
                    FOR VALUES IN ('Beijing', 'Tianjin', 'Hebei');
                RAISE NOTICE '分区 sales_north 创建成功';
            END IF;
            IF NOT EXISTS (SELECT 1 FROM pg_inherits WHERE inhrelid = 'sales_south'::regclass) THEN
                CREATE TABLE sales_south PARTITION OF sales
                    FOR VALUES IN ('Guangdong', 'Guangxi', 'Hainan');
                RAISE NOTICE '分区 sales_south 创建成功';
            END IF;
            IF NOT EXISTS (SELECT 1 FROM pg_inherits WHERE inhrelid = 'sales_default'::regclass) THEN
                CREATE TABLE sales_default PARTITION OF sales
                    DEFAULT;  -- 默认分区（可选）
                RAISE NOTICE '默认分区 sales_default 创建成功';
            END IF;
        END IF;
    EXCEPTION
        WHEN duplicate_table THEN
...
BEGIN
    ...
    EXCEPTION
        WHEN duplicate_table THEN
            RAISE NOTICE '分区表 users 已存在';
        WHEN OTHERS THEN
            RAISE WARNING '创建分区表 users 失败: %', SQLERRM;
            RAISE;
    END;

    -- 创建分区（通常创建 2^n 个分区）（带错误处理）
    BEGIN
        IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'users') THEN
            IF NOT EXISTS (SELECT 1 FROM pg_inherits WHERE inhrelid = 'users_0'::regclass) THEN
                CREATE TABLE users_0 PARTITION OF users
                    FOR VALUES WITH (MODULUS 4, REMAINDER 0);
                RAISE NOTICE '分区 users_0 创建成功';
            END IF;
            IF NOT EXISTS (SELECT 1 FROM pg_inherits WHERE inhrelid = 'users_1'::regclass) THEN
                CREATE TABLE users_1 PARTITION OF users
                    FOR VALUES WITH (MODULUS 4, REMAINDER 1);
                RAISE NOTICE '分区 users_1 创建成功';
            END IF;
            IF NOT EXISTS (SELECT 1 FROM pg_inherits WHERE inhrelid = 'users_2'::regclass) THEN
                CREATE TABLE users_2 PARTITION OF users
                    FOR VALUES WITH (MODULUS 4, REMAINDER 2);
                RAISE NOTICE '分区 users_2 创建成功';
            END IF;
            IF NOT EXISTS (SELECT 1 FROM pg_inherits WHERE inhrelid = 'users_3'::regclass) THEN
                CREATE TABLE users_3 PARTITION OF users
                    FOR VALUES WITH (MODULUS 4, REMAINDER 3);
                RAISE NOTICE '分区 users_3 创建成功';
            END IF;
        END IF;
    EXCEPTION
        WHEN duplicate_table THEN
...
BEGIN
    BEGIN
        IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'orders') THEN
            IF NOT EXISTS (SELECT 1 FROM pg_inherits WHERE inhrelid = 'orders_2025_q1'::regclass) THEN
                CREATE TABLE orders_2025_q1 PARTITION OF orders
                    FOR VALUES FROM ('2025-01-01') TO ('2025-04-01');
                RAISE NOTICE '分区 orders_2025_q1 创建成功';
            ELSE
                RAISE NOTICE '分区 orders_2025_q1 已存在';
            END IF;
        ELSE
...
BEGIN
    BEGIN
        IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'sales') THEN
            IF NOT EXISTS (SELECT 1 FROM pg_inherits WHERE inhrelid = 'sales_west'::regclass) THEN
                CREATE TABLE sales_west PARTITION OF sales
                    FOR VALUES IN ('Xinjiang', 'Tibet', 'Qinghai');
                RAISE NOTICE '分区 sales_west 创建成功';
            ELSE
                RAISE NOTICE '分区 sales_west 已存在';
            END IF;
        ELSE
            RAISE WARNING '分区表 sales 不存在，无法创建分区';
        END IF;
    EXCEPTION
        WHEN duplicate_table THEN
            RAISE NOTICE '分区已存在';
...
BEGIN
    BEGIN
        IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'orders_2024_q1') THEN
            -- 先检查数据量
            DECLARE
                row_count BIGINT;
            BEGIN
                SELECT COUNT(*) INTO row_count FROM orders_2024_q1;
                RAISE NOTICE '分区 orders_2024_q1 包含 % 行数据', row_count;

                IF row_count > 0 THEN
                    RAISE WARNING '分区 orders_2024_q1 包含数据，删除将导致数据丢失';
                END IF;
            END;

            DROP TABLE orders_2024_q1;
            RAISE NOTICE '分区 orders_2024_q1 删除成功';
        ELSE
            RAISE WARNING '分区 orders_2024_q1 不存在';
        END IF;
    EXCEPTION
        WHEN OTHERS THEN
...
BEGIN
    BEGIN
        IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'orders_2024_q1') THEN
            IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'orders_2024_q1_backup') THEN
                CREATE TABLE orders_2024_q1_backup AS
                SELECT * FROM orders_2024_q1;
                RAISE NOTICE '备份表 orders_2024_q1_backup 创建成功';
            ELSE
                RAISE NOTICE '备份表 orders_2024_q1_backup 已存在';
            END IF;
        ELSE
            RAISE WARNING '分区 orders_2024_q1 不存在，无法备份';
        END IF;
    EXCEPTION
        WHEN duplicate_table THEN
            RAISE NOTICE '备份表已存在';
        WHEN OTHERS THEN
            RAISE WARNING '创建备份表失败: %', SQLERRM;
            RAISE;
    END;
END $$;
          ...
          LOOP
              ...
              EXCEPTION
                  WHEN insufficient_privilege THEN
                      RAISE WARNING '权限不足，无法删除分区: %.%',
                          v_partition_record.schemaname, v_partition_record.tablename;
                  WHEN OTHERS THEN
                      RAISE WARNING '删除分区失败: %.% (错误: %)',
                          v_partition_record.schemaname, v_partition_record.tablename, SQLERRM;
              END;
          END LOOP;
...
BEGIN
    BEGIN
        IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'orders') THEN
            ...
            END IF;
        ELSE
            RAISE WARNING '分区表 orders 不存在，无法创建索引';
        END IF;
    EXCEPTION
        WHEN duplicate_table THEN
            RAISE NOTICE '索引已存在';
...
BEGIN
    BEGIN
        IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'orders_2024_q1') THEN
            IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_orders_2024_q1_date') THEN
                CREATE INDEX idx_orders_2024_q1_date ON orders_2024_q1(order_date);
                RAISE NOTICE '索引 idx_orders_2024_q1_date 创建成功';
            ELSE
                RAISE NOTICE '索引 idx_orders_2024_q1_date 已存在';
            END IF;
        ELSE
            RAISE WARNING '分区 orders_2024_q1 不存在，无法创建索引';
        END IF;
    EXCEPTION
        WHEN duplicate_table THEN
            RAISE NOTICE '索引已存在';
...
BEGIN
    ...
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '设置分区裁剪参数失败: %', SQLERRM;
            RAISE;
    END;
END $$;
...
-- 6. 禁用分区裁剪（用于对比测试）（带错误处理）
DO $$
BEGIN
    BEGIN
        SET enable_partition_pruning = off;
        RAISE NOTICE '分区裁剪已禁用';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '设置分区裁剪参数失败: %', SQLERRM;
            RAISE;
...
分区表的统计信息对查询优化器至关重要。优化器需要知道每个分区的数据量、数据分布等信息，才能做出正确的分区裁剪决策。
...
BEGIN
    BEGIN
        IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'orders') THEN
            ANALYZE orders;
            RAISE NOTICE '分区表 orders 统计信息更新成功';
        ELSE
            RAISE WARNING '分区表 orders 不存在，无法更新统计信息';
        END IF;
    EXCEPTION
        WHEN OTHERS THEN
...
BEGIN
    BEGIN
        IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'orders_2024_q1') THEN
            ...
            RAISE NOTICE '分区 orders_2024_q1 统计信息更新成功';
        ELSE
            RAISE WARNING '分区 orders_2024_q1 不存在，无法更新统计信息';
        END IF;
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '更新统计信息失败: %', SQLERRM;
...
BEGIN
    BEGIN
        IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'orders_2024_q1') THEN
            ...
            ANALYZE orders_2024_q1;
            RAISE NOTICE '统计信息采样率设置成功';
        ELSE
            RAISE WARNING '分区 orders_2024_q1 不存在，无法设置统计信息采样率';
        END IF;
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '设置统计信息采样率失败: %', SQLERRM;
            RAISE;
    END;
END $$;
-- 增加统计信息采样率，提高统计信息准确性
...
BEGIN
    BEGIN
        IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'orders') THEN
            IF NOT EXISTS (SELECT 1 FROM pg_inherits WHERE inhrelid = 'orders_2024_01'::regclass) THEN
                CREATE TABLE orders_2024_01 PARTITION OF orders
                    FOR VALUES FROM ('2024-01-01') TO ('2024-02-01');
                RAISE NOTICE '分区 orders_2024_01 创建成功';
            END IF;
            IF NOT EXISTS (SELECT 1 FROM pg_inherits WHERE inhrelid = 'orders_2024_02'::regclass) THEN
...
BEGIN
    ...
    BEGIN
        ...
        v_end_date := v_start_date_trunc + INTERVAL '1 month';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE EXCEPTION '计算分区日期范围失败: %', SQLERRM;
    END;
...
BEGIN
    ...
    IF months_to_keep < 0 THEN
        RAISE EXCEPTION '保留月数不能为负数';
    END IF;
    ...
    LOOP
        BEGIN
            -- 解析分区日期（格式：table_name_YYYY_MM）
            partition_year := (regexp_match(partition_record.tablename, '(\d{4})_\d{2}'))[1]::INTEGER;
            partition_month := (regexp_match(partition_record.tablename, '\d{4}_(\d{2})'))[1]::INTEGER;
            partition_date := make_date(partition_year, partition_month, 1);

            -- 如果分区日期早于截止日期，删除分区
            IF partition_date < cutoff_date THEN
                EXECUTE format('DROP TABLE IF EXISTS %I', partition_record.tablename);
                RAISE NOTICE '已删除旧分区: % (日期: %)', partition_record.tablename, partition_date;
            END IF;
        EXCEPTION
            WHEN OTHERS THEN
                RAISE WARNING '处理分区 % 时出错: %', partition_record.tablename, SQLERRM;
                -- 继续处理下一个分区
        END;
    END LOOP;
EXCEPTION
...
BEGIN
    ...
    EXCEPTION
        WHEN duplicate_table THEN
            RAISE NOTICE '分区表 logs 已存在';
        WHEN OTHERS THEN
            RAISE WARNING '创建分区表 logs 失败: %', SQLERRM;
            RAISE;
    END;
END $$;
...
BEGIN
    BEGIN
        IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'logs') THEN
            IF NOT EXISTS (SELECT 1 FROM pg_inherits WHERE inhrelid = 'logs_2025_11'::regclass) THEN
                CREATE TABLE logs_2025_11 PARTITION OF logs
                    FOR VALUES FROM ('2025-11-01') TO ('2025-12-01');
                RAISE NOTICE '分区 logs_2025_11 创建成功';
            ELSE
                RAISE NOTICE '分区 logs_2025_11 已存在';
            END IF;
        ELSE
            RAISE WARNING '分区表 logs 不存在，无法创建分区';
        END IF;
    EXCEPTION
        WHEN duplicate_table THEN
            RAISE NOTICE '分区已存在';
...
-- 3. 自动创建分区（使用pg_cron）（带错误处理）
DO $$
BEGIN
    BEGIN
        IF EXISTS (SELECT 1 FROM pg_extension WHERE extname = 'pg_cron') THEN
            IF NOT EXISTS (SELECT 1 FROM cron.job WHERE jobname = 'create-monthly-log-partition') THEN
                ...
                RAISE NOTICE '定时任务 create-monthly-log-partition 创建成功';
            ELSE
                RAISE NOTICE '定时任务 create-monthly-log-partition 已存在';
            END IF;
        ELSE
...
-- 4. 自动归档旧分区（保留6个月）（带错误处理）
DO $$
BEGIN
    BEGIN
        IF EXISTS (SELECT 1 FROM pg_extension WHERE extname = 'pg_cron') THEN
            IF NOT EXISTS (SELECT 1 FROM cron.job WHERE jobname = 'archive-old-log-partitions') THEN
                PERFORM cron.schedule(
                ...
                RAISE NOTICE '定时任务 archive-old-log-partitions 创建成功';
            ELSE
                RAISE NOTICE '定时任务 archive-old-log-partitions 已存在';
            END IF;
        ELSE
            RAISE WARNING '扩展 pg_cron 未安装，无法创建定时任务';
        END IF;
...
-- 创建 2024 年各月份的分区（带错误处理）
DO $$
BEGIN
    BEGIN
        IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'logs') THEN
            IF NOT EXISTS (SELECT 1 FROM pg_inherits WHERE inhrelid = 'logs_2024_01'::regclass) THEN
                CREATE TABLE logs_2024_01 PARTITION OF logs
                    FOR VALUES FROM ('2024-01-01') TO ('2024-02-01');
                RAISE NOTICE '分区 logs_2024_01 创建成功';
            END IF;
            IF NOT EXISTS (SELECT 1 FROM pg_inherits WHERE inhrelid = 'logs_2024_02'::regclass) THEN
...
BEGIN
    BEGIN
        IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'logs') THEN
            IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_logs_time') THEN
                CREATE INDEX idx_logs_time ON logs(log_time);
                RAISE NOTICE '索引 idx_logs_time 创建成功';
            END IF;
            IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_logs_level') THEN
                CREATE INDEX idx_logs_level ON logs(level);
                RAISE NOTICE '索引 idx_logs_level 创建成功';
            END IF;
        END IF;
    EXCEPTION
        WHEN duplicate_table THEN
...
BEGIN
    BEGIN
        IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'logs_2024_01') THEN
            -- 先检查数据量
            DECLARE
                row_count BIGINT;
            BEGIN
                SELECT COUNT(*) INTO row_count FROM logs_2024_01;
                RAISE NOTICE '分区 logs_2024_01 包含 % 行数据', row_count;

                IF row_count > 0 THEN
                    RAISE WARNING '分区 logs_2024_01 包含数据，删除将导致数据丢失';
                END IF;
            END;

            DROP TABLE logs_2024_01;
            RAISE NOTICE '分区 logs_2024_01 删除成功';
        ELSE
            RAISE WARNING '分区 logs_2024_01 不存在';
        END IF;
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '删除分区失败: %', SQLERRM;
   ...
   BEGIN
       BEGIN
           IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'tenant_data') THEN
               ...
               RAISE NOTICE '分区表 tenant_data 创建成功';
           ELSE
               RAISE NOTICE '分区表 tenant_data 已存在';
           END IF;
       EXCEPTION
           WHEN duplicate_table THEN
               RAISE NOTICE '分区表 tenant_data 已存在';
           WHEN OTHERS THEN
               RAISE WARNING '创建分区表 tenant_data 失败: %', SQLERRM;
               RAISE;
       END;
   END $$;
...
2. **控制分区数量**（避免创建过多分区，建议 < 1000）
   ...
   BEGIN
       ...
       EXCEPTION
           WHEN duplicate_table THEN
               RAISE NOTICE '分区表或分区已存在';
           WHEN OTHERS THEN
               RAISE WARNING '创建分区表或分区失败: %', SQLERRM;
       END;
   END $$;
   -- ... 创建12个月的分区
   ...
   -- ✅ 好：使用默认分区处理边界情况（带错误处理）
   DO $$
   BEGIN
       BEGIN
           IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'orders') THEN
               IF NOT EXISTS (SELECT 1 FROM pg_inherits WHERE inhrelid = 'orders_default'::regclass) THEN
                   CREATE TABLE orders_default PARTITION OF orders DEFAULT;
                   RAISE NOTICE '默认分区 orders_default 创建成功';
               ELSE
                   RAISE NOTICE '默认分区 orders_default 已存在';
               END IF;
           ELSE
               RAISE WARNING '分区表 orders 不存在，无法创建默认分区';
           END IF;
       EXCEPTION
           WHEN duplicate_table THEN
               RAISE NOTICE '默认分区 orders_default 已存在';
           WHEN OTHERS THEN
               RAISE WARNING '创建默认分区 orders_default 失败: %', SQLERRM;
       END;
   END $$;
   ```
...
1. **确保查询条件包含分区键**（启用分区裁剪）
   ...
   LIMIT 100;
   -- 分区裁剪失效，扫描所有分区
   -- 解决方案：在 customer_id 上创建索引（带错误处理）
   DO $$
   BEGIN
       BEGIN
           IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'orders') THEN
       ...
       EXCEPTION
           WHEN duplicate_table THEN
               RAISE NOTICE '索引 idx_orders_customer_id 已存在';
           WHEN OTHERS THEN
               RAISE WARNING '创建索引 idx_orders_customer_id 失败: %', SQLERRM;
       END;
   END $$;
   ```
...
2. **为每个分区创建合适的索引**（提升查询性能）
   ...
   BEGIN
       BEGIN
           IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'orders_2024_q1') THEN
               IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_orders_2024_q1_special') THEN
                   CREATE INDEX idx_orders_2024_q1_special ON orders_2024_q1(special_column);
                   RAISE NOTICE '索引 idx_orders_2024_q1_special 创建成功';
               ELSE
                   RAISE NOTICE '索引 idx_orders_2024_q1_special 已存在';
               END IF;
           ELSE
               RAISE WARNING '分区 orders_2024_q1 不存在，无法创建索引';
           END IF;
       EXCEPTION
           WHEN duplicate_table THEN
               RAISE NOTICE '索引 idx_orders_2024_q1_special 已存在';
           WHEN OTHERS THEN
               RAISE WARNING '创建索引 idx_orders_2024_q1_special 失败: %', SQLERRM;
       END;
   END $$;

   -- ❌ 不好：忘记创建索引
   -- 解决方案：定期检查索引使用情况（带性能测试）
   EXPLAIN (ANALYZE, BUFFERS, TIMING)
   SELECT
       schemaname,
       tablename,
   ...
   BEGIN
       BEGIN
           IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'orders_2024_q1') THEN
               ...
               RAISE NOTICE 'VACUUM ANALYZE orders_2024_q1 执行成功';
           ELSE
               RAISE WARNING '分区 orders_2024_q1 不存在，无法执行维护操作';
           END IF;
       EXCEPTION
           WHEN OTHERS THEN
               RAISE WARNING 'VACUUM ANALYZE orders_2024_q1 失败: %', SQLERRM;
       END;

       BEGIN
           IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'orders_2024_q1') THEN
               REINDEX TABLE orders_2024_q1;
               RAISE NOTICE 'REINDEX TABLE orders_2024_q1 执行成功';
           ELSE
               RAISE WARNING '分区 orders_2024_q1 不存在，无法执行REINDEX';
           END IF;
       EXCEPTION
           WHEN OTHERS THEN
               RAISE WARNING 'REINDEX TABLE orders_2024_q1 失败: %', SQLERRM;
       END;
   END $$;
