...
> **最后更新**: 2025年1月
> **对标与关联**: 网络对标、多维矩阵与思维表征见 [00-主题26-34网络对标与思维表征报告-2025-01](../00-主题26-34网络对标与思维表征报告-2025-01.md)；与 34-模型与建模、33-数据处理与统计算法 的关联见该报告「主题关联图/表」。
...
| 阶段 | 主题 | 与本主题关系 |
|------|------|--------------|
| **建模** | [34-模型与建模](../34-模型与建模/) | 维度建模、OLTP/OLAP/时序/图建模等产出**逻辑模型**；本主题数据仓库/数据湖/分区表等实现**物理存储与生命周期**。 |
| **算法** | [33-数据处理与统计算法](../33-数据处理与统计算法/) | 聚合、统计、时序、图算法等在本主题的**数据管道、ETL、数仓查询**中落地。 |
| **数据管理** | 本主题（26） | 分区、数仓、数据湖、数据治理、数据编排等**管理与运维**。 |
