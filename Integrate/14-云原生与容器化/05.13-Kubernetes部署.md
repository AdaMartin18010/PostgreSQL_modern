...
> **📋 文档来源**: `PostgreSQL\05-部署架构\容器化部署\05.13-Kubernetes部署.md`
> **📅 复制日期**: 2025-12-22
...
- [Kubernetes 部署指南](#kubernetes-部署指南)
  ...
  - [7. 备份与恢复](#7-备份与恢复)
    ...
    - [7.2 恢复备份](#72-恢复备份)
  - [7. 生产级StatefulSet配置](#7-生产级statefulset配置)
    - [7.1 完整生产环境配置](#71-完整生产环境配置)
    - [7.2 资源限制和优化](#72-资源限制和优化)
    - [7.3 滚动更新策略](#73-滚动更新策略)
    - [7.4 网络策略配置](#74-网络策略配置)
  - [8. PostgreSQL Operator详细配置](#8-postgresql-operator详细配置)
    - [8.1 Crunchy Operator完整配置](#81-crunchy-operator完整配置)
    - [8.2 Zalando Operator配置](#82-zalando-operator配置)
    - [8.3 备份和恢复配置](#83-备份和恢复配置)
    - [8.4 监控和告警配置](#84-监控和告警配置)
  - [9. 高可用配置](#9-高可用配置)
    - [9.1 Patroni集成配置](#91-patroni集成配置)
    - [9.2 etcd配置](#92-etcd配置)
    - [9.3 故障转移配置](#93-故障转移配置)
    - [9.4 自动恢复配置](#94-自动恢复配置)
  - [10. 监控和运维](#10-监控和运维)
    - [10.1 Prometheus监控配置](#101-prometheus监控配置)
    - [10.2 Grafana仪表板配置](#102-grafana仪表板配置)
    - [10.3 告警规则配置](#103-告警规则配置)
    - [10.4 日志收集配置](#104-日志收集配置)
  - [11. 故障排查和诊断](#11-故障排查和诊断)
    - [11.1 Pod启动问题排查](#111-pod启动问题排查)
    - [11.2 存储问题排查](#112-存储问题排查)
    - [11.3 网络问题排查](#113-网络问题排查)
    - [11.4 性能问题诊断](#114-性能问题诊断)
  - [12. 备份与恢复](#12-备份与恢复)
    - [12.1 使用 pgBackRest](#121-使用-pgbackrest)
    - [12.2 恢复备份](#122-恢复备份)
    - [12.3 自动备份配置](#123-自动备份配置)
  - [13. 深入阅读](#13-深入阅读)
    - [相关文档](#相关文档)
      - [部署架构](#部署架构)
      - [运维实践](#运维实践)
...
spec:
  updateStrategy:
    type: RollingUpdate
    rollingUpdate:
      partition: 2  # 只更新postgres-2，保留postgres-0和postgres-1

# 测试通过后，逐步更新其他Pod
# partition: 1  # 更新postgres-1和postgres-2
# partition: 0  # 更新所有Pod
```
...
## 8. PostgreSQL Operator详细配置

### 8.1 Crunchy Operator完整配置

**完整的PostgresCluster配置**:
...
### 8.2 Zalando Operator配置

**Zalando Postgres Operator配置**:
...
**使用Crunchy Operator的备份配置**:

```yaml
# 在PostgresCluster中配置备份
spec:
  backups:
    pgbackrest:
      repos:
...
kubectl logs postgres-0 -n postgres --previous  # 查看之前容器的日志
...
echo "=== Kubernetes PostgreSQL性能诊断 ==="
