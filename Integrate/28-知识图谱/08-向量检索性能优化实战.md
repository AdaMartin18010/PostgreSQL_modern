...
> **📋 文档来源**: `DataBaseTheory\21-AI知识库\08-向量检索性能优化实战.md`
> **📅 复制日期**: 2025-12-22
...
WITH (
    m = 32,              -- 连接数（16-64）
    ef_construction = 128,  -- 构建时搜索范围（64-256）
    ef_search = 100      -- 查询时搜索范围（50-200）
);
...
**完成**: 向量检索性能优化实战
**字数**: ~12,000字
**涵盖**: HNSW优化、批量检索、过滤优化、向量压缩、缓存策略、并行检索、PostgreSQL 18优化、性能监控、最佳实践
