...
> **版本**: PostgreSQL 18.x
> **最后更新**: 2025-01-15
> **语言**: 中文 | [English](../en-US/01-core-fundamentals/01.01-system-architecture.md)
```
...
<!-- 正确：使用相对路径 -->
[系统架构](./01.01-系统架构.md)
[查询优化](../02-查询处理/02.01-查询优化.md)

<!-- 错误：使用绝对路径或硬编码域名 -->
[系统架构](https://example.com/01.01-系统架构.md)
```
...
- **中文版本**：本文档
- **English Version**: [System Architecture](../en-US/01-core-fundamentals/01.01-system-architecture.md)
```
...
```bash
# 1. 创建中文文档
touch "01-核心基础/01.01-系统架构.md"

# 2. 创建对应的英文文档
touch "en-US/01-core-fundamentals/01.01-system-architecture.md"
...
# 在英文文档中添加：
# - **中文版本**: [系统架构](../01-核心基础/01.01-系统架构.md)

# 4. 检查结构对齐
python tools/i18n-check.py --structure \
  --zh "01-核心基础/01.01-系统架构.md" \
  --en "en-US/01-core-fundamentals/01.01-system-architecture.md"
```
...
```markdown
    ...
    **中文文件**：
    - `01-核心基础/01.01-系统架构.md`

    **英文文件**：
    - `en-US/01-core-fundamentals/01.01-system-architecture.md`
