...
- [PostgreSQL 风险评估算法完整指南](#postgresql-风险评估算法完整指南)
  ...
  - [1. 波动率计算](#1-波动率计算)
    - [1.1 历史波动率](#11-历史波动率)
  - [2. VaR计算](#2-var计算)
    - [2.1 历史模拟法VaR](#21-历史模拟法var)
  - [3. 风险指标](#3-风险指标)
    - [3.1 最大回撤](#31-最大回撤)
    - [3.2 夏普比率](#32-夏普比率)
  - [4. 实际应用案例](#4-实际应用案例)
    - [4.1 投资组合风险评估](#41-投资组合风险评估)
  - [📊 性能优化建议](#-性能优化建议)
  - [🎯 最佳实践](#-最佳实践)
...
**风险评估**用于量化投资风险，帮助投资者做出理性决策。

### 核心风险指标

| 指标 | 公式 | 用途 |
|------|------|------|
| **波动率** | σ = √(Var(r)) | 衡量价格波动程度 |
| **VaR** | P(Loss > VaR) = α | 在险价值 |
| **最大回撤** | Max(Peak - Trough) | 最大损失幅度 |
| **夏普比率** | (R - Rf) / σ | 风险调整收益 |
