...
> **📋 文档来源**: `PostgreSQL_View\09-实践指南\运维手册\备份与恢复.md`
> **📅 复制日期**: 2025-12-22
...
- [备份与恢复](#备份与恢复)
  ...
  - [1. 概述](#1-概述)
    ...
    - [1.3 备份架构](#13-备份架构)
  - [2. 备份策略](#2-备份策略)
    - [2.1 逻辑备份（pg\_dump）](#21-逻辑备份pg_dump)
      - [2.1.1 完整备份](#211-完整备份)
      - [2.1.2 表级备份](#212-表级备份)
      - [2.1.3 仅数据/结构备份](#213-仅数据结构备份)
    - [2.2 物理备份（pg\_basebackup）](#22-物理备份pg_basebackup)
  ...
  - [3. 恢复策略](#3-恢复策略)
    - [3.1 逻辑恢复（pg\_restore）](#31-逻辑恢复pg_restore)
...
1. **数据保护**: 保护重要数据不丢失
1. **快速恢复**: 支持快速恢复，减少停机时间
1. **点对点恢复**: 支持恢复到任意时间点（PITR）
1. **自动化管理**: 自动化备份和恢复流程
