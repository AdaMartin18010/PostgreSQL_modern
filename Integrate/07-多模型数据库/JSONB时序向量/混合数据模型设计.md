...
SET checkpoint_segments = 32;      -- 增加检查点段数
...
INSERT INTO device_data VALUES
    (NOW(), 'device_001', 25.5, 60.0, '{"status": "active"}'::jsonb, '[0.1, 0.2, ...]'::vector(128)),
    (NOW(), 'device_002', 26.0, 58.0, '{"status": "active"}'::jsonb, '[0.2, 0.3, ...]'::vector(128)),
    -- ... 最多 10,000 条
    (NOW(), 'device_10000', 24.8, 62.0, '{"status": "active"}'::jsonb, '[0.3, 0.4, ...]'::vector(128));
COMMIT;
...
INSERT INTO device_data (
    ...
    (NOW(), 'device_001', 25.5, 60.0, '{"status": "active"}'::jsonb, '[0.1, 0.2, ...]'::vector(128)),
    (NOW(), 'device_002', 26.0, 58.0, '{"status": "active"}'::jsonb, '[0.2, 0.3, ...]'::vector(128)),
    (NOW(), 'device_003', 24.8, 62.0, '{"status": "active"}'::jsonb, '[0.3, 0.4, ...]'::vector(128));
```
...
FROM json_array_elements('[
    {"time": "2025-01-01T10:00:00Z", "device_id": "device_001", "temperature": 25.5, ...},
    ...
]'::json) as data;
```
