...
> **📋 文档来源**: `PostgreSQL_View\04-多模一体化\JSONB时序向量\IoT异常检测方案.md`
> **📅 复制日期**: 2025-12-22
...
- [IoT 异常检测方案](#iot-异常检测方案)
  ...
  - [5. 最佳实践](#5-最佳实践)
    ...
    - [5.5 实际应用案例](#55-实际应用案例)
      - [案例 1: 智能工厂设备监控](#案例-1-智能工厂设备监控)
      - [案例 2: 智慧城市传感器监控](#案例-2-智慧城市传感器监控)
...
1. **连续聚合**: 使用连续聚合预计算异常统计
1. **批量处理**: 批量检测多个设备，提高效率
1. **缓存策略**: 缓存常用异常模式，减少查询时间
1. **异步处理**: 对于非关键异常，使用异步检测
