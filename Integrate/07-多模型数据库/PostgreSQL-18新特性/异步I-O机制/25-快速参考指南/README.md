...
- [25. 快速参考指南](#25-快速参考指南)
  - [25. 快速参考指南](#25-快速参考指南-1)
  - [📑 目录](#-目录)
    - [25.2 常用命令速查表](#252-常用命令速查表)
      - [25.2.1 配置检查命令](#2521-配置检查命令)
      - [25.2.2 性能监控命令](#2522-性能监控命令)
      - [25.2.3 系统检查命令](#2523-系统检查命令)
    - [25.3 常见错误代码和解决方案](#253-常见错误代码和解决方案)
      - [25.3.1 配置错误](#2531-配置错误)
      - [25.3.2 系统错误](#2532-系统错误)
      - [25.3.3 性能错误](#2533-性能错误)
    - [25.4 性能指标参考值](#254-性能指标参考值)
      - [25.4.1 I/O性能指标](#2541-io性能指标)
      - [25.4.2 系统资源指标](#2542-系统资源指标)
      - [25.4.3 查询性能指标](#2543-查询性能指标)
    - [25.5 故障排查快速指南](#255-故障排查快速指南)
      - [25.5.1 故障排查流程图](#2551-故障排查流程图)
      - [25.5.2 快速诊断脚本](#2552-快速诊断脚本)
      - [25.5.3 常见问题快速解决](#2553-常见问题快速解决)
