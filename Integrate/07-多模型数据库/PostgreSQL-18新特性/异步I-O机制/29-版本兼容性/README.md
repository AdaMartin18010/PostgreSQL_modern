...
- [29. 版本兼容性与升级路径](#29-版本兼容性与升级路径)
  - [29. 版本兼容性与升级路径](#29-版本兼容性与升级路径-1)
  - [📑 目录](#-目录)
    - [29.2 升级路径规划](#292-升级路径规划)
      - [29.2.1 从PostgreSQL 16升级到18](#2921-从postgresql-16升级到18)
      - [29.2.2 从PostgreSQL 17升级到18](#2922-从postgresql-17升级到18)
      - [29.2.3 升级风险评估](#2923-升级风险评估)
    - [29.3 向后兼容性说明](#293-向后兼容性说明)
      - [29.3.1 配置参数兼容性](#2931-配置参数兼容性)
      - [29.3.2 应用兼容性](#2932-应用兼容性)
      - [29.3.3 扩展兼容性](#2933-扩展兼容性)
    - [29.4 版本历史与演进](#294-版本历史与演进)
      - [29.4.1 异步I/O功能演进](#2941-异步io功能演进)
      - [29.4.2 功能特性对比](#2942-功能特性对比)
      - [29.4.3 未来发展方向](#2943-未来发展方向)
