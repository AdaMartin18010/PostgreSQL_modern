...
- [PostgreSQL容量监控指南](#postgresql容量监控指南)
  ...
  - [3. 计算监控](#3-计算监控)
    - [3.1 CPU监控](#31-cpu监控)
      - [PostgreSQL 18异步I/O优化监控](#postgresql-18异步io优化监控)
    - [3.1 CPU监控1](#31-cpu监控1)
    - [3.2 内存监控](#32-内存监控)
  - [4. 告警设置](#4-告警设置)
    - [4.1 告警阈值](#41-告警阈值)
    - [4.2 告警通知](#42-告警通知)
...
#### PostgreSQL 18异步I/O优化监控

```sql
-- PostgreSQL 18异步I/O优化监控（提升容量监控性能）
-- 异步I/O可以显著提升I/O性能，改善容量监控查询性能
DO $$
BEGIN
    -- 检查是否为超级用户
