...
- [联邦学习与隐私计算完整指南](#联邦学习与隐私计算完整指南)
  ...
  - [三、架构设计](#三架构设计)
    - [3.1 整体架构](#31-整体架构)
      - [1. 协调服务器（Coordinator Server）](#1-协调服务器coordinator-server)
      - [2. 客户端（Client）](#2-客户端client)
      - [3. PostgreSQL数据源](#3-postgresql数据源)
  - [四、程序设计](#四程序设计)
    - [4.1 环境准备](#41-环境准备)
    ...
    - [4.4 差分隐私](#44-差分隐私)
  - [五、案例实战](#五案例实战)
    - [5.1 案例1：医疗联邦学习](#51-案例1医疗联邦学习)
    - [5.2 案例2：金融联邦学习](#52-案例2金融联邦学习)
    - [5.3 案例3：IoT联邦学习](#53-案例3iot联邦学习)
  - [六、总结与展望](#六总结与展望)
    - [核心收获](#核心收获)
    - [未来展望](#未来展望)
  - [七、参考资料](#七参考资料)
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'hospital_a_patients') THEN
            ...
            RAISE NOTICE '表 hospital_a_patients 创建成功';
        ELSE
            RAISE NOTICE '表 hospital_a_patients 已存在';
        END IF;
    EXCEPTION
        WHEN duplicate_table THEN
            RAISE WARNING '表 hospital_a_patients 已存在';
        WHEN OTHERS THEN
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'hospital_b_patients') THEN
            ...
            RAISE NOTICE '表 hospital_b_patients 创建成功';
        ELSE
            RAISE NOTICE '表 hospital_b_patients 已存在';
        END IF;
    EXCEPTION
        WHEN duplicate_table THEN
            RAISE WARNING '表 hospital_b_patients 已存在';
        WHEN OTHERS THEN
            RAISE WARNING '创建表失败: %', SQLERRM;
            RAISE;
    END;
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'federated_model_params') THEN
            ...
            RAISE NOTICE '表 federated_model_params 创建成功';
        ELSE
            RAISE NOTICE '表 federated_model_params 已存在';
        END IF;
    EXCEPTION
        WHEN duplicate_table THEN
            RAISE WARNING '表 federated_model_params 已存在';
        WHEN OTHERS THEN
            RAISE WARNING '创建表失败: %', SQLERRM;
            RAISE;
    END;
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'aggregated_model_params') THEN
            ...
            RAISE NOTICE '表 aggregated_model_params 创建成功';
        ELSE
            RAISE NOTICE '表 aggregated_model_params 已存在';
        END IF;
    EXCEPTION
        WHEN duplicate_table THEN
            RAISE WARNING '表 aggregated_model_params 已存在';
        WHEN OTHERS THEN
            RAISE WARNING '创建表失败: %', SQLERRM;
            RAISE;
    END;
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'bank_users') THEN
            ...
            RAISE NOTICE '表 bank_users 创建成功';
        ELSE
            RAISE NOTICE '表 bank_users 已存在';
        END IF;
    EXCEPTION
        WHEN duplicate_table THEN
            RAISE WARNING '表 bank_users 已存在';
        WHEN OTHERS THEN
            RAISE WARNING '创建表失败: %', SQLERRM;
            RAISE;
    END;
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'ecommerce_users') THEN
            ...
            RAISE NOTICE '表 ecommerce_users 创建成功';
        ELSE
            RAISE NOTICE '表 ecommerce_users 已存在';
        END IF;
    EXCEPTION
        WHEN duplicate_table THEN
            RAISE WARNING '表 ecommerce_users 已存在';
        WHEN OTHERS THEN
            RAISE WARNING '创建表失败: %', SQLERRM;
            RAISE;
    END;
...
-- 3. 创建用户对齐表（使用PSI后的结果，带错误处理）
DO $$
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'aligned_users') THEN
            ...
            RAISE NOTICE '表 aligned_users 创建成功';
        ELSE
            RAISE NOTICE '表 aligned_users 已存在';
        END IF;
    EXCEPTION
        WHEN duplicate_table THEN
            RAISE WARNING '表 aligned_users 已存在';
        WHEN OTHERS THEN
            RAISE WARNING '创建表失败: %', SQLERRM;
            RAISE;
    END;
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'vertical_model_params') THEN
            ...
            RAISE NOTICE '表 vertical_model_params 创建成功';
        ELSE
            RAISE NOTICE '表 vertical_model_params 已存在';
        END IF;
    EXCEPTION
        WHEN duplicate_table THEN
            RAISE WARNING '表 vertical_model_params 已存在';
        WHEN OTHERS THEN
            RAISE WARNING '创建表失败: %', SQLERRM;
            RAISE;
    END;
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'secret_shares') THEN
            ...
            RAISE NOTICE '表 secret_shares 创建成功';
        ELSE
            RAISE NOTICE '表 secret_shares 已存在';
        END IF;
    EXCEPTION
        WHEN duplicate_table THEN
            RAISE WARNING '表 secret_shares 已存在';
        WHEN OTHERS THEN
            RAISE WARNING '创建表失败: %', SQLERRM;
            RAISE;
    END;
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'aggregated_secrets') THEN
            ...
            RAISE NOTICE '表 aggregated_secrets 创建成功';
        ELSE
            RAISE NOTICE '表 aggregated_secrets 已存在';
        END IF;
    EXCEPTION
        WHEN duplicate_table THEN
            RAISE WARNING '表 aggregated_secrets 已存在';
        WHEN OTHERS THEN
            RAISE WARNING '创建表失败: %', SQLERRM;
            RAISE;
    END;
...
BEGIN
    BEGIN
        ...
        END;
        $$ LANGUAGE plpgsql;
        RAISE NOTICE '安全聚合函数 secure_aggregate_shares 创建成功';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '创建安全聚合函数失败: %', SQLERRM;
            RAISE;
    END;
END $$;
```
...
```mermaid
flowchart TD
    A[协调服务器<br/>Coordinator Server] --> B[客户端1<br/>Client 1]
    A --> C[客户端2<br/>Client 2]
    A --> D[客户端N<br/>Client N]

    B --> B1[PostgreSQL<br/>数据源]
    C --> C1[PostgreSQL<br/>数据源]
    D --> D1[PostgreSQL<br/>数据源]

    B --> B2[本地模型<br/>Local Model]
    C --> C2[本地模型<br/>Local Model]
    D --> D2[本地模型<br/>Local Model]

    A --> A1[全局模型<br/>Global Model]
    A --> A2[聚合算法<br/>Aggregation]
    A --> A3[安全机制<br/>Security]
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'training_data') THEN
            ...
            RAISE NOTICE '表 training_data 创建成功';
        ELSE
            RAISE NOTICE '表 training_data 已存在';
        END IF;
    EXCEPTION
        WHEN duplicate_table THEN
            RAISE WARNING '表 training_data 已存在';
        WHEN OTHERS THEN
            RAISE WARNING '创建表失败: %', SQLERRM;
            RAISE;
    END;
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'training_data') THEN
            RAISE WARNING '表 training_data 不存在，无法启用RLS';
            RETURN;
        END IF;

        ALTER TABLE training_data ENABLE ROW LEVEL SECURITY;
        RAISE NOTICE '表 training_data 已启用行级安全';
    EXCEPTION
        WHEN undefined_table THEN
            RAISE WARNING '表 training_data 不存在';
        WHEN OTHERS THEN
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'training_data') THEN
            RAISE WARNING '表 training_data 不存在，无法创建策略';
            RETURN;
        END IF;

        IF EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'training_data' AND policyname = 'client_data_policy') THEN
            DROP POLICY client_data_policy ON training_data;
        END IF;

        CREATE POLICY client_data_policy ON training_data
            FOR SELECT
            USING (client_id = current_setting('app.client_id'));
        RAISE NOTICE '客户端数据策略创建成功';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '创建客户端数据策略失败: %', SQLERRM;
            RAISE;
    END;
END $$;
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'federated_learning_audit') THEN
            ...
            RAISE NOTICE '联邦学习审计表 federated_learning_audit 创建成功';
        ELSE
            RAISE NOTICE '联邦学习审计表 federated_learning_audit 已存在';
        END IF;
    EXCEPTION
        WHEN duplicate_table THEN
            RAISE WARNING '联邦学习审计表 federated_learning_audit 已存在';
        WHEN OTHERS THEN
            RAISE WARNING '创建联邦学习审计表失败: %', SQLERRM;
            RAISE;
    END;
END $$;
...
BEGIN
    BEGIN
        ...
        END;
        $$ LANGUAGE plpgsql;
        RAISE NOTICE '联邦学习审计触发器函数 audit_federated_learning 创建成功';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '创建联邦学习审计触发器函数失败: %', SQLERRM;
            RAISE;
    END;
END $$;
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'training_data') THEN
            RAISE WARNING '表 training_data 不存在，无法创建触发器';
            RETURN;
        END IF;
        IF NOT EXISTS (SELECT 1 FROM pg_proc WHERE proname = 'audit_federated_learning') THEN
            RAISE WARNING '函数 audit_federated_learning 不存在';
            RETURN;
        END IF;

        IF EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'audit_trigger' AND tgrelid = 'training_data'::regclass) THEN
            DROP TRIGGER audit_trigger ON training_data;
        END IF;
        ...
        RAISE NOTICE '联邦学习审计触发器 audit_trigger 创建成功';
    EXCEPTION
        WHEN undefined_table THEN
            RAISE WARNING '表 training_data 不存在';
        WHEN undefined_function THEN
            RAISE WARNING '函数 audit_federated_learning 不存在';
        WHEN OTHERS THEN
            RAISE WARNING '创建联邦学习审计触发器失败: %', SQLERRM;
            RAISE;
    END;
END $$;
```
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM pg_database WHERE datname = 'federated_learning_db') THEN
            PERFORM dblink_exec('dbname=postgres', 'CREATE DATABASE federated_learning_db');
            RAISE NOTICE '数据库 federated_learning_db 创建成功';
        ELSE
            RAISE NOTICE '数据库 federated_learning_db 已存在';
        END IF;
    EXCEPTION
        WHEN duplicate_database THEN
            RAISE WARNING '数据库 federated_learning_db 已存在';
        WHEN undefined_function THEN
...
BEGIN
    ...
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM pg_extension WHERE extname = 'vector') THEN
            ...
            RAISE NOTICE 'vector扩展安装成功';
        ELSE
            RAISE NOTICE 'vector扩展已存在';
        END IF;
    EXCEPTION
        WHEN undefined_file THEN
            RAISE WARNING 'vector扩展不可用（可选），跳过安装';
        WHEN insufficient_privilege THEN
            RAISE WARNING '需要超级用户权限来安装vector扩展';
        WHEN OTHERS THEN
            RAISE WARNING '安装vector扩展失败: %', SQLERRM;
            -- vector扩展是可选的，不抛出异常
    END;
END $$;
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM pg_roles WHERE rolname = 'federated_client') THEN
            CREATE USER federated_client WITH PASSWORD 'secure_password_123';
            RAISE NOTICE '用户 federated_client 创建成功';
        ELSE
            RAISE NOTICE '用户 federated_client 已存在';
        END IF;
    EXCEPTION
        WHEN duplicate_object THEN
            RAISE WARNING '用户 federated_client 已存在';
        WHEN OTHERS THEN
    ...
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM pg_roles WHERE rolname = 'federated_readonly') THEN
            CREATE ROLE federated_readonly;
            RAISE NOTICE '角色 federated_readonly 创建成功';
        END IF;
        IF NOT EXISTS (SELECT 1 FROM pg_roles WHERE rolname = 'federated_readwrite') THEN
            CREATE ROLE federated_readwrite;
            RAISE NOTICE '角色 federated_readwrite 创建成功';
        END IF;
    EXCEPTION
        WHEN duplicate_object THEN
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM pg_database WHERE datname = 'federated_learning_db') THEN
            RAISE WARNING '数据库 federated_learning_db 不存在，无法授予权限';
            RETURN;
        END IF;
        IF NOT EXISTS (SELECT 1 FROM pg_roles WHERE rolname = 'federated_client') THEN
            RAISE WARNING '用户 federated_client 不存在';
            RETURN;
        END IF;
        IF NOT EXISTS (SELECT 1 FROM pg_roles WHERE rolname = 'federated_readonly') THEN
            RAISE WARNING '角色 federated_readonly 不存在';
            RETURN;
        END IF;
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.schemata WHERE schema_name = 'federated_learning') THEN
            CREATE SCHEMA federated_learning;
            RAISE NOTICE 'Schema federated_learning 创建成功';
        ELSE
            RAISE NOTICE 'Schema federated_learning 已存在';
        END IF;
    EXCEPTION
        WHEN duplicate_schema THEN
            RAISE WARNING 'Schema federated_learning 已存在';
        WHEN OTHERS THEN
    ...
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.schemata WHERE schema_name = 'federated_learning') THEN
            RAISE WARNING 'Schema federated_learning 不存在，无法授予权限';
            RETURN;
        END IF;
        IF NOT EXISTS (SELECT 1 FROM pg_roles WHERE rolname = 'federated_readonly') THEN
            RAISE WARNING '角色 federated_readonly 不存在';
        ...
        END IF;
        IF NOT EXISTS (SELECT 1 FROM pg_roles WHERE rolname = 'federated_readwrite') THEN
            RAISE WARNING '角色 federated_readwrite 不存在';
            RETURN;
        END IF;
        ...
        RAISE NOTICE 'Schema权限授予成功';
    EXCEPTION
        WHEN undefined_object THEN
            RAISE WARNING 'Schema或角色不存在';
        WHEN OTHERS THEN
            RAISE WARNING '授予Schema权限失败: %', SQLERRM;
            RAISE;
    END;
END $$;
```
