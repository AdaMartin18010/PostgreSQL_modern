...
BEGIN
    ...
    BEGIN
        IF EXISTS (SELECT 1 FROM pg_roles WHERE rolname = 'admin_user') THEN
            RAISE NOTICE '角色 admin_user 已存在';
        ELSE
            CREATE ROLE admin_user WITH SUPERUSER CREATEDB CREATEROLE;
            RAISE NOTICE '角色 admin_user 创建成功';
        END IF;
    EXCEPTION
        WHEN duplicate_object THEN
            RAISE WARNING '角色 admin_user 已存在';
        WHEN OTHERS THEN
            RAISE WARNING '创建角色 admin_user 失败: %', SQLERRM;
            RAISE;
    END;
END $$;
```
...
BEGIN
    BEGIN
        ...
        RAISE NOTICE '角色 app_user 密码修改成功';
    EXCEPTION
        WHEN undefined_object THEN
            RAISE WARNING '角色 app_user 不存在';
        WHEN OTHERS THEN
            RAISE WARNING '修改角色密码失败: %', SQLERRM;
            RAISE;
    END;
END $$;
...
BEGIN
    BEGIN
        ...
        RAISE NOTICE '角色 app_user 属性修改成功';
    EXCEPTION
        WHEN undefined_object THEN
            RAISE WARNING '角色 app_user 不存在';
        WHEN OTHERS THEN
            RAISE WARNING '修改角色属性失败: %', SQLERRM;
            RAISE;
    END;
END $$;
...
BEGIN
    BEGIN
        ...
        DROP ROLE app_user;
        RAISE NOTICE '角色 app_user 删除成功';
    EXCEPTION
        WHEN undefined_object THEN
            RAISE WARNING '角色 app_user 不存在';
        WHEN dependent_objects_still_exist THEN
            RAISE WARNING '角色 app_user 仍有依赖对象，无法删除';
        WHEN OTHERS THEN
            RAISE WARNING '删除角色失败: %', SQLERRM;
            RAISE;
    END;
END $$;
```
...
BEGIN
    ...
    EXCEPTION
        ...
        WHEN OTHERS THEN
            RAISE WARNING '创建角色 app_admin 失败: %', SQLERRM;
            RAISE;
    END;
END $$;
...
BEGIN
    BEGIN
        ...
        END IF;
        IF NOT EXISTS (SELECT 1 FROM pg_roles WHERE rolname = 'app_readwrite') THEN
            RAISE EXCEPTION '角色 app_readwrite 不存在';
        END IF;

        GRANT app_readonly TO app_readwrite;
        RAISE NOTICE '角色继承成功: app_readonly -> app_readwrite';
    EXCEPTION
        WHEN undefined_object THEN
            RAISE WARNING '角色不存在，无法授予继承';
        WHEN OTHERS THEN
            RAISE WARNING '角色继承失败: %', SQLERRM;
            RAISE;
    END;
    ...
    BEGIN
        ...
        END IF;
        IF NOT EXISTS (SELECT 1 FROM pg_roles WHERE rolname = 'app_admin') THEN
            RAISE EXCEPTION '角色 app_admin 不存在';
        END IF;

        GRANT app_readwrite TO app_admin;
        RAISE NOTICE '角色继承成功: app_readwrite -> app_admin';
    EXCEPTION
        WHEN undefined_object THEN
            RAISE WARNING '角色不存在，无法授予继承';
        WHEN OTHERS THEN
...
BEGIN
    ...
    BEGIN
        ...
        RAISE NOTICE '用户继承角色成功: app_user -> app_readwrite';
    EXCEPTION
        WHEN undefined_object THEN
            RAISE WARNING '角色不存在，无法授予继承';
        WHEN OTHERS THEN
            RAISE WARNING '用户继承角色失败: %', SQLERRM;
            RAISE;
    END;
END $$;
```
...
BEGIN
    BEGIN
        ...
        RAISE NOTICE 'SELECT 权限授予成功: users -> readonly_user';
    EXCEPTION
        WHEN undefined_object THEN
            RAISE WARNING '表或角色不存在';
        WHEN OTHERS THEN
            RAISE WARNING '授予 SELECT 权限失败: %', SQLERRM;
            RAISE;
    END;
END $$;
...
BEGIN
    BEGIN
        ...
        RAISE NOTICE 'ALL 权限授予成功: users -> app_user';
    EXCEPTION
        WHEN undefined_object THEN
            RAISE WARNING '表或角色不存在';
        WHEN OTHERS THEN
            RAISE WARNING '授予 ALL 权限失败: %', SQLERRM;
            RAISE;
    END;
END $$;
...
BEGIN
    BEGIN
        ...
        RAISE NOTICE '所有表的 SELECT 权限授予成功: public.* -> readonly_user';
    EXCEPTION
        WHEN undefined_object THEN
            RAISE WARNING 'Schema 或角色不存在';
        WHEN OTHERS THEN
            RAISE WARNING '授予所有表权限失败: %', SQLERRM;
            RAISE;
    END;
END $$;
...
BEGIN
    BEGIN
        ...
        RAISE NOTICE '未来表的 SELECT 权限授予成功: public.* -> readonly_user';
    EXCEPTION
        WHEN undefined_object THEN
            RAISE WARNING 'Schema 或角色不存在';
        WHEN OTHERS THEN
            RAISE WARNING '授予未来表权限失败: %', SQLERRM;
            RAISE;
    END;
END $$;
...
BEGIN
    BEGIN
        ...
        RAISE NOTICE 'SELECT 权限撤销成功: users <- readonly_user';
    EXCEPTION
        WHEN undefined_object THEN
            RAISE WARNING '表或角色不存在';
        WHEN OTHERS THEN
...
BEGIN
    BEGIN
        ...
        RAISE NOTICE '角色 readonly_user 有 % 个表权限', perm_count;
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '查看表权限失败: %', SQLERRM;
            RAISE;
    END;
END $$;
...
BEGIN
    BEGIN
        ...
        RAISE NOTICE '列权限授予成功: users(id, name, email) -> readonly_user';
    EXCEPTION
        WHEN undefined_object THEN
            RAISE WARNING '表或角色不存在';
        WHEN OTHERS THEN
...
BEGIN
    BEGIN
        ...
        RAISE NOTICE '列权限撤销成功: users(password) <- readonly_user';
    EXCEPTION
        WHEN undefined_object THEN
            RAISE WARNING '表或角色不存在';
        WHEN OTHERS THEN
            RAISE WARNING '撤销列权限失败: %', SQLERRM;
            RAISE;
    END;
END $$;
```
...
BEGIN
    BEGIN
        IF NOT EXISTS (
            ...
            RAISE WARNING '函数 calculate_total(DECIMAL, INTEGER) 不存在';
            RETURN;
        END IF;
        IF NOT EXISTS (SELECT 1 FROM pg_roles WHERE rolname = 'app_user') THEN
            RAISE WARNING '角色 app_user 不存在';
        ...
        RAISE NOTICE '函数执行权限授予成功: calculate_total -> app_user';
    EXCEPTION
        WHEN undefined_object THEN
            RAISE WARNING '函数或角色不存在';
        WHEN OTHERS THEN
            RAISE WARNING '授予函数执行权限失败: %', SQLERRM;
            RAISE;
    END;
END $$;
...
BEGIN
    BEGIN
        ...
        RAISE NOTICE '所有函数的执行权限授予成功: public.* -> app_user';
    EXCEPTION
        WHEN undefined_object THEN
            RAISE WARNING 'Schema 或角色不存在';
        WHEN OTHERS THEN
            RAISE WARNING '授予所有函数权限失败: %', SQLERRM;
            RAISE;
    END;
END $$;
```
...
BEGIN
    BEGIN
        ...
        IF EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'orders' AND policyname = 'user_orders_policy') THEN
        ...
        RAISE NOTICE '策略 user_orders_policy 创建成功';
    EXCEPTION
        WHEN undefined_table THEN
            RAISE WARNING '表 orders 不存在';
        WHEN undefined_object THEN
...
BEGIN
    BEGIN
        ...
        RAISE NOTICE '用户ID=1 可以看到 % 条订单记录', row_count;
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '使用策略查询失败: %', SQLERRM;
            RAISE;
    END;
END $$;
...
BEGIN
    BEGIN
        ...
        IF EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'users' AND policyname = 'user_select_policy') THEN
    ...
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '创建 SELECT 策略失败: %', SQLERRM;
            RAISE;
    END;
END $$;
...
BEGIN
    BEGIN
        ...
        IF EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'users' AND policyname = 'user_insert_policy') THEN
            DROP POLICY user_insert_policy ON users;
        END IF;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '创建 INSERT 策略失败: %', SQLERRM;
            RAISE;
    END;
END $$;
...
BEGIN
    BEGIN
        ...
        RAISE NOTICE 'UPDATE 策略创建成功';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '创建 UPDATE 策略失败: %', SQLERRM;
            RAISE;
    END;
END $$;
...
BEGIN
    BEGIN
        ...
        IF EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'users' AND policyname = 'user_delete_policy') THEN
            DROP POLICY user_delete_policy ON users;
        END IF;
        ...
        TO app_user
        USING (id = current_setting('app.user_id')::INTEGER);
        RAISE NOTICE 'DELETE 策略创建成功';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '创建 DELETE 策略失败: %', SQLERRM;
            RAISE;
    END;
END $$;
```
...
BEGIN
    BEGIN
        ...
        IF EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'orders' AND policyname = 'role_based_policy') THEN
            DROP POLICY role_based_policy ON orders;
            RAISE NOTICE '已删除现有策略 role_based_policy';
        END IF;
        ...
        USING (
            CASE
                ...
                WHEN current_setting('app.user_role', true) = 'manager' THEN
                    department_id = (SELECT department_id FROM users WHERE id = current_setting('app.user_id', true)::INTEGER)
                ELSE user_id = current_setting('app.user_id', true)::INTEGER
            END
        );
        RAISE NOTICE '基于角色的 RLS 策略创建成功';
    EXCEPTION
        WHEN undefined_table THEN
            RAISE WARNING '表 orders 或 users 不存在';
        WHEN undefined_object THEN
            RAISE WARNING '角色 app_user 不存在';
        WHEN OTHERS THEN
            RAISE WARNING '创建基于角色的 RLS 策略失败: %', SQLERRM;
            RAISE;
    END;
END $$;
```
...
BEGIN
    BEGIN
        ...
        RAISE NOTICE '角色 app_user 有 % 个表权限', perm_count;
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '查看用户权限失败: %', SQLERRM;
            RAISE;
    END;
END $$;
...
BEGIN
    BEGIN
        SELECT EXISTS (SELECT 1 FROM pg_roles WHERE rolname = 'app_user') INTO role_exists;
        IF NOT role_exists THEN
            RAISE WARNING '角色 app_user 不存在';
            RETURN;
        END IF;

        RAISE NOTICE '角色 app_user 权限信息查询成功';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '查看角色权限失败: %', SQLERRM;
            RAISE;
    END;
END $$;
...
BEGIN
    BEGIN
        PERFORM grant_standard_permissions('readonly_user', 'public');
        RAISE NOTICE '标准权限授予成功';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '执行 grant_standard_permissions 失败: %', SQLERRM;
            RAISE;
    END;
END $$;
```
...
BEGIN
    ...
    BEGIN
        -- 验证表是否存在
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'users') THEN
            RAISE WARNING '表 users 不存在，无法授予权限';
            RETURN;
        END IF;

        -- 授予 Schema 使用权限
        GRANT USAGE ON SCHEMA public TO readonly_user;
        RAISE NOTICE 'Schema public 使用权限授予成功';

        -- 授予表 SELECT 权限
        GRANT SELECT ON users TO readonly_user;
        RAISE NOTICE '表 users 的 SELECT 权限授予成功';
    EXCEPTION
        WHEN undefined_object THEN
...
```sql
-- 1. 查看用户角色信息（使用psql命令，SQL中无法直接执行）
-- \du username
...
BEGIN
    BEGIN
        ...
        RAISE NOTICE '角色 username 有 % 个表权限', perm_count;
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '查看表权限失败: %', SQLERRM;
            RAISE;
...
BEGIN
    BEGIN
        ...
        SELECT COUNT(*) INTO inherit_count
        FROM pg_roles r
        JOIN pg_auth_members am ON r.oid = am.roleid
        JOIN pg_roles m ON am.member = m.oid
        WHERE r.rolname = 'app_user';

        RAISE NOTICE '角色 app_user 有 % 个继承关系', inherit_count;
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '查看角色继承关系失败: %', SQLERRM;
            RAISE;
    END;
END $$;
...
BEGIN
    BEGIN
        ...
        IF rls_enabled THEN
            RAISE NOTICE '表 orders 已启用行级安全';
        ELSE
            RAISE NOTICE '表 orders 未启用行级安全';
        END IF;
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '检查RLS状态失败: %', SQLERRM;
            RAISE;
    END;
END $$;
...
BEGIN
    BEGIN
        ...
        RAISE NOTICE '表 orders 有 % 个RLS策略', policy_count;
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '检查RLS策略失败: %', SQLERRM;
            RAISE;
    END;
END $$;
...
BEGIN
    ...
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '获取用户ID失败: %', SQLERRM;
            RETURN NULL;
    END;
END;
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'orders') THEN
            ...
            RETURN;
        END IF;
        IF NOT EXISTS (SELECT 1 FROM pg_proc p JOIN pg_namespace n ON p.pronamespace = n.oid WHERE n.nspname = 'public' AND p.proname = 'current_user_id') THEN
...
-- 2. 检查权限来源（直接授予还是通过角色，带错误处理和性能测试）
DO $$
DECLARE
    perm_count INT;
BEGIN
    BEGIN
        ...
        RAISE NOTICE '角色 username 有 % 个权限记录', perm_count;
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '检查权限来源失败: %', SQLERRM;
            RAISE;
    END;
END $$;
...
BEGIN
    BEGIN
        ...
        RAISE NOTICE '表权限撤销成功: orders <- app_user';
    EXCEPTION
        WHEN undefined_object THEN
            RAISE WARNING '表或角色不存在';
        WHEN OTHERS THEN
            RAISE WARNING '撤销表权限失败: %', SQLERRM;
            RAISE;
    END;
END $$;
...
BEGIN
    BEGIN
        ...
        RAISE NOTICE '所有表权限撤销成功: public.* <- app_user';
    EXCEPTION
        WHEN undefined_object THEN
            RAISE WARNING 'Schema 或角色不存在';
        WHEN OTHERS THEN
            RAISE WARNING '撤销所有权限失败: %', SQLERRM;
            RAISE;
    END;
END $$;
...
BEGIN
    BEGIN
        ...
        RAISE NOTICE '角色撤销成功: app_role <- app_user';
    EXCEPTION
        WHEN undefined_object THEN
            RAISE WARNING '角色不存在';
        WHEN OTHERS THEN
            RAISE WARNING '撤销角色失败: %', SQLERRM;
            RAISE;
    END;
END $$;
...
BEGIN
    BEGIN
        ...
        RAISE NOTICE '默认权限撤销成功: public.* <- app_user';
    EXCEPTION
        WHEN undefined_object THEN
            RAISE WARNING 'Schema 或角色不存在';
        WHEN OTHERS THEN
            RAISE WARNING '撤销默认权限失败: %', SQLERRM;
            RAISE;
    END;
END $$;
```
