...
> **📋 文档来源**: `DataBaseTheory\08-查询语言与语义\08.10-窗口聚合语义-稳定性与等价变换.md`
> **📅 复制日期**: 2025-12-22
...
INSERT INTO daily_sales (date, sales) VALUES
    ...
    ('2024-01-04', 1300.00),
    ('2024-01-05', 1250.00)
ON CONFLICT (date) DO UPDATE SET sales = EXCLUDED.sales;

INSERT INTO products (category, product, sales) VALUES
    ('Electronics', 'Laptop', 5000.00),
    ('Electronics', 'Phone', 3000.00),
    ('Clothing', 'Shirt', 500.00),
    ('Clothing', 'Pants', 600.00)
ON CONFLICT DO NOTHING;
