...
- [PostgreSQL 18 向量数据库实战指南](#postgresql-18-向量数据库实战指南)
  - [📑 目录](#-目录)
  - [1. pgvector架构](#1-pgvector架构)
    - [1.1 核心概念](#11-核心概念)
    - [1.2 数据类型](#12-数据类型)
  - [2. 索引策略](#2-索引策略)
...
EXCEPTION
    ...
    WHEN OTHERS THEN
        RAISE EXCEPTION '插入向量失败: %', SQLERRM;
END $$;
```
