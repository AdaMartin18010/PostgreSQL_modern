...
> **📋 文档来源**: `PostgreSQL_View\02-AI自治与自优化\强化学习优化器\训练与部署流程.md`
> **📅 复制日期**: 2025-12-22
...
- **[pg_ai 官方文档](https://github.com/postgresql/pg_ai)**
  - 版本: pg_ai 1.0+
  - 内容: pg_ai 扩展的完整文档，包括训练和部署流程
  - GitHub: <https://github.com/postgresql/pg_ai>
  - 最后更新: 2025年

- **[PostgreSQL 扩展开发文档](https://www.postgresql.org/docs/current/extend.html)**
  - 内容: PostgreSQL 扩展开发的完整指南
