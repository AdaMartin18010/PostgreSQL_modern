...
> **📋 文档来源**: `PostgreSQL培训\05-部署架构\【深入】PostgreSQL云原生Kubernetes完整实战指南.md`
> **📅 复制日期**: 2025-12-22
...
- [【深入】PostgreSQL云原生Kubernetes完整实战指南](#深入postgresql云原生kubernetes完整实战指南)
  - [📑 目录](#-目录)
  - [1. Kubernetes基础](#1-kubernetes基础)
    - [1.1 为什么选择Kubernetes运行PostgreSQL](#11-为什么选择kubernetes运行postgresql)
    - [1.2 快速开始（30分钟）](#12-快速开始30分钟)
  - [2. StatefulSet详解](#2-statefulset详解)
    - [2.1 StatefulSet vs Deployment](#21-statefulset-vs-deployment)
    - [2.2 StatefulSet完整配置](#22-statefulset完整配置)
  - [3. PostgreSQL Operator](#3-postgresql-operator)
    - [3.1 Operator模式](#31-operator模式)
    - [3.2 Zalando Postgres Operator](#32-zalando-postgres-operator)
    - [3.3 CloudNativePG Operator](#33-cloudnativepg-operator)
  - [4. 存储管理（PV/PVC）](#4-存储管理pvpvc)
    - [4.1 存储类（StorageClass）](#41-存储类storageclass)
    - [4.2 PVC扩容](#42-pvc扩容)
    - [4.3 存储性能优化](#43-存储性能优化)
  - [5. 配置管理（ConfigMap/Secret）](#5-配置管理configmapsecret)
    - [5.1 PostgreSQL配置（ConfigMap）](#51-postgresql配置configmap)
    - [5.2 密钥管理（Secret）](#52-密钥管理secret)
  - [6. 高可用架构](#6-高可用架构)
    - [6.1 基于Patroni的高可用](#61-基于patroni的高可用)
    - [6.2 自动故障切换测试](#62-自动故障切换测试)
  - [7. 监控和日志](#7-监控和日志)
    - [7.1 Prometheus监控](#71-prometheus监控)
    - [7.2 日志聚合（EFK/PLG）](#72-日志聚合efkplg)
  - [8. 备份和恢复](#8-备份和恢复)
    - [8.1 使用pgBackRest](#81-使用pgbackrest)
  - [9. 完整生产案例](#9-完整生产案例)
    - [9.1 电商平台PostgreSQL on Kubernetes](#91-电商平台postgresql-on-kubernetes)
  - [📚 参考资源](#-参考资源)
    - [Kubernetes官方](#kubernetes官方)
