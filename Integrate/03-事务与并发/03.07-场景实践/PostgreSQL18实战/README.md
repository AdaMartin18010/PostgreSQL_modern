...
1. **电商秒杀系统**（高并发OLTP）
   - [完整案例](../../../00-归档-项目管理文档/README.md) - 电商秒杀系统案例
   - 36,000字 + 1000行代码
   - QPS 105K+, TPS 25K+

2. **OLAP分析系统**（大数据分析）
   - [完整案例](../../../00-归档-项目管理文档/README.md) - OLAP分析系统案例
   - 18,000字 + 完整SQL
   - 查询时间-73%

3. **IoT时序系统**（高频写入）
   - [完整案例](../../../00-归档-项目管理文档/README.md) - IoT时序数据系统案例
   - 15,000字 + 完整SQL
   - 1M points/秒, 存储-88%
...
1. **先学MVCC理论**
   - [MVCC核心公理](../../../25-理论体系/公理系统/MVCC核心公理.md)
   - [MVCC可见性定理](../../../25-理论体系/形式化证明/MVCC可见性定理证明.md)

2. **再学ACID理论**
   - [ACID公理系统](../../../25-理论体系/公理系统/ACID公理系统.md)
   - [ACID属性定理](../../../25-理论体系/形式化证明/ACID属性定理证明.md)

3. **最后学CAP理论**
   - [CAP定理](../../../25-理论体系/CAP理论/CAP定理完整定义与证明.md)
   - [CAP权衡框架](../../../25-理论体系/CAP理论/CAP权衡决策框架.md)
