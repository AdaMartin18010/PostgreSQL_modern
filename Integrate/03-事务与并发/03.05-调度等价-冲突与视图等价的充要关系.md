...
- 📖 [MVCC正确性证明](../../90-事务与并发设计理论体系/03-证明与形式化/02-MVCC正确性证明.md) - PostgreSQL MVCC机制的完整正确性证明
- 📖 [核心理论模型](../../90-事务与并发设计理论体系/01-核心理论模型/README.md) - 事务与并发设计的核心理论基础
