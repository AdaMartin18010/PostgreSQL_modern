...
> **📋 文档来源**: `MVCC-ACID-CAP\25-理论体系\事务模型\隔离级别深度分析.md`
> **📅 复制日期**: 2025-12-22
...
BEGIN
    ...
    EXCEPTION
        WHEN undefined_table THEN
            ...
            END IF;
        WHEN OTHERS THEN
            RAISE WARNING '事务T1执行失败: %', SQLERRM;
            IF FOUND THEN
                ROLLBACK;
            END IF;
    END;
...
-- 事务T2（READ UNCOMMITTED，带错误处理和性能测试）
DO $$
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'accounts') THEN
        ...
        RAISE NOTICE '开始查询账户余额（READ UNCOMMITTED）';
    EXCEPTION
        WHEN OTHERS THEN
...
```sql
-- 事务T1（READ COMMITTED，带错误处理和性能测试）
DO $$
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'accounts') THEN
        ...
        RAISE NOTICE '事务T1：开始（READ COMMITTED）';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '设置隔离级别失败: %', SQLERRM;
            IF FOUND THEN
...
BEGIN
    ...
    EXCEPTION
        WHEN undefined_table THEN
            ...
            END IF;
        WHEN OTHERS THEN
            RAISE WARNING '事务T2执行失败: %', SQLERRM;
            IF FOUND THEN
                ROLLBACK;
            END IF;
    END;
...
```sql
-- 事务T1（REPEATABLE READ，带错误处理和性能测试）
DO $$
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'orders') THEN
            RAISE WARNING '表 orders 不存在，无法执行事务';
            RETURN;
        END IF;

        BEGIN;
        SET TRANSACTION ISOLATION LEVEL REPEATABLE READ;
        RAISE NOTICE '事务T1：开始（REPEATABLE READ）';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '设置隔离级别失败: %', SQLERRM;
            IF FOUND THEN
...
BEGIN
    BEGIN
        ...
        RAISE NOTICE '事务T1：开始（SERIALIZABLE）';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '设置隔离级别失败: %', SQLERRM;
            IF FOUND THEN
...
BEGIN
    BEGIN
        ...
        RAISE NOTICE '事务T1：UPDATE成功';
    EXCEPTION
        WHEN serialization_failure THEN
            RAISE WARNING 'SSI检测到冲突，事务T1回滚';
            IF FOUND THEN
                ROLLBACK;
            END IF;
        WHEN OTHERS THEN
...
1. **映射为READ COMMITTED**：
   ...
   ```sql
   -- PostgreSQL将READ UNCOMMITTED映射为READ COMMITTED（带错误处理）
   DO $$
   BEGIN
       BEGIN
           SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED;
           RAISE NOTICE '隔离级别已设置为READ UNCOMMITTED（实际效果等同于READ COMMITTED）';
       EXCEPTION
           WHEN OTHERS THEN
               RAISE WARNING '设置隔离级别失败: %', SQLERRM;
       END;
...
```sql
-- REPEATABLE READ使用快照隔离（带错误处理和性能测试）
DO $$
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'accounts') THEN
        ...
        BEGIN;
        SET TRANSACTION ISOLATION LEVEL REPEATABLE READ;
        RAISE NOTICE '事务开始（REPEATABLE READ）';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '设置隔离级别失败: %', SQLERRM;
            IF FOUND THEN
...
BEGIN
    BEGIN
        ...
        BEGIN;
        SET TRANSACTION ISOLATION LEVEL SERIALIZABLE;
        RAISE NOTICE '事务开始（SERIALIZABLE）';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '设置隔离级别失败: %', SQLERRM;
            IF FOUND THEN
...
-- 读取数据，创建SIREAD锁（带性能测试）
EXPLAIN (ANALYZE, BUFFERS, TIMING)
SELECT * FROM accounts WHERE balance > 1000;
-- SIREAD锁：accounts WHERE balance > 1000

-- 事务T2（SERIALIZABLE，带错误处理）
DO $$
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'accounts') THEN
        ...
        BEGIN;
        SET TRANSACTION ISOLATION LEVEL SERIALIZABLE;
        RAISE NOTICE '事务T2：开始（SERIALIZABLE）';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '设置隔离级别失败: %', SQLERRM;
            IF FOUND THEN
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'accounts') THEN
            RAISE WARNING '表 accounts 不存在，无法执行插入';
            RETURN;
        END IF;
        ...
        RAISE NOTICE '事务T2：插入成功';
    EXCEPTION
        WHEN serialization_failure THEN
            RAISE WARNING 'SSI检测到冲突，事务T2回滚';
            IF FOUND THEN
                ROLLBACK;
            END IF;
        WHEN unique_violation THEN
            RAISE WARNING '账户ID 10 已存在';
            IF FOUND THEN
                ROLLBACK;
            END IF;
        WHEN OTHERS THEN
...
-- 事务T1（REPEATABLE READ - 快照隔离，带错误处理和性能测试）
DO $$
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'accounts') THEN
...
-- 事务T2（REPEATABLE READ - 快照隔离，带错误处理和性能测试）
DO $$
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'accounts') THEN
        ...
        BEGIN;
        SET TRANSACTION ISOLATION LEVEL REPEATABLE READ;
        RAISE NOTICE '事务T2：开始（REPEATABLE READ）';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '设置隔离级别失败: %', SQLERRM;
            IF FOUND THEN
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'products') THEN
            RAISE WARNING '表 products 不存在，无法执行事务';
            RETURN;
        END IF;
...
BEGIN
    BEGIN
        ...
        BEGIN;
        SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED;
        RAISE NOTICE '事务T2：开始查询库存（READ UNCOMMITTED）';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '设置隔离级别失败: %', SQLERRM;
            IF FOUND THEN
...
BEGIN
    BEGIN
        ...
        RAISE NOTICE '事务T1已回滚，库存恢复为100';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '回滚事务T1失败: %', SQLERRM;
    END;
END $$;
...
```sql
-- PostgreSQL的READ COMMITTED防止脏读（带错误处理和性能测试）
DO $$
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'products') THEN
        ...
        BEGIN;
        SET TRANSACTION ISOLATION LEVEL READ COMMITTED;
        RAISE NOTICE '事务开始（READ COMMITTED）';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '设置隔离级别失败: %', SQLERRM;
            IF FOUND THEN
...
```sql
-- PostgreSQL的REPEATABLE READ防止不可重复读（带错误处理和性能测试）
DO $$
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'accounts') THEN
...
```sql
-- PostgreSQL的SERIALIZABLE防止幻读（带错误处理和性能测试）
DO $$
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'orders') THEN
