...
- [概念演化视角：一致性概念演进分析](#概念演化视角一致性概念演进分析)
  - [📑 目录](#-目录)
  - [📋 概述](#-概述)
  - [📊 第一部分：ACID中的"C"：事务层面的状态一致性](#-第一部分acid中的c事务层面的状态一致性)
    - [1.1 ACID一致性的定义](#11-acid一致性的定义)
    - [1.2 应用层面的概念](#12-应用层面的概念)
    - [1.3 实现机制](#13-实现机制)
  - [🔍 第二部分：CAP中的"C"：分布式环境下的线性一致性](#-第二部分cap中的c分布式环境下的线性一致性)
    - [2.1 CAP一致性的定义](#21-cap一致性的定义)
    - [2.2 系统层面的概念](#22-系统层面的概念)
    - [2.3 分布式环境的挑战](#23-分布式环境的挑战)
  - [🚀 第三部分：从统一到分化的概念演进](#-第三部分从统一到分化的概念演进)
    - [3.1 概念对比](#31-概念对比)
    - [3.2 概念分化的原因](#32-概念分化的原因)
    - [3.3 看似矛盾的说法](#33-看似矛盾的说法)
  - [📈 第四部分：概念分化的形式化模型](#-第四部分概念分化的形式化模型)
...
- [CAP理论的历史演进](../25-理论体系/CAP理论/CAP理论的历史演进.md)
