...
> **📋 文档来源**: `docs\04-Distributed\06-Citus分布式实战指南.md`
> **📅 复制日期**: 2025-12-22
...
- [PostgreSQL 18 + Citus 分布式实战指南](#postgresql-18--citus-分布式实战指南)
  - [📋 目录](#-目录)
  - [1. Citus架构](#1-citus架构)
    - [1.1 核心架构](#11-核心架构)
  - [2. 安装部署](#2-安装部署)
    - [2.1 安装Citus](#21-安装citus)
    - [2.2 集群配置](#22-集群配置)
  - [3. 表分片](#3-表分片)
    - [3.1 分布式表](#31-分布式表)
    - [3.2 引用表（小表）](#32-引用表小表)
  ...
  - [4. 查询路由](#4-查询路由)
    ...
    - [4.2 多分片查询](#42-多分片查询)
  - [5. JOIN优化](#5-join优化)
    - [5.1 Co-located JOIN](#51-co-located-join)
    - [5.2 Re-partition JOIN](#52-re-partition-join)
  - [6. 数据平衡](#6-数据平衡)
    - [6.1 分片重平衡](#61-分片重平衡)
    - [6.2 手动分片移动](#62-手动分片移动)
  - [7. 性能测试](#7-性能测试)
    - [7.1 写入性能](#71-写入性能)
    - [7.2 查询性能](#72-查询性能)
  - [8. 高可用配置](#8-高可用配置)
    - [8.1 Worker高可用](#81-worker高可用)
    - [8.2 Coordinator高可用](#82-coordinator高可用)
  - [9. 监控](#9-监控)
    - [9.1 Citus专用指标](#91-citus专用指标)
  - [10. 最佳实践](#10-最佳实践)
