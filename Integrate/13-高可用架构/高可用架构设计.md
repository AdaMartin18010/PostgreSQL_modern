...
class PatroniClusterManager:
    ...
    def get_cluster_status(self) -> Dict:
        """获取集群状态"""
        response = requests.get(f"{self.patroni_url}/cluster")
        return response.json()

    def get_node_status(self, node_name: str) -> Dict:
        """获取节点状态"""
        response = requests.get(f"{self.patroni_url}/patroni/{node_name}")
        return response.json()
    ...
    def failover(self, candidate: str = None) -> Dict:
        ...
        response = requests.post(f"{url}/failover", json=data)
        return response.json()

    def restart_node(self, node_name: str) -> Dict:
        """重启节点"""
        response = requests.post(f"{self.patroni_url}/patroni/{node_name}/restart")
        return response.json()

    def reload_config(self, node_name: str) -> Dict:
        """重新加载配置"""
        response = requests.post(f"{self.patroni_url}/patroni/{node_name}/reload")
        return response.json()
...
class HAProxyManager:
    ...
    def get_stats(self) -> List[Dict]:
        """获取统计信息"""
        response = requests.get(f"{self.stats_url}/stats;csv")
