...
> **📋 文档来源**: `PostgreSQL\06-运维实践\运维工具\README.md`
> **📅 复制日期**: 2025-12-22
...
- [PostgreSQL运维工具集](#postgresql运维工具集)
  - [目录](#目录)
  - [常用运维工具](#常用运维工具)
    - [1. pgAdmin](#1-pgadmin)
    - [2. pg\_top](#2-pg_top)
    - [3. pg\_stat\_statements](#3-pg_stat_statements)
    - [4. pgBadger](#4-pgbadger)
    - [5. pg\_activity](#5-pg_activity)
    - [6. pgbench](#6-pgbench)
    - [7. pg\_repack](#7-pg_repack)
    - [8. pgBackRest](#8-pgbackrest)
  - [自动化脚本](#自动化脚本)
    - [1. 数据库健康检查脚本](#1-数据库健康检查脚本)
    - [2. 自动VACUUM监控脚本](#2-自动vacuum监控脚本)
    - [3. 慢查询监控脚本](#3-慢查询监控脚本)
    - [4. 备份验证脚本](#4-备份验证脚本)
  - [实用工具集](#实用工具集)
    - [1. 数据库大小统计](#1-数据库大小统计)
...
- ⭐⭐⭐ [监控与诊断落地指南](../监控与诊断/12-监控与诊断/06.01-监控与诊断.md) - Prometheus + Grafana部署
- ⭐⭐ [性能调优变更闭环](../监控与诊断/30-性能调优/README.md) - 性能调优流程
