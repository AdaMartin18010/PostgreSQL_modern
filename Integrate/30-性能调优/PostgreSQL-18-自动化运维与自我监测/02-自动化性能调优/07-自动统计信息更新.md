...
- [2.7 自动统计信息更新](#27-自动统计信息更新)
  ...
  - [2.7.1 概述与背景](#271-概述与背景)
    - [2.7.1.1 什么是自动统计信息更新](#2711-什么是自动统计信息更新)
    - [2.7.1.2 问题背景](#2712-问题背景)
    - [2.7.1.3 PostgreSQL 18特性](#2713-postgresql-18特性)
  - [2.7.2 自动统计信息更新原理](#272-自动统计信息更新原理)
    - [2.7.2.1 更新流程](#2721-更新流程)
  - [2.7.3 更新策略决策树](#273-更新策略决策树)
    - [2.7.3.1 更新判断决策树](#2731-更新判断决策树)
    - [2.7.3.2 更新频率决策树](#2732-更新频率决策树)
    - [2.7.3.3 更新决策论证](#2733-更新决策论证)
  - [2.7.4 自动统计信息更新系统](#274-自动统计信息更新系统)
  - [2.7.5 更新策略说明](#275-更新策略说明)
    - [2.7.5.1 策略列表](#2751-策略列表)
    - [2.7.5.2 策略公式](#2752-策略公式)
  - [2.7.6 使用示例与实践](#276-使用示例与实践)
    - [2.7.6.1 基础使用示例](#2761-基础使用示例)
    - [2.7.6.2 高级实践](#2762-高级实践)
  - [2.7.7 性能优势与论证](#277-性能优势与论证)
    - [2.7.7.1 性能优势分析](#2771-性能优势分析)
    - [2.7.7.2 性能优势论证](#2772-性能优势论证)
  - [2.7.8 注意事项与最佳实践](#278-注意事项与最佳实践)
    - [2.7.8.1 注意事项](#2781-注意事项)
    - [2.7.8.2 最佳实践](#2782-最佳实践)
    - [2.7.8.3 故障排查](#2783-故障排查)
  - [2.7.9 导航](#279-导航)
    - [2.7.9.1 章节导航](#2791-章节导航)
    - [2.7.9.2 相关章节](#2792-相关章节)
  - [📚 参考资料](#-参考资料)
