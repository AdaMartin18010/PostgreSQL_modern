...
- [3.1 pg\_stat\_io增强监控](#31-pg_stat_io增强监控)
  ...
  - [3.1.1 概述与背景](#311-概述与背景)
    - [3.1.1.1 什么是pg\_stat\_io增强监控](#3111-什么是pg_stat_io增强监控)
    - [3.1.1.2 问题背景](#3112-问题背景)
    - [3.1.1.3 PostgreSQL 18新特性](#3113-postgresql-18新特性)
  - [3.1.2 pg\_stat\_io增强功能原理](#312-pg_stat_io增强功能原理)
    - [3.1.2.1 监控流程](#3121-监控流程)
  - [3.1.3 监控决策树](#313-监控决策树)
    - [3.1.3.1 I/O监控使用决策树](#3131-io监控使用决策树)
    - [3.1.3.2 I/O瓶颈识别决策树](#3132-io瓶颈识别决策树)
    - [3.1.3.3 监控决策论证](#3133-监控决策论证)
  - [3.1.4 pg\_stat\_io增强功能](#314-pg_stat_io增强功能)
    - [3.1.4.1 新增列说明](#3141-新增列说明)
  - [3.1.5 I/O统计查询](#315-io统计查询)
  - [3.1.6 PostgreSQL 18新增列](#316-postgresql-18新增列)
    - [3.1.6.1 完整视图说明](#3161-完整视图说明)
  - [3.1.7 使用示例与实践](#317-使用示例与实践)
    - [3.1.7.1 基础使用示例](#3171-基础使用示例)
    - [3.1.7.2 高级分析查询](#3172-高级分析查询)
  - [3.1.8 性能优势与论证](#318-性能优势与论证)
    - [3.1.8.1 性能优势分析](#3181-性能优势分析)
    - [3.1.8.2 性能优势论证](#3182-性能优势论证)
  - [3.1.9 注意事项与最佳实践](#319-注意事项与最佳实践)
    - [3.1.9.1 注意事项](#3191-注意事项)
    - [3.1.9.2 最佳实践](#3192-最佳实践)
    - [3.1.9.3 故障排查](#3193-故障排查)
  - [3.1.10 导航](#3110-导航)
    - [3.1.10.1 章节导航](#31101-章节导航)
    - [3.1.10.2 相关章节](#31102-相关章节)
  - [📚 参考资料](#-参考资料)
