...
详细内容请参考：[PostgreSQL-18-自动化运维与自我监测完整指南.md](./PostgreSQL-18-自动化运维与自我监测完整指南.md)
...
6. **启用自动化运维** - 使用PostgreSQL 18自动化运维功能
   ...
   -- 定期运行自动化健康检查
   -- 参考：PostgreSQL-18-自动化运维与自我监测完整指南.md
   ```
...
- [PostgreSQL-18-自动化运维与自我监测完整指南.md](./PostgreSQL-18-自动化运维与自我监测完整指南.md) - PostgreSQL 18自动化运维完整指南
