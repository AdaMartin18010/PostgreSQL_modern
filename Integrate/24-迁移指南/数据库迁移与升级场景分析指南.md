...
- [PostgreSQL数据库迁移与升级场景分析指南](#postgresql数据库迁移与升级场景分析指南)
  - [元数据](#元数据)
  - [🆕 PostgreSQL 18 升级增强](#-postgresql-18-升级增强)
    - [pg\_upgrade 保留优化器统计信息 ⭐⭐⭐⭐](#pg_upgrade-保留优化器统计信息-)
    - [MD5 密码认证迁移 ⚠️](#md5-密码认证迁移-️)
  - [📋 完整目录](#-完整目录)
  - [1. 迁移与升级概述](#1-迁移与升级概述)
    - [1.1 迁移体系](#11-迁移体系)
      - [迁移体系思维导图](#迁移体系思维导图)
