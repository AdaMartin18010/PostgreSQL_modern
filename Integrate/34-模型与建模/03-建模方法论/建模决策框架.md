...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'requirement_analysis') THEN
        ...
        RAISE NOTICE '表 requirement_analysis 创建成功';
    ELSE
        RAISE NOTICE '表 requirement_analysis 已存在，跳过创建';
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        RAISE EXCEPTION '创建表 requirement_analysis 失败: %', SQLERRM;
END $$;
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'data_characteristics') THEN
        ...
        RAISE NOTICE '表 data_characteristics 创建成功';
    ELSE
        RAISE NOTICE '表 data_characteristics 已存在，跳过创建';
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        RAISE EXCEPTION '创建表 data_characteristics 失败: %', SQLERRM;
END $$;
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'architecture_decision') THEN
        ...
        RAISE NOTICE '表 architecture_decision 创建成功';
    ELSE
        RAISE NOTICE '表 architecture_decision 已存在，跳过创建';
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        RAISE EXCEPTION '创建表 architecture_decision 失败: %', SQLERRM;
END $$;
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'model_decision') THEN
        ...
        RAISE NOTICE '表 model_decision 创建成功';
    ELSE
        RAISE NOTICE '表 model_decision 已存在，跳过创建';
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        RAISE EXCEPTION '创建表 model_decision 失败: %', SQLERRM;
END $$;
```
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'migration_strategy') THEN
        ...
        RAISE NOTICE '表 migration_strategy 创建成功';
    ELSE
        RAISE NOTICE '表 migration_strategy 已存在，跳过创建';
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        RAISE EXCEPTION '创建表 migration_strategy 失败: %', SQLERRM;
END $$;
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'modeling_decisions') THEN
        ...
        RAISE NOTICE '表 modeling_decisions 创建成功';
    ELSE
        RAISE NOTICE '表 modeling_decisions 已存在，跳过创建';
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        RAISE EXCEPTION '创建表 modeling_decisions 失败: %', SQLERRM;
END $$;
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'modeling_decision_log') THEN
        ...
        RAISE NOTICE '表 modeling_decision_log 创建成功';
    ELSE
        RAISE NOTICE '表 modeling_decision_log 已存在，跳过创建';
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        RAISE EXCEPTION '创建表 modeling_decision_log 失败: %', SQLERRM;
END $$;
