...
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'data_lake_catalog') THEN
        ...
        RAISE NOTICE '表 data_lake_catalog 创建成功';
    ELSE
        RAISE NOTICE '表 data_lake_catalog 已存在，跳过创建';
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        RAISE EXCEPTION '创建表 data_lake_catalog 失败: %', SQLERRM;
END $$;
...
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'data_lake_partitions') THEN
        ...
        RAISE NOTICE '表 data_lake_partitions 创建成功';
    ELSE
        RAISE NOTICE '表 data_lake_partitions 已存在，跳过创建';
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        RAISE EXCEPTION '创建表 data_lake_partitions 失败: %', SQLERRM;
END $$;
...
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'data_lake_layers') THEN
        ...
        RAISE NOTICE '表 data_lake_layers 创建成功';
    ELSE
        RAISE NOTICE '表 data_lake_layers 已存在，跳过创建';
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        RAISE EXCEPTION '创建表 data_lake_layers 失败: %', SQLERRM;
END $$;
...
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'data_lake_lineage') THEN
        ...
        RAISE NOTICE '表 data_lake_lineage 创建成功';
    ELSE
        RAISE NOTICE '表 data_lake_lineage 已存在，跳过创建';
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        RAISE EXCEPTION '创建表 data_lake_lineage 失败: %', SQLERRM;
END $$;
...
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'data_lake_quality_metrics') THEN
        ...
        RAISE NOTICE '分区表 data_lake_quality_metrics 创建成功';
    ELSE
        RAISE NOTICE '表 data_lake_quality_metrics 已存在，跳过创建';
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        RAISE EXCEPTION '创建分区表 data_lake_quality_metrics 失败: %', SQLERRM;
END $$;
...
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'data_lake_access_audit') THEN
        ...
        RAISE NOTICE '分区表 data_lake_access_audit 创建成功';
    ELSE
        RAISE NOTICE '表 data_lake_access_audit 已存在，跳过创建';
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        RAISE EXCEPTION '创建分区表 data_lake_access_audit 失败: %', SQLERRM;
END $$;
