...
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'data_products') THEN
        ...
        RAISE NOTICE '表 data_products 创建成功';
    ELSE
        RAISE NOTICE '表 data_products 已存在，跳过创建';
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        RAISE EXCEPTION '创建表 data_products 失败: %', SQLERRM;
END $$;
...
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'data_product_access') THEN
        ...
        RAISE NOTICE '表 data_product_access 创建成功';
    ELSE
        RAISE NOTICE '表 data_product_access 已存在，跳过创建';
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        RAISE EXCEPTION '创建表 data_product_access 失败: %', SQLERRM;
END $$;
...
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'data_domains') THEN
        ...
        RAISE NOTICE '表 data_domains 创建成功';
    ELSE
        RAISE NOTICE '表 data_domains 已存在，跳过创建';
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        RAISE EXCEPTION '创建表 data_domains 失败: %', SQLERRM;
END $$;
...
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'data_domain_relationships') THEN
        ...
        RAISE NOTICE '表 data_domain_relationships 创建成功';
    ELSE
        RAISE NOTICE '表 data_domain_relationships 已存在，跳过创建';
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        RAISE EXCEPTION '创建表 data_domain_relationships 失败: %', SQLERRM;
END $$;
...
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'data_catalog') THEN
        ...
        RAISE NOTICE '表 data_catalog 创建成功';
    ELSE
        RAISE NOTICE '表 data_catalog 已存在，跳过创建';
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        RAISE EXCEPTION '创建表 data_catalog 失败: %', SQLERRM;
END $$;

-- 创建全文搜索索引（PostgreSQL 18 GIN并行构建优化，带错误处理）
DO $$
BEGIN
...
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'data_quality_monitoring') THEN
        ...
        RAISE NOTICE '分区表 data_quality_monitoring 创建成功';
    ELSE
        RAISE NOTICE '表 data_quality_monitoring 已存在，跳过创建';
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        RAISE EXCEPTION '创建分区表 data_quality_monitoring 失败: %', SQLERRM;
END $$;
