...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'data_sources') THEN
        ...
        RAISE NOTICE '表 data_sources 创建成功';
    ELSE
        RAISE NOTICE '表 data_sources 已存在，跳过创建';
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        RAISE EXCEPTION '创建表 data_sources 失败: %', SQLERRM;
END $$;
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'data_pipelines') THEN
        ...
        RAISE NOTICE '表 data_pipelines 创建成功';
    ELSE
        RAISE NOTICE '表 data_pipelines 已存在，跳过创建';
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        RAISE EXCEPTION '创建表 data_pipelines 失败: %', SQLERRM;
END $$;
...
BEGIN
    ...
    CREATE INDEX IF NOT EXISTS idx_data_pipelines_target ON data_pipelines(target_id);
...
```sql
-- 管道执行记录表（使用TimescaleDB，带错误处理）
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'pipeline_executions') THEN
        ...
        RAISE NOTICE '表 pipeline_executions 创建成功';
    ELSE
        RAISE NOTICE '表 pipeline_executions 已存在，跳过创建';
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        RAISE EXCEPTION '创建表 pipeline_executions 失败: %', SQLERRM;
END $$;

-- 创建TimescaleDB超表（带错误处理）
DO $$
BEGIN
    ...
    RAISE NOTICE 'TimescaleDB超表创建成功';
EXCEPTION
    WHEN OTHERS THEN
        RAISE WARNING '创建TimescaleDB超表失败（可能需要先安装TimescaleDB扩展）: %', SQLERRM;
END $$;

-- 创建索引（带错误处理）
DO $$
BEGIN
    CREATE INDEX IF NOT EXISTS idx_pipeline_executions_pipeline ON pipeline_executions(pipeline_id, time DESC);
    CREATE INDEX IF NOT EXISTS idx_pipeline_executions_status ON pipeline_executions(status, time DESC);
    RAISE NOTICE '索引创建成功';
EXCEPTION
    WHEN OTHERS THEN
        RAISE WARNING '创建索引失败: %', SQLERRM;
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'data_warehouse_tables') THEN
        ...
        RAISE NOTICE '表 data_warehouse_tables 创建成功';
    ELSE
        RAISE NOTICE '表 data_warehouse_tables 已存在，跳过创建';
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        RAISE EXCEPTION '创建表 data_warehouse_tables 失败: %', SQLERRM;
END $$;

-- 创建索引（带错误处理）
DO $$
BEGIN
    CREATE INDEX IF NOT EXISTS idx_data_warehouse_tables_type ON data_warehouse_tables(table_type);
    CREATE INDEX IF NOT EXISTS idx_data_warehouse_tables_next_refresh ON data_warehouse_tables(next_refresh_at)
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'data_warehouse_quality_checks') THEN
        ...
        RAISE NOTICE '表 data_warehouse_quality_checks 创建成功';
    ELSE
        RAISE NOTICE '表 data_warehouse_quality_checks 已存在，跳过创建';
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        RAISE EXCEPTION '创建表 data_warehouse_quality_checks 失败: %', SQLERRM;
END $$;

-- 创建索引（带错误处理）
DO $$
BEGIN
    CREATE INDEX IF NOT EXISTS idx_data_warehouse_quality_checks_table ON data_warehouse_quality_checks(table_id);
    CREATE INDEX IF NOT EXISTS idx_data_warehouse_quality_checks_active ON data_warehouse_quality_checks(is_active) WHERE is_active = TRUE;
    RAISE NOTICE '索引创建成功';
EXCEPTION
    WHEN OTHERS THEN
        RAISE WARNING '创建索引失败: %', SQLERRM;
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'data_applications') THEN
        ...
        RAISE NOTICE '表 data_applications 创建成功';
    ELSE
        RAISE NOTICE '表 data_applications 已存在，跳过创建';
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        RAISE EXCEPTION '创建表 data_applications 失败: %', SQLERRM;
END $$;

-- 创建索引（带错误处理）
DO $$
BEGIN
    CREATE INDEX IF NOT EXISTS idx_data_applications_type ON data_applications(app_type);
    CREATE INDEX IF NOT EXISTS idx_data_applications_active ON data_applications(is_active) WHERE is_active = TRUE;
    RAISE NOTICE '索引创建成功';
EXCEPTION
    WHEN OTHERS THEN
        RAISE WARNING '创建索引失败: %', SQLERRM;
...
```sql
-- 数据应用使用统计表（使用TimescaleDB，带错误处理）
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'data_application_usage') THEN
        ...
        RAISE NOTICE '表 data_application_usage 创建成功';
    ELSE
        RAISE NOTICE '表 data_application_usage 已存在，跳过创建';
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        RAISE EXCEPTION '创建表 data_application_usage 失败: %', SQLERRM;
END $$;
...
DO $$
BEGIN
    CREATE INDEX IF NOT EXISTS idx_data_application_usage_app ON data_application_usage(app_id, time DESC);
    CREATE INDEX IF NOT EXISTS idx_data_application_usage_user ON data_application_usage(user_id, time DESC);
    CREATE INDEX IF NOT EXISTS idx_data_application_usage_status ON data_application_usage(status, time DESC);
    RAISE NOTICE '索引创建成功';
EXCEPTION
    WHEN OTHERS THEN
        RAISE WARNING '创建索引失败: %', SQLERRM;
