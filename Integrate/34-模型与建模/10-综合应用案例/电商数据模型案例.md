...
BEGIN
    BEGIN
        ...
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'orders') OR
           ...
           NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'fact_sales') OR
           ...
           NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'dim_customer') THEN
            RAISE EXCEPTION '必需的表不存在，请检查orders、order_items、fact_sales、dim_date、dim_product、dim_customer';
        END IF;
    EXCEPTION
        WHEN OTHERS THEN
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'orders') OR
           NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'order_items') OR
           NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'dim_date') OR
           NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'dim_product') THEN
            RAISE WARNING '必需的表不存在，无法执行ETL查询性能测试';
            RETURN;
        END IF;
        RAISE NOTICE '开始执行ETL查询性能测试';
    EXCEPTION
        WHEN OTHERS THEN
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'orders') OR
           ...
           NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'dim_product') OR
           NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'dim_customer') THEN
            RAISE WARNING '必需的表不存在，无法执行OLAP查询';
            RETURN;
        END IF;
        RAISE NOTICE '开始执行OLAP查询性能测试';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '查询准备失败: %', SQLERRM;
            RAISE;
...
DO $$
BEGIN
    IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'fact_sales') THEN
        CREATE TABLE IF NOT EXISTS fact_sales_2025_01 PARTITION OF fact_sales
            FOR VALUES FROM ('2025-01-01') TO ('2025-02-01');
        RAISE NOTICE '分区 fact_sales_2025_01 创建成功';
    ELSE
        RAISE WARNING '表 fact_sales 不存在，请先创建表';
    END IF;
EXCEPTION
    WHEN duplicate_table THEN
        RAISE NOTICE '分区 fact_sales_2025_01 已存在，跳过创建';
    WHEN OTHERS THEN
        RAISE WARNING '创建分区失败: %', SQLERRM;
END $$;
```
    ...
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'orders') OR
           NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'order_items') THEN
            RAISE WARNING '表 orders 或 order_items 不存在，无法执行查询';
            RETURN;
        END IF;
        RAISE NOTICE '开始执行用户订单查询';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '查询准备失败: %', SQLERRM;
            RAISE;
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'fact_sales') OR
           NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'dim_date') OR
           NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'dim_product') THEN
            RAISE WARNING '必需的表不存在，无法执行销售分析查询';
            RETURN;
        END IF;
        RAISE NOTICE '开始执行销售分析查询';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '查询准备失败: %', SQLERRM;
            RAISE;
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'fact_sales') OR
           NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'dim_date') OR
           NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'dim_product') THEN
            RAISE WARNING '必需的表不存在，无法执行OLAP聚合查询';
            RETURN;
        END IF;
        RAISE NOTICE '开始执行OLAP聚合查询性能测试';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '查询准备失败: %', SQLERRM;
            RAISE;
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'orders') THEN
            RAISE WARNING '表 orders 不存在，无法执行索引扫描查询';
            RETURN;
        END IF;
        RAISE NOTICE '开始执行索引扫描查询（仅扫描索引）';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '查询准备失败: %', SQLERRM;
    END;
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'orders') THEN
            RAISE WARNING '表 orders 不存在，无法执行覆盖索引查询测试';
            RETURN;
        END IF;
        RAISE NOTICE '开始执行覆盖索引查询性能测试';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '查询准备失败: %', SQLERRM;
            RAISE;
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'mv_sales_summary_monthly') THEN
            RAISE WARNING '物化视图 mv_sales_summary_monthly 不存在，无法执行查询';
            RETURN;
        END IF;
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.views WHERE table_schema = 'public' AND table_name = 'mv_sales_summary_monthly') AND
           NOT EXISTS (SELECT 1 FROM pg_matviews WHERE schemaname = 'public' AND matviewname = 'mv_sales_summary_monthly') THEN
            RAISE WARNING '物化视图 mv_sales_summary_monthly 不存在，无法执行查询测试';
            RETURN;
        END IF;
        RAISE NOTICE '开始执行物化视图查询性能测试';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '查询准备失败: %', SQLERRM;
            RAISE;
...
```sql
-- 优化：使用CDC（Change Data Capture，带错误处理）
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'cdc_orders_log') THEN
        ...
        RAISE NOTICE '表 cdc_orders_log 创建成功';
    ELSE
        RAISE NOTICE '表 cdc_orders_log 已存在，跳过创建';
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        RAISE EXCEPTION '创建表 cdc_orders_log 失败: %', SQLERRM;
END $$;
...
BEGIN
    BEGIN
        -- 检查日志表是否存在
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'cdc_orders_log') THEN
            RAISE WARNING '表 cdc_orders_log 不存在，跳过记录变更';
        ...
        IF TG_OP = 'INSERT' THEN
            IF NEW.order_id IS NULL THEN
                RAISE WARNING 'order_id为NULL，跳过记录';
                RETURN NEW;
            END IF;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '记录订单变更失败: %', SQLERRM;
            IF TG_OP = 'DELETE' THEN
                RETURN OLD;
            ELSE
                RETURN NEW;
...
```sql
-- 监控：订单处理性能（带错误处理和性能测试）
DO $$
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'orders') THEN
            RAISE WARNING '表 orders 不存在，无法执行监控查询';
            RETURN;
        END IF;
        RAISE NOTICE '开始执行订单处理性能监控查询';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '查询准备失败: %', SQLERRM;
            RAISE;
...
-- 监控：OLTP订单状态统计（带错误处理和性能测试）
DO $$
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'orders') THEN
            RAISE WARNING '表 orders 不存在，无法执行订单状态统计监控';
            RETURN;
        END IF;
        RAISE NOTICE '开始执行订单状态统计监控';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '查询准备失败: %', SQLERRM;
            RAISE;
...
-- 监控：OLAP查询性能（带错误处理和性能测试）
DO $$
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM pg_extension WHERE extname = 'pg_stat_statements') THEN
            RAISE WARNING 'pg_stat_statements扩展未安装，无法查看OLAP查询性能';
            RETURN;
        END IF;
        RAISE NOTICE '开始查询OLAP查询性能';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '查询准备失败: %', SQLERRM;
            RAISE;
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM pg_extension WHERE extname = 'pg_stat_statements') THEN
            ...
            RETURN;
        END IF;
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'pg_catalog' AND table_name = 'pg_stat_statements') THEN
            RAISE WARNING 'pg_stat_statements视图不存在，无法查看OLAP查询性能';
            RETURN;
        END IF;
        RAISE NOTICE '开始查询OLAP查询性能';
    EXCEPTION
...
```sql
-- 方案1：定时批量同步（推荐，带错误处理和性能测试）
DO $$
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM pg_proc WHERE proname = 'sync_orders_to_fact_sales') THEN
            RAISE WARNING '函数 sync_orders_to_fact_sales 不存在，无法执行同步';
            RETURN;
        END IF;
        RAISE NOTICE '开始执行定时批量同步（每小时执行）';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '同步准备失败: %', SQLERRM;
            RAISE;
    END;
END $$;

-- ETL函数调用性能测试（带错误处理和性能测试）
DO $$
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.routines WHERE routine_schema = 'public' AND routine_name = 'sync_orders_to_fact_sales') THEN
            RAISE WARNING '函数 sync_orders_to_fact_sales 不存在，无法执行性能测试';
            RETURN;
        END IF;
        RAISE NOTICE '开始执行ETL函数性能测试';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '函数检查失败: %', SQLERRM;
            RAISE;
    END;
END $$;

EXPLAIN (ANALYZE, BUFFERS, TIMING)
SELECT sync_orders_to_fact_sales();

-- 方案2：实时同步（小数据量）
-- 使用触发器在订单完成时立即同步（已在7.3节实现）
```
...
BEGIN
    BEGIN
        ...
        IF p_new_data IS NULL THEN
            RAISE EXCEPTION 'new_data不能为NULL';
        END IF;

        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'dim_product') THEN
            RAISE EXCEPTION '表 dim_product 不存在';
        END IF;
    EXCEPTION
        WHEN OTHERS THEN
    ...
    BEGIN
        ...
        IF v_updated_count = 0 THEN
            RAISE NOTICE '产品 % 没有当前版本，直接创建新版本', p_product_id;
        ELSE
            RAISE NOTICE '产品 % 的旧版本已关闭，新版本已创建', p_product_id;
        END IF;
    EXCEPTION
        WHEN not_null_violation THEN
            RAISE EXCEPTION '必填字段缺失，请检查product_name、category_name、price';
        WHEN OTHERS THEN
            RAISE WARNING '更新产品SCD2失败: %', SQLERRM;
            RAISE;
    END;
END;
$$ LANGUAGE plpgsql;
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'products') THEN
            RAISE WARNING '表 products 不存在，无法执行热门商品查询';
            RETURN;
        END IF;
        RAISE NOTICE '开始查询热门商品（预热缓存）';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '查询准备失败: %', SQLERRM;
    END;
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'products') THEN
            RAISE WARNING '表 products 不存在，无法执行商品查询性能测试';
            RETURN;
        END IF;
        RAISE NOTICE '开始执行商品查询性能测试';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '查询准备失败: %', SQLERRM;
            RAISE;
...
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'fact_sales_columnar') THEN
        ...
        RAISE NOTICE '列存表 fact_sales_columnar 创建成功';
    ELSE
        RAISE NOTICE '表 fact_sales_columnar 已存在，跳过创建';
    END IF;
EXCEPTION
    WHEN undefined_table THEN
        RAISE EXCEPTION '请先创建 fact_sales 表';
    WHEN OTHERS THEN
        RAISE EXCEPTION '创建列存表 fact_sales_columnar 失败: %', SQLERRM;
END $$;

-- 迁移数据到列存表
-- 数据迁移到列式存储（带错误处理和性能测试）
DO $$
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'fact_sales') THEN
            RAISE WARNING '表 fact_sales 不存在，无法迁移数据';
            RETURN;
        END IF;
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'fact_sales_columnar') THEN
            RAISE WARNING '表 fact_sales_columnar 不存在，无法迁移数据';
            RETURN;
        END IF;
        RAISE NOTICE '开始迁移数据到列式存储表';
    EXCEPTION
        WHEN OTHERS THEN
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'fact_sales') THEN
            RAISE WARNING '源表 fact_sales 不存在，无法迁移数据';
            RETURN;
        END IF;
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'fact_sales_columnar') THEN
            RAISE WARNING '目标表 fact_sales_columnar 不存在，无法迁移数据';
            RETURN;
        END IF;
        RAISE NOTICE '开始迁移数据到列式存储表';
    EXCEPTION
