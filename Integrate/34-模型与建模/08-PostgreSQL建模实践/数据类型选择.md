...
```sql
-- ❌ 错误：金融金额使用浮点（示例表，带错误处理）
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'bad_orders') THEN
        CREATE TABLE bad_orders (
            amount DOUBLE PRECISION  -- 精度损失风险
        );
        RAISE NOTICE '表 bad_orders 创建成功（反模式示例）';
    ELSE
        RAISE NOTICE '表 bad_orders 已存在，跳过创建';
    END IF;
EXCEPTION
    WHEN OTHERS THEN
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'good_orders') THEN
        CREATE TABLE good_orders (
            amount NUMERIC(10,2)  -- 精确计算
        );
        RAISE NOTICE '表 good_orders 创建成功';
    ELSE
        RAISE NOTICE '表 good_orders 已存在，跳过创建';
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        RAISE EXCEPTION '创建表 good_orders 失败: %', SQLERRM;
END $$;
```
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM pg_database WHERE datname = 'mydb') THEN
            ...
            RAISE NOTICE '数据库 mydb 创建成功（UTF8编码）';
        ELSE
            RAISE NOTICE '数据库 mydb 已存在，跳过创建';
        END IF;
    EXCEPTION
        WHEN insufficient_privilege THEN
            RAISE WARNING '权限不足，无法创建数据库（需要超级用户权限）';
        WHEN OTHERS THEN
...
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'users') THEN
        ...
        RAISE NOTICE '表 users 创建成功（collation示例）';
    ELSE
        RAISE NOTICE '表 users 已存在，跳过创建';
    END IF;
EXCEPTION
...
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'subscriptions') THEN
        ...
        RAISE NOTICE '表 subscriptions 创建成功';
    ELSE
        RAISE NOTICE '表 subscriptions 已存在，跳过创建';
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        RAISE EXCEPTION '创建表 subscriptions 失败: %', SQLERRM;
END $$;
...
BEGIN
    IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'subscriptions') THEN
        ...
        RAISE NOTICE '订阅数据插入成功';
    ELSE
        RAISE NOTICE '表 subscriptions 不存在，跳过插入';
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        RAISE WARNING '插入订阅数据失败: %', SQLERRM;
END $$;
```
...
BEGIN
    IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'products') THEN
        IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_products_attributes_gin') THEN
            CREATE INDEX idx_products_attributes_gin ON products USING GIN (attributes);
            RAISE NOTICE '索引 idx_products_attributes_gin 创建成功';
        ELSE
            RAISE NOTICE '索引 idx_products_attributes_gin 已存在，跳过创建';
        END IF;
        
        IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_products_attributes_gin_path') THEN
            CREATE INDEX idx_products_attributes_gin_path ON products USING GIN ((attributes->'tags'));
            RAISE NOTICE '索引 idx_products_attributes_gin_path 创建成功';
        ELSE
            RAISE NOTICE '索引 idx_products_attributes_gin_path 已存在，跳过创建';
        END IF;
    ELSE
...
EXCEPTION
    WHEN OTHERS THEN
        RAISE WARNING '创建JSONB GIN索引失败: %', SQLERRM;
END $$;
```
...
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'products') THEN
        ...
        RAISE NOTICE '表 products 创建成功（数组类型）';
    ELSE
        RAISE NOTICE '表 products 已存在，跳过创建';
    END IF;
EXCEPTION
...
BEGIN
    IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'products') THEN
        ...
        RAISE NOTICE '数组数据插入成功';
    ELSE
        RAISE NOTICE '表 products 不存在，跳过插入';
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        RAISE WARNING '插入数组数据失败: %', SQLERRM;
END $$;
...
BEGIN
    IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'products') THEN
        IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_products_tags_gin') THEN
            ...
            RAISE NOTICE '数组GIN索引创建成功';
        ELSE
            RAISE NOTICE '索引 idx_products_tags_gin 已存在，跳过创建';
        END IF;
    ELSE
        RAISE NOTICE '表 products 不存在，跳过索引创建';
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        RAISE WARNING '创建数组GIN索引失败: %', SQLERRM;
END $$;
```
...
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'users') THEN
        ...
        RAISE NOTICE '表 users 创建成功（布尔类型）';
    ELSE
        RAISE NOTICE '表 users 已存在，跳过创建';
    END IF;
EXCEPTION
...
```sql
-- Network devices表创建（网络地址类型，带错误处理）
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'network_devices') THEN
        ...
        RAISE NOTICE '表 network_devices 创建成功';
    ELSE
        RAISE NOTICE '表 network_devices 已存在，跳过创建';
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        RAISE EXCEPTION '创建表 network_devices 失败: %', SQLERRM;
END $$;
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'network_devices') THEN
            RAISE WARNING '表 network_devices 不存在，无法执行查询';
            RETURN;
        END IF;
        RAISE NOTICE '开始执行网络地址查询（网段内）';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '查询准备失败: %', SQLERRM;
    END;
...
BEGIN
    ...
    ELSE
        RAISE NOTICE 'PostGIS扩展已存在，跳过创建';
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        RAISE WARNING '创建PostGIS扩展失败: %', SQLERRM;
END $$;
```
...
BEGIN
    IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'locations') THEN
        ...
        RAISE NOTICE '坐标数据插入成功';
    ELSE
        RAISE NOTICE '表 locations 不存在，跳过插入';
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        RAISE WARNING '插入坐标数据失败: %', SQLERRM;
END $$;
...
BEGIN
    IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'locations') THEN
        IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_locations_geog') THEN
            CREATE INDEX idx_locations_geog ON locations USING GIST (geog_point);
            RAISE NOTICE 'GIST空间索引创建成功';
        ELSE
            RAISE NOTICE '索引 idx_locations_geog 已存在，跳过创建';
        END IF;
    ELSE
...
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_extension WHERE extname = 'uuid-ossp') THEN
        ...
        RAISE NOTICE 'UUID扩展创建成功';
    ELSE
        RAISE NOTICE 'UUID扩展已存在，跳过创建';
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        RAISE WARNING '创建UUID扩展失败: %', SQLERRM;
END $$;

-- Users表创建（UUID v4，带错误处理）
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'users') THEN
        CREATE TABLE users (
        ...
        RAISE NOTICE '表 users 创建成功（UUID v4）';
    ELSE
        RAISE NOTICE '表 users 已存在，跳过创建';
    END IF;
EXCEPTION
...
-- 或使用UUID v7（时间排序）
-- 需要安装pg_uuidv7扩展（带错误处理）
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_extension WHERE extname = 'pg_uuidv7') THEN
        CREATE EXTENSION IF NOT EXISTS pg_uuidv7;
        RAISE NOTICE 'pg_uuidv7扩展创建成功';
    ELSE
        RAISE NOTICE 'pg_uuidv7扩展已存在，跳过创建';
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        RAISE WARNING '创建pg_uuidv7扩展失败: %', SQLERRM;
END $$;

-- Orders表创建（UUID v7，带错误处理）
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'orders') THEN
        CREATE TABLE orders (
        ...
        RAISE NOTICE '表 orders 创建成功（UUID v7）';
    ELSE
        RAISE NOTICE '表 orders 已存在，跳过创建';
    END IF;
EXCEPTION
...
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'orders') THEN
        ...
        RAISE NOTICE '表 orders 创建成功（电商订单系统）';
    ELSE
        RAISE NOTICE '表 orders 已存在，跳过创建';
    END IF;
EXCEPTION
...
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'sensor_readings') THEN
        ...
        RAISE NOTICE '表 sensor_readings 创建成功（IoT传感器数据）';
    ELSE
...
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'users') THEN
        ...
        RAISE NOTICE '表 users 创建成功（用户系统）';
    ELSE
        RAISE NOTICE '表 users 已存在，跳过创建';
    END IF;
EXCEPTION
...
```sql
-- ❌ 错误：时间戳不使用时区（示例表，带错误处理）
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'bad_events') THEN
        CREATE TABLE bad_events (
            created_at TIMESTAMP  -- 时区问题
        );
        RAISE NOTICE '表 bad_events 创建成功（反模式示例）';
    ELSE
        RAISE NOTICE '表 bad_events 已存在，跳过创建';
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        RAISE WARNING '创建示例表失败: %', SQLERRM;
...
-- ✅ 正确：使用TIMESTAMPTZ（带错误处理）
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'good_events') THEN
        CREATE TABLE good_events (
            created_at TIMESTAMPTZ  -- 自动处理时区
        );
        RAISE NOTICE '表 good_events 创建成功';
    ELSE
        RAISE NOTICE '表 good_events 已存在，跳过创建';
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        RAISE EXCEPTION '创建表 good_events 失败: %', SQLERRM;
END $$;
```
...
```sql
-- ❌ 错误：文本字段使用VARCHAR限制过小（示例表，带错误处理）
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'bad_products') THEN
        CREATE TABLE bad_products (
            description VARCHAR(100)  -- 可能截断
        );
        RAISE NOTICE '表 bad_products 创建成功（反模式示例）';
    ELSE
        RAISE NOTICE '表 bad_products 已存在，跳过创建';
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        RAISE WARNING '创建示例表失败: %', SQLERRM;
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'good_products') THEN
        CREATE TABLE good_products (
            description TEXT  -- 无限制
        );
        RAISE NOTICE '表 good_products 创建成功';
    ELSE
        RAISE NOTICE '表 good_products 已存在，跳过创建';
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        RAISE EXCEPTION '创建表 good_products 失败: %', SQLERRM;
END $$;
```
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'test_int_types') THEN
        ...
        RAISE NOTICE '表 test_int_types 创建成功';
    ELSE
        RAISE NOTICE '表 test_int_types 已存在，跳过创建';
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        RAISE EXCEPTION '创建表 test_int_types 失败: %', SQLERRM;
END $$;

-- 插入测试数据（带错误处理）
DO $$
BEGIN
    IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'test_int_types') THEN
    ...
    ELSE
        RAISE NOTICE '表 test_int_types 不存在，跳过插入';
    END IF;
EXCEPTION
    WHEN OTHERS THEN
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'test_int_types') THEN
            RAISE WARNING '表 test_int_types 不存在，无法执行查询';
            RETURN;
        END IF;
        RAISE NOTICE '开始执行表大小查询';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '查询准备失败: %', SQLERRM;
    END;
...
```sql
-- 测试VARCHAR vs TEXT（带错误处理）
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'test_string_types') THEN
        CREATE TABLE test_string_types (
            id SERIAL PRIMARY KEY,
            varchar_col VARCHAR(100),
            text_col TEXT
        );
        RAISE NOTICE '表 test_string_types 创建成功';
    ELSE
        RAISE NOTICE '表 test_string_types 已存在，跳过创建';
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        RAISE EXCEPTION '创建表 test_string_types 失败: %', SQLERRM;
END $$;

-- 插入相同长度的数据（带错误处理）
DO $$
BEGIN
    IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'test_string_types') THEN
        INSERT INTO test_string_types (varchar_col, text_col)
        SELECT
            repeat('A', 50),
            repeat('A', 50)
        FROM generate_series(1, 1000000);
        RAISE NOTICE '字符串测试数据插入成功';
    ELSE
        RAISE NOTICE '表 test_string_types 不存在，跳过插入';
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        RAISE WARNING '插入字符串测试数据失败: %', SQLERRM;
END $$;
...
```sql
-- JSON：文本存储，插入快，查询慢（带错误处理）
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'test_json') THEN
        CREATE TABLE test_json (
            id SERIAL PRIMARY KEY,
            data JSON
        );
        RAISE NOTICE '表 test_json 创建成功';
    ELSE
        RAISE NOTICE '表 test_json 已存在，跳过创建';
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        RAISE EXCEPTION '创建表 test_json 失败: %', SQLERRM;
END $$;

-- JSONB：二进制存储，插入慢，查询快（带错误处理）
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'test_jsonb') THEN
        CREATE TABLE test_jsonb (
            id SERIAL PRIMARY KEY,
            data JSONB
        );
        RAISE NOTICE '表 test_jsonb 创建成功';
    ELSE
        RAISE NOTICE '表 test_jsonb 已存在，跳过创建';
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        RAISE EXCEPTION '创建表 test_jsonb 失败: %', SQLERRM;
END $$;
...
DECLARE
    ...
    end_time TIMESTAMP;
BEGIN
    IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'test_json') THEN
        start_time := clock_timestamp();
        INSERT INTO test_json (data)
        SELECT json_build_object('key', i, 'value', random())
        FROM generate_series(1, 1000000) i;
        end_time := clock_timestamp();
        RAISE NOTICE 'JSON插入完成，耗时: %', end_time - start_time;
    ELSE
        RAISE NOTICE '表 test_json 不存在，跳过插入';
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        RAISE WARNING 'JSON插入失败: %', SQLERRM;
END $$;
...
DECLARE
    ...
    end_time TIMESTAMP;
BEGIN
    IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'test_jsonb') THEN
        start_time := clock_timestamp();
        INSERT INTO test_jsonb (data)
        SELECT json_build_object('key', i, 'value', random())
        FROM generate_series(1, 1000000) i;
        end_time := clock_timestamp();
        RAISE NOTICE 'JSONB插入完成，耗时: %', end_time - start_time;
    ELSE
        RAISE NOTICE '表 test_jsonb 不存在，跳过插入';
    END IF;
EXCEPTION
    WHEN OTHERS THEN
        RAISE WARNING 'JSONB插入失败: %', SQLERRM;
END $$;

-- 查询性能测试（无索引，带性能测试和错误处理）
DO $$
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'test_json') THEN
            RAISE WARNING '表 test_json 不存在，无法执行查询';
            RETURN;
        END IF;
        RAISE NOTICE '开始执行JSON查询（无索引）';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '查询准备失败: %', SQLERRM;
    END;
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'test_jsonb') THEN
            RAISE WARNING '表 test_jsonb 不存在，无法执行查询';
            RETURN;
        END IF;
        RAISE NOTICE '开始执行JSONB查询（无索引）';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '查询准备失败: %', SQLERRM;
    END;
...
BEGIN
    IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'test_jsonb') THEN
        IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_jsonb') THEN
            CREATE INDEX idx_jsonb ON test_jsonb USING GIN (data);
            RAISE NOTICE 'JSONB GIN索引创建成功';
        ELSE
            RAISE NOTICE '索引 idx_jsonb 已存在，跳过创建';
        END IF;
        
        RAISE NOTICE '开始执行JSONB查询（有索引）';
    ELSE
        RAISE NOTICE '表 test_jsonb 不存在，跳过索引创建和查询';
    END IF;
EXCEPTION
    WHEN OTHERS THEN
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'test_int_perf') THEN
            ...
            RAISE NOTICE '表 test_int_perf 创建成功';
        ELSE
            RAISE NOTICE '表 test_int_perf 已存在，跳过创建';
        END IF;
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '创建表 test_int_perf 失败: %', SQLERRM;
    END;
END $$;
...
BEGIN
    BEGIN
        IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'test_int_perf') THEN
            ...
            RAISE NOTICE '测试数据插入成功';
        ELSE
            RAISE NOTICE '表 test_int_perf 不存在，跳过插入';
        END IF;
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '插入测试数据失败: %', SQLERRM;
...
BEGIN
    BEGIN
        IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'test_int_perf') THEN
            CREATE INDEX IF NOT EXISTS idx_small ON test_int_perf(small_col);
            CREATE INDEX IF NOT EXISTS idx_int ON test_int_perf(int_col);
            CREATE INDEX IF NOT EXISTS idx_bigint ON test_int_perf(big_col);
            RAISE NOTICE '索引创建成功';
        ELSE
            RAISE NOTICE '表 test_int_perf 不存在，跳过索引创建';
        END IF;
    EXCEPTION
        WHEN OTHERS THEN
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'test_int_perf') THEN
            RAISE WARNING '表 test_int_perf 不存在，无法执行查询';
            RETURN;
        END IF;
        RAISE NOTICE '开始执行整数类型性能测试查询';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '查询准备失败: %', SQLERRM;
    END;
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'test_int_perf') THEN
            RAISE WARNING '表 test_int_perf 不存在，无法执行性能测试';
            RETURN;
        END IF;
        RAISE NOTICE '开始执行整数类型性能测试';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '查询准备失败: %', SQLERRM;
    END;
...
EXPLAIN (ANALYZE, BUFFERS, TIMING) SELECT * FROM test_int_perf WHERE small_col = 10000;
-- Index Scan: 2.5ms

EXPLAIN (ANALYZE, BUFFERS, TIMING) SELECT * FROM test_int_perf WHERE int_col = 1000000;
-- Index Scan: 2.5ms

EXPLAIN (ANALYZE, BUFFERS, TIMING) SELECT * FROM test_int_perf WHERE big_col = 1000000000;
...
```sql
-- TIMESTAMP：无时区信息，存储小，但需要应用层处理时区（带错误处理）
DO $$
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'test_timestamp') THEN
            CREATE TABLE test_timestamp (
                id SERIAL PRIMARY KEY,
                ts TIMESTAMP
            );
            RAISE NOTICE '表 test_timestamp 创建成功';
        ELSE
            RAISE NOTICE '表 test_timestamp 已存在，跳过创建';
        END IF;
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '创建表 test_timestamp 失败: %', SQLERRM;
    END;
END $$;

-- TIMESTAMPTZ：有时区信息，存储相同，自动处理时区（带错误处理）
DO $$
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'test_timestamptz') THEN
            CREATE TABLE test_timestamptz (
                id SERIAL PRIMARY KEY,
                ts TIMESTAMPTZ
            );
            RAISE NOTICE '表 test_timestamptz 创建成功';
        ELSE
            RAISE NOTICE '表 test_timestamptz 已存在，跳过创建';
        END IF;
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '创建表 test_timestamptz 失败: %', SQLERRM;
    END;
END $$;
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'test_index_sizes') THEN
            ...
            RAISE NOTICE '表 test_index_sizes 创建成功';
        ELSE
            RAISE NOTICE '表 test_index_sizes 已存在，跳过创建';
        END IF;
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '创建表 test_index_sizes 失败: %', SQLERRM;
    END;
END $$;
...
BEGIN
    BEGIN
        IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'test_index_sizes') THEN
            ...
            RAISE NOTICE '测试数据插入成功';
        ELSE
            RAISE NOTICE '表 test_index_sizes 不存在，跳过插入';
        END IF;
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '插入测试数据失败: %', SQLERRM;
...
BEGIN
    BEGIN
        IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'test_index_sizes') THEN
            CREATE INDEX IF NOT EXISTS idx_int ON test_index_sizes(int_col);
            CREATE INDEX IF NOT EXISTS idx_bigint ON test_index_sizes(bigint_col);
            CREATE INDEX IF NOT EXISTS idx_varchar ON test_index_sizes(varchar_col);
            CREATE INDEX IF NOT EXISTS idx_text ON test_index_sizes(text_col);
            CREATE INDEX IF NOT EXISTS idx_jsonb ON test_index_sizes USING GIN (jsonb_col);
            CREATE INDEX IF NOT EXISTS idx_timestamp ON test_index_sizes(timestamp_col);
            RAISE NOTICE '索引创建成功';
        ELSE
            RAISE NOTICE '表 test_index_sizes 不存在，跳过索引创建';
        END IF;
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '创建索引失败: %', SQLERRM;
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'test_index_sizes') THEN
            RAISE WARNING '表 test_index_sizes 不存在，无法执行查询';
            RETURN;
        END IF;
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'test_index_sizes') THEN
            RAISE WARNING '表 test_index_sizes 不存在，无法执行索引性能测试';
            RETURN;
        END IF;
        RAISE NOTICE '开始执行索引大小性能测试';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '查询准备失败: %', SQLERRM;
    END;
...
EXPLAIN (ANALYZE, BUFFERS, TIMING) SELECT * FROM test_index_sizes WHERE int_col = 500000;
-- Index Scan: 2.5ms

EXPLAIN (ANALYZE, BUFFERS, TIMING) SELECT * FROM test_index_sizes WHERE bigint_col = 500000;
-- Index Scan: 2.8ms

EXPLAIN (ANALYZE, BUFFERS, TIMING) SELECT * FROM test_index_sizes WHERE varchar_col = 'varchar_500000';
-- Index Scan: 3.0ms

EXPLAIN (ANALYZE, BUFFERS, TIMING) SELECT * FROM test_index_sizes WHERE jsonb_col @> '{"key": 500000}';
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'application_logs') THEN
            ...
            RAISE NOTICE '表 application_logs 创建成功';
        ELSE
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'application_logs') THEN
            RAISE WARNING '表 application_logs 不存在，无法执行查询';
            RETURN;
        END IF;
        RAISE NOTICE '开始执行日志查询';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '查询准备失败: %', SQLERRM;
    END;
...
BEGIN
    BEGIN
        ...
        ELSE
            RAISE NOTICE '表 tenants 已存在，跳过创建';
        END IF;
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '创建表 tenants 失败: %', SQLERRM;
    END;
END $$;
...
BEGIN
    ...
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '创建表 tenant_data 失败: %', SQLERRM;
    END;
END $$;
...
BEGIN
    ...
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '创建表 locations 失败: %', SQLERRM;
    END;
END $$;

-- 查询附近的位置（距离查询，带错误处理和性能测试）
DO $$
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'locations') THEN
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'orders') THEN
            RAISE WARNING '表 orders 不存在，无法执行插入操作';
            RETURN;
        END IF;
        INSERT INTO orders (notes)
        VALUES (REPEAT('A', 1000))
        ON CONFLICT DO NOTHING;
        RAISE NOTICE '验证插入成功，不再截断';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '验证插入失败: %', SQLERRM;
    END;
END $$;
...
BEGIN
    BEGIN
        ...
        ON CONFLICT DO NOTHING;  -- 自动处理时区
        RAISE NOTICE 'TIMESTAMPTZ插入成功，自动处理时区';
    EXCEPTION
        WHEN OTHERS THEN
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'application_logs') THEN
            RAISE WARNING '表 application_logs 不存在，无法创建索引';
            RETURN;
        END IF;
        IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_log_level_service') THEN
            CREATE INDEX idx_log_level_service
            ON application_logs USING GIN (
                (log_data->>'level'),
                (log_data->>'service')
            );
            RAISE NOTICE '表达式索引 idx_log_level_service 创建成功';
        ELSE
            RAISE NOTICE '索引 idx_log_level_service 已存在，跳过创建';
        END IF;
        -- 注意：表达式索引只支持B-Tree，不支持GIN
        -- 但可以用于等值查询
    EXCEPTION
        WHEN undefined_table THEN
            RAISE WARNING '表 application_logs 不存在';
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'application_logs') THEN
            RAISE WARNING '表 application_logs 不存在，无法创建触发器';
            RETURN;
        END IF;
        ...
        END;
        $$ LANGUAGE plpgsql;
        RAISE NOTICE '函数 update_log_fields 创建成功';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '创建函数 update_log_fields 失败: %', SQLERRM;
    END;
END $$;
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'application_logs') THEN
            ...
            RETURN;
        END IF;
        IF NOT EXISTS (SELECT 1 FROM pg_proc WHERE proname = 'update_log_fields') THEN
            RAISE WARNING '函数 update_log_fields 不存在，无法创建触发器';
            RETURN;
        END IF;
        DROP TRIGGER IF EXISTS trg_update_log_fields ON application_logs;
        CREATE TRIGGER trg_update_log_fields
        BEFORE INSERT OR UPDATE ON application_logs
        FOR EACH ROW
        EXECUTE FUNCTION update_log_fields();
        RAISE NOTICE '触发器 trg_update_log_fields 创建成功';
    EXCEPTION
        WHEN undefined_table THEN
            RAISE WARNING '表 application_logs 不存在';
        WHEN undefined_function THEN
            RAISE WARNING '函数 update_log_fields 不存在';
        WHEN OTHERS THEN
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'application_logs') THEN
            ...
            RETURN;
        END IF;
        IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_log_level_service_btree') THEN
            CREATE INDEX idx_log_level_service_btree
            ON application_logs(log_level, log_service);
            RAISE NOTICE '索引 idx_log_level_service_btree 创建成功';
        ELSE
            RAISE NOTICE '索引 idx_log_level_service_btree 已存在，跳过创建';
        END IF;
    EXCEPTION
        WHEN undefined_table THEN
            RAISE WARNING '表 application_logs 不存在';
...
-- 方案4：规范化设计（如果查询复杂，带错误处理）
-- 1. 创建标签关联表
DO $$
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'product_tags') THEN
            IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'products') THEN
                RAISE WARNING '表 products 不存在，无法创建外键关联表 product_tags';
                RETURN;
            END IF;
            ...
            RAISE NOTICE '表 product_tags 创建成功';
        ELSE
            RAISE NOTICE '表 product_tags 已存在，跳过创建';
        END IF;
    EXCEPTION
        WHEN duplicate_table THEN
            RAISE NOTICE '表 product_tags 已存在';
        WHEN foreign_key_violation THEN
            RAISE WARNING '外键约束违反，表 products 可能不存在';
        WHEN OTHERS THEN
            RAISE WARNING '创建表 product_tags 失败: %', SQLERRM;
    END;
END $$;
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'product_tags') THEN
            RAISE WARNING '表 product_tags 不存在，无法创建索引';
            RETURN;
        END IF;
        IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_product_tags_tag') THEN
            CREATE INDEX idx_product_tags_tag ON product_tags(tag);
            RAISE NOTICE '索引 idx_product_tags_tag 创建成功';
        ELSE
            RAISE NOTICE '索引 idx_product_tags_tag 已存在，跳过创建';
        END IF;
    EXCEPTION
        WHEN undefined_table THEN
            RAISE WARNING '表 product_tags 不存在';
        WHEN duplicate_table THEN
            RAISE NOTICE '索引已存在';
        WHEN OTHERS THEN
            RAISE WARNING '创建索引失败: %', SQLERRM;
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'products') OR
           NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'product_tags') THEN
            RAISE WARNING '必需的表不存在（products或product_tags），无法执行数据迁移';
            RETURN;
        END IF;
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'order_status') THEN
            ...
            RAISE NOTICE '枚举类型 order_status 创建成功';
        ELSE
            RAISE NOTICE '枚举类型 order_status 已存在，跳过创建';
        END IF;
    EXCEPTION
        WHEN duplicate_object THEN
            RAISE NOTICE '枚举类型 order_status 已存在';
        WHEN OTHERS THEN
            RAISE WARNING '创建枚举类型失败: %', SQLERRM;
    END;
END $$;
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'orders') THEN
            IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'order_status') THEN
                RAISE WARNING '枚举类型 order_status 不存在，无法创建表 orders';
                RETURN;
            END IF;
            CREATE TABLE orders (
                order_id BIGSERIAL PRIMARY KEY,
            ...
            RAISE NOTICE '表 orders 创建成功（使用枚举类型）';
        ELSE
            RAISE NOTICE '表 orders 已存在，跳过创建';
        END IF;
    EXCEPTION
        ...
        WHEN undefined_object THEN
            RAISE WARNING '枚举类型 order_status 不存在';
        WHEN OTHERS THEN
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'email_address') THEN
            ...
            RAISE NOTICE '域类型 email_address 创建成功';
        ELSE
            RAISE NOTICE '域类型 email_address 已存在，跳过创建';
        END IF;
    EXCEPTION
        WHEN duplicate_object THEN
            RAISE NOTICE '域类型 email_address 已存在';
        WHEN OTHERS THEN
            RAISE WARNING '创建域类型失败: %', SQLERRM;
    END;
END $$;
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'users') THEN
            IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'email_address') THEN
                RAISE WARNING '域类型 email_address 不存在，无法创建表 users';
                RETURN;
            END IF;
            CREATE TABLE users (
            ...
            RAISE NOTICE '表 users 创建成功（使用域类型）';
        ELSE
            RAISE NOTICE '表 users 已存在，跳过创建';
        END IF;
    EXCEPTION
        ...
        WHEN undefined_object THEN
            RAISE WARNING '域类型 email_address 不存在';
        WHEN OTHERS THEN
...
```sql
-- PostgreSQL 18支持UUID v7（时间排序的UUID，带错误处理）
DO $$
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM pg_extension WHERE extname = 'pg_uuidv7') THEN
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'orders') THEN
            IF NOT EXISTS (SELECT 1 FROM pg_proc WHERE proname = 'uuid_generate_v7') THEN
                RAISE WARNING '函数 uuid_generate_v7 不存在，无法创建表 orders';
                RETURN;
            END IF;
            CREATE TABLE orders (
    ...
    EXCEPTION
        WHEN duplicate_table THEN
            RAISE NOTICE '表 orders 已存在';
        WHEN undefined_function THEN
            RAISE WARNING '函数 uuid_generate_v7 不存在';
        WHEN OTHERS THEN
            RAISE WARNING '创建表 orders 失败: %', SQLERRM;
    END;
END $$;
...
```sql
-- PostgreSQL 18改进了NUMERIC类型的计算性能（带错误处理）
DO $$
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'orders') THEN
            RAISE WARNING '表 orders 不存在，无法执行NUMERIC性能测试';
            RETURN;
        END IF;
        RAISE NOTICE '开始执行NUMERIC类型性能测试（PostgreSQL 18改进）';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '查询准备失败: %', SQLERRM;
    END;
...
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'orders') THEN
            RAISE WARNING '表 orders 不存在，无法执行复杂NUMERIC计算测试';
            RETURN;
        END IF;
        RAISE NOTICE '开始执行复杂NUMERIC计算性能测试';
    EXCEPTION
        WHEN OTHERS THEN
            RAISE WARNING '查询准备失败: %', SQLERRM;
    END;
...
```sql
-- PostgreSQL 18改进了JSONB查询性能（带错误处理）
DO $$
BEGIN
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'table_name') THEN
            RAISE WARNING '表 table_name 不存在，无法创建索引';
            RETURN;
        END IF;
        IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_data_gin') THEN
            CREATE INDEX idx_data_gin ON table_name USING GIN (jsonb_column);
            RAISE NOTICE 'GIN索引 idx_data_gin 创建成功';
        ELSE
            RAISE NOTICE '索引 idx_data_gin 已存在，跳过创建';
        END IF;
    EXCEPTION
        WHEN undefined_table THEN
