...
```sql
-- PostgreSQL 18改进了B-Tree索引的插入和查询性能
CREATE INDEX idx_orders_date ON orders(order_date);
-- 插入性能提升约10-15%
-- 查询性能提升约5-10%
