...
> **文档状态**: 🔄 全面扩展中（基于现有4个核心概念文档深化扩展）
> **当前进度**: 4个核心文档已完成，正在系统化整理和扩展中
> **扩展方向**: 增加理论深度、实践案例、权威资源对齐、PostgreSQL特定实现
...
│   └── 开源数据模型.md                # AdventureWorks、Sakila等
├── 03-建模方法论/
...
│   ├── Party模型.md                   # 通用人员组织模型
│   ├── 订单管理模型.md                # 订单、支付、物流
│   └── PostgreSQL实现.md             # PostgreSQL特定实现
├── 05-OLAP建模/
│   ├── 维度建模基础.md                # 星型模式、雪花模式
...
│   ├── 反模式识别.md                  # 常见错误与代价
│   ├── 重构策略.md                    # 模型重构方法
│   └── 最佳实践.md                    # PostgreSQL建模最佳实践
├── 10-综合应用案例/
│   ├── 电商数据模型案例.md            # 完整电商模型设计
│   ├── IoT监控系统案例.md             # 时序数据建模案例
│   ├── 数据仓库案例.md                # OLAP建模案例
│   └── 工作流引擎案例.md              # BPMN实现案例
└── 原始文档/
