...
本文档专注于音乐推荐场景的特定实现细节。通用架构和最佳实践请参考通用文档。

**原始文档来源**: `PostgreSQL_View\08-落地案例\音乐场景\智能音乐推荐系统.md`
...
SELECT *
FROM songs
WHERE metadata @> '{"genre": "流行", "duration": {"$gt": 180}}'::jsonb
...
- [智能视频推荐系统-详细实现](../视频场景/智能视频推荐系统-详细实现.md) - 视频场景实现
