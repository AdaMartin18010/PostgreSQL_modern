...
- [PostgreSQL失败案例库](#postgresql失败案例库)
  ...
  - [6. 并发控制失败案例](#6-并发控制失败案例)
    - [6.1 案例5：死锁导致事务失败](#61-案例5死锁导致事务失败)
    - [6.2 案例6：长时间事务导致锁等待](#62-案例6长时间事务导致锁等待)
  - [7. 索引失败案例](#7-索引失败案例)
    - [7.1 案例7：索引过多导致写入性能下降](#71-案例7索引过多导致写入性能下降)
    - [7.2 案例8：索引顺序错误导致查询性能差](#72-案例8索引顺序错误导致查询性能差)
  - [8. PostgreSQL 18特性使用失败案例](#8-postgresql-18特性使用失败案例)
    - [8.1 案例9：异步I/O配置错误](#81-案例9异步io配置错误)
    - [8.2 案例10：并行查询配置不当](#82-案例10并行查询配置不当)
  - [9. 监控告警失败案例](#9-监控告警失败案例)
    - [9.1 案例11：缺少监控导致问题发现延迟](#91-案例11缺少监控导致问题发现延迟)
    - [9.2 案例12：告警阈值设置不当](#92-案例12告警阈值设置不当)
  - [10. 经验教训总结](#10-经验教训总结)
    - [10.1 配置教训](#101-配置教训)
    - [10.2 性能教训](#102-性能教训)
    - [10.3 高可用教训](#103-高可用教训)
    - [10.4 并发控制教训](#104-并发控制教训)
    - [10.5 PostgreSQL 18特性使用教训](#105-postgresql-18特性使用教训)
  - [11. 预防措施](#11-预防措施)
    - [11.1 配置管理](#111-配置管理)
    - [11.2 性能管理](#112-性能管理)
    - [11.3 高可用管理](#113-高可用管理)
  - [📚 相关文档](#-相关文档)
