...
> **📋 文档来源**: `DataBaseTheory\19-场景案例库\03-IoT时序数据系统\06-部署运维.md`
> **📅 复制日期**: 2025-12-22
...
EXCEPTION
    WHEN OTHERS THEN
        RAISE EXCEPTION '自动压缩失败: %', SQLERRM;
END;
$$ LANGUAGE plpgsql;
```
...
WHERE timestamp BETWEEN $1 AND $2  -- 必须包含时间范围
  AND device_id = $3;
```
