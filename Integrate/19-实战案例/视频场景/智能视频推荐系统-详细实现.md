...
> **创建日期**: 2025年1月
> **用途**: 视频推荐场景的详细实现文档
> **通用架构**: 请参考 [通用推荐系统架构](../通用推荐系统架构.md)

---

## 📋 文档说明

本文档专注于视频推荐场景的特定实现细节。通用架构和最佳实践请参考通用文档。

**原始文档来源**: `PostgreSQL_View\08-落地案例\视频场景\智能视频推荐系统.md`
...
SELECT *
FROM videos
WHERE metadata @> '{"category": "科技", "duration": {"$gt": 300}}'::jsonb
...
- [智能音乐推荐系统-详细实现](../音乐场景/智能音乐推荐系统-详细实现.md) - 音乐场景实现
- [实时推荐系统](../07-实时推荐系统/) - 实时推荐系统完整案例
