...
> **📋 文档来源**: `PostgreSQL_View\08-落地案例\服装场景\智能服装设计系统.md`
> **📅 复制日期**: 2025-12-22
...
- [智能服装设计系统](#智能服装设计系统)
  ...
  - [7. 参考资料](#7-参考资料)
  - [8. 完整代码示例](#8-完整代码示例)
    - [8.1 服装设计数据表创建](#81-服装设计数据表创建)
    - [8.2 服装设计推荐实现](#82-服装设计推荐实现)
...
CREATE TABLE designs (
    ...
    color_vector vector(128),  -- 颜色向量
    pattern_vector vector(256),  -- 图案向量
    created_at TIMESTAMPTZ DEFAULT NOW(),
