...
> **📋 文档来源**: `PostgreSQL_View\08-落地案例\翻译场景\智能翻译系统.md`
> **📅 复制日期**: 2025-12-22
...
- [智能翻译系统](#智能翻译系统)
  ...
  - [7. 参考资料](#7-参考资料)
  - [8. 完整代码示例](#8-完整代码示例)
    - [8.1 翻译数据表创建](#81-翻译数据表创建)
    - [8.2 翻译服务实现](#82-翻译服务实现)
...
CREATE TABLE translation_memory (
    ...
    target_lang TEXT NOT NULL,
    source_vector vector(512),  -- 源文本向量
    target_vector vector(512),  -- 目标文本向量
    domain TEXT,  -- 'technical', 'legal', 'medical', etc.
    quality_score DECIMAL(3, 2),  -- 质量分数（0-1）
    usage_count INTEGER DEFAULT 0,
    created_at TIMESTAMPTZ DEFAULT NOW(),
...
# 查找翻译（需要先获取源文本向量）
# source_vector = get_embedding("Hello world")  # 假设有获取向量的函数
