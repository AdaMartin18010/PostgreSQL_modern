...
> **📋 文档来源**: `PostgreSQL_View\08-落地案例\供应链场景\智能供应链管理系统.md`
> **📅 复制日期**: 2025-12-22
...
- [智能供应链管理系统](#智能供应链管理系统)
  ...
  - [7. 参考资料](#7-参考资料)
  - [8. 完整代码示例](#8-完整代码示例)
    - [8.1 供应链数据表创建](#81-供应链数据表创建)
    - [8.2 供应链管理系统实现](#82-供应链管理系统实现)
...
for supplier in nearby:
    print(f"供应商: {supplier['supplier_name']}, 距离: {supplier['distance_km']:.2f}km")
...
for rec in recommendations:
    print(f"推荐供应商: {rec['supplier_name']}, 分数: {rec['score']:.4f}")
