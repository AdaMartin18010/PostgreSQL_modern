...
> **📋 文档来源**: `PostgreSQL_View\08-落地案例\化妆品场景\智能美妆推荐系统.md`
> **📅 复制日期**: 2025-12-22
...
- [智能美妆推荐系统](#智能美妆推荐系统)
  ...
  - [7. 参考资料](#7-参考资料)
  - [8. 完整代码示例](#8-完整代码示例)
    - [8.1 美妆数据表创建](#81-美妆数据表创建)
    - [8.2 美妆推荐实现](#82-美妆推荐实现)
...
CREATE TABLE cosmetics (
    ...
    ingredient_vector vector(512),  -- 成分向量
    effect_vector vector(256),  -- 效果向量
    price DECIMAL(10, 2),
    created_at TIMESTAMPTZ DEFAULT NOW(),
...
CREATE TABLE user_skin_profiles (
    ...
    ingredient_allergies TEXT[],  -- 过敏成分数组
    updated_at TIMESTAMPTZ DEFAULT NOW(),
    metadata JSONB DEFAULT '{}'::JSONB
);
