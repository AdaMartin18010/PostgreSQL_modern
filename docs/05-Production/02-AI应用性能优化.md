...
- [📘 AI应用性能优化完整手册](#-ai应用性能优化完整手册)
  - [📑 目录](#-目录)
  - [一、向量搜索优化](#一向量搜索优化)
    - [1.1 索引选择与调优](#11-索引选择与调优)
      - [小数据量（\<10万）](#小数据量10万)
      - [中等数据量（10万-100万）](#中等数据量10万-100万)
      - [大数据量（\>100万）](#大数据量100万)
    - [1.2 混合检索优化](#12-混合检索优化)
    - [1.3 批量查询优化](#13-批量查询优化)
  - [二、RAG应用优化](#二rag应用优化)
    - [2.1 文档分块优化](#21-文档分块优化)
    - [2.2 检索策略优化](#22-检索策略优化)
    - [2.3 LLM调用优化](#23-llm调用优化)
  - [三、模型推理优化](#三模型推理优化)
    - [3.1 模型选择](#31-模型选择)
    - [3.2 量化优化](#32-量化优化)
    - [3.3 批处理推理](#33-批处理推理)
  - [四、批处理优化](#四批处理优化)
    - [4.1 数据库批量操作](#41-数据库批量操作)
  - [五、缓存策略优化](#五缓存策略优化)
    - [5.1 多级缓存](#51-多级缓存)
  - [六、并发优化](#六并发优化)
    - [6.1 异步处理](#61-异步处理)
    - [6.2 连接池](#62-连接池)
  - [七、成本优化](#七成本优化)
    - [7.1 API vs 本地模型](#71-api-vs-本地模型)
    - [7.2 模型优化](#72-模型优化)
  - [八、综合优化案例](#八综合优化案例)
    - [案例：智能客服RAG系统](#案例智能客服rag系统)
