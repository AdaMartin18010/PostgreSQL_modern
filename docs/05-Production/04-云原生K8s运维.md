...
- [📘 云原生Kubernetes运维完整手册](#-云原生kubernetes运维完整手册)
  - [📑 目录](#-目录)
  - [一、Kubernetes部署最佳实践](#一kubernetes部署最佳实践)
    - [1.1 StatefulSet部署](#11-statefulset部署)
    - [1.2 Service配置](#12-service配置)
  - [二、Operator运维](#二operator运维)
    - [2.1 安装Zalando Postgres Operator](#21-安装zalando-postgres-operator)
    - [2.2 创建PostgreSQL集群](#22-创建postgresql集群)
    - [2.3 常用Operator操作](#23-常用operator操作)
  - [三、备份恢复](#三备份恢复)
    - [3.1 使用PgBackRest](#31-使用pgbackrest)
    - [3.2 恢复](#32-恢复)
  - [四、监控告警](#四监控告警)
    - [4.1 Prometheus监控](#41-prometheus监控)
    - [4.2 Grafana仪表板](#42-grafana仪表板)
  - [五、扩容缩容](#五扩容缩容)
    - [5.1 垂直扩容（资源）](#51-垂直扩容资源)
    - [5.2 水平扩容（副本）](#52-水平扩容副本)
  - [六、故障恢复](#六故障恢复)
    - [6.1 Pod故障](#61-pod故障)
    - [6.2 主库故障](#62-主库故障)
    - [6.3 存储故障](#63-存储故障)
  - [七、安全加固](#七安全加固)
    - [7.1 Secret管理](#71-secret管理)
    - [7.2 Network Policy](#72-network-policy)
  - [八、性能优化](#八性能优化)
    - [8.1 资源QoS](#81-资源qos)
    - [8.2 节点亲和性](#82-节点亲和性)
    - [8.3 拓扑分布](#83-拓扑分布)
