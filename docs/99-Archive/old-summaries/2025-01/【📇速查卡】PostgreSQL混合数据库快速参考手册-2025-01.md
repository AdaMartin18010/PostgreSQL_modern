...
- [【📇速查卡】PostgreSQL混合数据库快速参考手册](#速查卡postgresql混合数据库快速参考手册)
  - [📋 目录](#-目录)
  - [1. 10种数据模型速查](#1-10种数据模型速查)
    - [1.1 关系型（原生）](#11-关系型原生)
    - [1.2 文档型（JSONB）](#12-文档型jsonb)
    - [1.3 图数据库（Apache AGE）](#13-图数据库apache-age)
    - [1.4 空间数据（PostGIS）](#14-空间数据postgis)
    - [1.5 时序数据（TimescaleDB）](#15-时序数据timescaledb)
    - [1.6 全文搜索（FTS）](#16-全文搜索fts)
    - [1.7-1.10 其他模型](#17-110-其他模型)
  - [2. 4种查询语言速查](#2-4种查询语言速查)
    - [2.1 SQL（原生）](#21-sql原生)
    - [2.2 Cypher（Apache AGE）](#22-cypherapache-age)
    - [2.3 GraphQL（PostGraphile/Hasura）](#23-graphqlpostgraphilehasura)
    - [2.4 JSONPath（原生）](#24-jsonpath原生)
  - [3. 索引类型速查](#3-索引类型速查)
    - [常用索引场景](#常用索引场景)
  - [4. 性能优化速查](#4-性能优化速查)
    - [4.1 诊断工具](#41-诊断工具)
    - [4.2 立即见效的优化](#42-立即见效的优化)
    - [4.3 配置速查](#43-配置速查)
  - [5. 常用函数速查](#5-常用函数速查)
    - [5.1 JSONB函数](#51-jsonb函数)
    - [5.2 PostGIS函数](#52-postgis函数)
    - [5.3 TimescaleDB函数](#53-timescaledb函数)
    - [5.4 全文搜索函数](#54-全文搜索函数)
  - [6. 故障排查速查](#6-故障排查速查)
    - [6.1 常见问题](#61-常见问题)
      - [查询慢](#查询慢)
      - [连接数满](#连接数满)
