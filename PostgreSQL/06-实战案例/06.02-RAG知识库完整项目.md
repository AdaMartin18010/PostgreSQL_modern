...
- [PostgreSQL RAG知识库完整项目 - 企业级实现指南](#postgresql-rag知识库完整项目---企业级实现指南)
  - [📑 目录](#-目录)
  - [📊 思维导图](#-思维导图)
  - [一、项目概述](#一项目概述)
    - [1.1 核心特性](#11-核心特性)
  ...
  - [五、项目结构](#五项目结构)
  - [六、数据库设计](#六数据库设计)
    - [6.1 完整数据模型](#61-完整数据模型)
    - [6.2 核心视图和函数](#62-核心视图和函数)
  - [七、后端核心实现](#七后端核心实现)
    - [7.1 LangChain RAG链 (services/rag/chain.py)](#71-langchain-rag链-servicesragchainpy)
    - [7.2 PostgreSQL检索器 (services/rag/retriever.py)](#72-postgresql检索器-servicesragretrieverpy)
    - [7.3 对话记忆管理 (services/rag/memory.py)](#73-对话记忆管理-servicesragmemorypy)
  - [八、完整API实现](#八完整api实现)
    - [8.1 问答API (api/qa.py)](#81-问答api-apiqapy)
    - [8.2 数据摄取API (api/ingest.py)](#82-数据摄取api-apiingestpy)
  - [九、前端实现](#九前端实现)
    - [9.1 问答界面 (pages/QA.tsx)](#91-问答界面-pagesqatsx)
  - [十、生产部署](#十生产部署)
    - [10.1 Docker Compose完整配置](#101-docker-compose完整配置)
  - [十一、性能基准测试](#十一性能基准测试)
    - [11.1 PostgreSQL 18 vs 17 对比](#111-postgresql-18-vs-17-对比)
    - [11.2 企业级配置优化 (PostgreSQL 18)](#112-企业级配置优化-postgresql-18)
    - [11.3 增量备份配置 (PostgreSQL 18新特性)](#113-增量备份配置-postgresql-18新特性)
  - [十二、监控和分析](#十二监控和分析)
    - [12.1 PostgreSQL 18监控增强](#121-postgresql-18监控增强)
    - [12.2 性能指标收集](#122-性能指标收集)
  - [十三、总结](#十三总结)
    - [13.1 完整功能清单](#131-完整功能清单)
    - [13.2 性能基准](#132-性能基准)
    - [13.3 后续扩展](#133-后续扩展)
...
### 7.1 LangChain RAG链 (services/rag/chain.py)
...
### 7.2 PostgreSQL检索器 (services/rag/retriever.py)
...
### 7.3 对话记忆管理 (services/rag/memory.py)
