...
**PostgreSQL版本**: 17.0 (Released September 2024) | 18.0 (Released September 2025)
**文档类型**: 实际特性清单（非概念）
**最后更新**: 2025-11-11
**官方文档**:
...
> 📖 **AI 时代专题**: 详细 AI 特性请参考 [ai_view.md](../ai_view.md) 和 [AI 时代专题导航](../05-前沿技术/AI-时代/00-导航.md)
...
- [AI 时代专题主文档](../ai_view.md) - PostgreSQL 18 AI 特性详解
