...
**形式化定义**（带物理偏移）：
$$
\tau \triangleq \langle \underbrace{d}_{\text{数据, 偏移23+}}, \underbrace{\text{xmin}}_{\text{偏移0-3}}, \underbrace{\text{xmax}}_{\text{偏移4-7}}, \underbrace{\text{ctid}}_{\text{偏移8-13}}, \underbrace{\Psi}_{\text{infomask, 偏移14-17}} \rangle
$$
