...
- **C** = (basic, extended, incremental) 是收集策略，basic ∈ {true, false}，extended ∈ {true, false}，incremental ∈ {true, false}
- **U** = (auto, manual, scheduled) 是更新策略，auto ∈ {true, false}，manual ∈ {true, false}，scheduled ∈ {true, false}
