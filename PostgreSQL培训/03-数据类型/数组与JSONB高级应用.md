...
- [PostgreSQL 数组与 JSONB 高级应用](#postgresql-数组与-jsonb-高级应用)
  ...
  - [2. 数组与JSONB形式化定义](#2-数组与jsonb形式化定义)
    - [2.0 数组与JSONB形式化定义](#20-数组与jsonb形式化定义)
    - [2.1 数组 vs JSONB数组对比矩阵](#21-数组-vs-jsonb数组对比矩阵)
  - [3. 数组类型高级应用](#3-数组类型高级应用)
    - [3.1 数组操作符](#31-数组操作符)
    - [3.2 数组函数](#32-数组函数)
    - [3.3 数组索引](#33-数组索引)
  - [4. JSONB 高级应用](#4-jsonb-高级应用)
    - [4.1 JSONB 操作符](#41-jsonb-操作符)
    - [4.2 JSONB 函数](#42-jsonb-函数)
    - [4.3 JSONB 索引](#43-jsonb-索引)
  - [5. 实际应用案例](#5-实际应用案例)
    - [5.1 案例: 标签系统（数组应用）](#51-案例-标签系统数组应用)
    - [5.2 案例: 用户配置系统（JSONB 应用）](#52-案例-用户配置系统jsonb-应用)
  - [6. 最佳实践](#6-最佳实践)
    - [6.1 数组使用建议](#61-数组使用建议)
    - [6.2 JSONB 使用建议](#62-jsonb-使用建议)
    - [6.3 性能优化](#63-性能优化)
  - [7. 参考资料](#7-参考资料)
    - [7.1 官方文档](#71-官方文档)
