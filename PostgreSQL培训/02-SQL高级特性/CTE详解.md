...
- [PostgreSQL CTE 详解](#postgresql-cte-详解)
  ...
  - [2. CTE形式化定义](#2-cte形式化定义)
    - [2.0 CTE计算模型形式化定义](#20-cte计算模型形式化定义)
    - [2.1 CTE vs 子查询对比矩阵](#21-cte-vs-子查询对比矩阵)
    - [2.2 CTE 基础](#22-cte-基础)
    - [2.2.1 简单 CTE](#221-简单-cte)
    - [2.2.2 多个 CTE](#222-多个-cte)
    - [2.2.3 物化 CTE](#223-物化-cte)
  - [3. CTE 应用](#3-cte-应用)
