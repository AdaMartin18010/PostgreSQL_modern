...
- [PostgreSQL 多云部署策略](#postgresql-多云部署策略)
  ...
  - [📚 目录](#-目录)
  - [1. 多云部署基础](#1-多云部署基础)
    - [1.0 多云部署策略知识体系思维导图](#10-多云部署策略知识体系思维导图)
  ...
  - [10. 常见问题（FAQ）](#10-常见问题faq)
    - [10.1 多云部署基础常见问题](#101-多云部署基础常见问题)
      - [Q1: 如何实现多云部署？](#q1-如何实现多云部署)
      - [Q2: 如何优化多云部署成本？](#q2-如何优化多云部署成本)
    - [10.2 跨云同步常见问题](#102-跨云同步常见问题)
      - [Q3: 如何保证跨云数据一致性？](#q3-如何保证跨云数据一致性)
  - [📚 参考资料](#-参考资料)
  - [📚 参考资料1](#-参考资料1)
    - [官方文档](#官方文档)
    - [技术论文](#技术论文)
...
1. **配置跨云复制**：
    ...
    -- 从库在Azure
    CREATE SUBSCRIPTION azure_subscription
    CONNECTION 'host=azure-db.postgres.database.azure.com dbname=mydb user=replicator'
...
1. **选择合适的实例类型**：
    ...
    ```yaml
    # ✅ 好：选择合适的实例类型
    # AWS: db.r6g.xlarge (4 vCPU, 32GB RAM)
...
1. **使用同步复制**：
    ...
    ```sql
    -- ✅ 好：使用同步复制
    ALTER SYSTEM SET synchronous_standby_names = 'ANY 1 (azure_standby)';
    SELECT pg_reload_conf();
    -- 配置同步复制，保证数据一致性
    ```
