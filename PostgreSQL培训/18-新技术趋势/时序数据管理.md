...
- [PostgreSQL 时序数据管理](#postgresql-时序数据管理)
  ...
  - [1. 时序数据管理概述](#1-时序数据管理概述)
    - [1.0 时序数据管理知识体系思维导图](#10-时序数据管理知识体系思维导图)
  ...
  - [6. 常见问题（FAQ）](#6-常见问题faq)
    - [6.1 时序数据管理基础常见问题](#61-时序数据管理基础常见问题)
      - [Q1: 如何设计时序数据保留策略？](#q1-如何设计时序数据保留策略)
      - [Q2: 如何优化时序数据查询性能？](#q2-如何优化时序数据查询性能)
    - [6.2 数据保留常见问题](#62-数据保留常见问题)
      - [Q3: 如何实现数据归档？](#q3-如何实现数据归档)
  - [📚 参考资料](#-参考资料)
  - [📚 参考资料1](#-参考资料1)
    - [官方文档](#官方文档)
    - [技术论文](#技术论文)
...
- [Time-Series Data Management: A Survey](https://www.vldb.org/pvldb/vol15/p2658-neumann.pdf) - 时序数据管理研究综述
- [Partitioning Strategies for Time-Series Data](https://www.timescale.com/blog/) - 时序数据分区策略研究

### 技术博客

- [TimescaleDB 官方博客](https://www.timescale.com/blog/) - TimescaleDB 最新动态
- [Understanding Time-Series Data Management](https://docs.timescale.com/) - 时序数据管理详解
- [PostgreSQL Time-Series Best Practices](https://docs.timescale.com/) - PostgreSQL 时序数据最佳实践

### 社区资源

- [TimescaleDB GitHub](https://github.com/timescale/timescaledb) - TimescaleDB 开源项目
- [PostgreSQL Mailing Lists](https://www.postgresql.org/list/) - PostgreSQL 邮件列表讨论
- [Stack Overflow - Time-Series Data](https://stackoverflow.com/questions/tagged/time-series+postgresql) - Stack Overflow 相关问题
