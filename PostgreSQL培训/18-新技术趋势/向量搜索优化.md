...
- [向量搜索优化：pgvector 性能调优指南](#向量搜索优化pgvector-性能调优指南)
  ...
  - [1. 向量搜索优化概述](#1-向量搜索优化概述)
    - [1.0 向量搜索优化知识体系思维导图](#10-向量搜索优化知识体系思维导图)
  ...
  - [6. 常见问题（FAQ）](#6-常见问题faq)
    - [6.1 向量搜索性能常见问题](#61-向量搜索性能常见问题)
      - [Q1: 如何选择向量索引类型？](#q1-如何选择向量索引类型)
      - [Q2: 如何优化向量搜索查询性能？](#q2-如何优化向量搜索查询性能)
    - [6.2 索引参数调优常见问题](#62-索引参数调优常见问题)
      - [Q3: 如何调优HNSW索引参数？](#q3-如何调优hnsw索引参数)
  - [📚 参考资料](#-参考资料)
    - [官方文档](#官方文档)
    - [技术论文](#技术论文)
    - [技术博客](#技术博客)
...
2. **调整ef_construction参数**：
   - ef_construction越大，构建时间越长，但精度越高
   - 推荐值：64-128
...
- [Efficient and Robust Approximate Nearest Neighbor Search using Hierarchical Navigable Small World graphs](https://arxiv.org/abs/1603.09320) - HNSW 算法论文
- [Product Quantization for Nearest Neighbor Search](https://ieeexplore.ieee.org/document/5432202) - IVFFlat 算法基础
- [Billion-scale Similarity Search with GPUs](https://arxiv.org/abs/1702.08734) - 大规模向量搜索优化

### 技术博客

- [pgvector Performance Optimization](https://github.com/pgvector/pgvector#performance) - pgvector 性能优化
- [Understanding Vector Index Performance](https://www.postgresql.org/docs/current/indexes.html) - 向量索引性能详解
- [PostgreSQL Vector Search Best Practices](https://github.com/pgvector/pgvector) - 向量搜索最佳实践

### 社区资源

- [PostgreSQL Wiki - pgvector](https://wiki.postgresql.org/wiki/Pgvector) - pgvector 相关 Wiki
- [PostgreSQL Mailing Lists](https://www.postgresql.org/list/) - PostgreSQL 邮件列表讨论
- [Stack Overflow - pgvector](https://stackoverflow.com/questions/tagged/pgvector) - Stack Overflow 相关问题
