...
- [PostgreSQL 监控与诊断](#postgresql-监控与诊断)
  ...
  - [2. 系统监控](#2-系统监控)
    - [2.1 数据库活动监控](#21-数据库活动监控)
    - [2.2 数据库大小监控](#22-数据库大小监控)
    - [2.3 表统计信息](#23-表统计信息)
  - [3. 数据库监控](#3-数据库监控)
    - [3.1 索引使用情况](#31-索引使用情况)
    - [3.2 慢查询监控](#32-慢查询监控)
  - [4. 锁监控](#4-锁监控)
    - [4.1 查看当前锁](#41-查看当前锁)
    - [4.2 终止阻塞查询](#42-终止阻塞查询)
  - [5. 日志分析](#5-日志分析)
    - [5.1 日志配置](#51-日志配置)
    - [5.2 日志分析](#52-日志分析)
  - [6. 实际应用案例](#6-实际应用案例)
    - [6.1 案例: 生产环境性能监控系统](#61-案例-生产环境性能监控系统)
    - [6.2 案例: 慢查询自动分析系统](#62-案例-慢查询自动分析系统)
  - [7. 实践练习](#7-实践练习)
