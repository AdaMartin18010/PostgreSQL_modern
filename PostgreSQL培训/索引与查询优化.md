...
- [PostgreSQL 索引与查询优化](#postgresql-索引与查询优化)
  ...
  - [3. 索引类型](#3-索引类型)
    - [1.1 B-tree 索引（默认）](#11-b-tree-索引默认)
    - [1.2 Hash 索引](#12-hash-索引)
    - [1.3 GiST 索引](#13-gist-索引)
    - [1.4 GIN 索引](#14-gin-索引)
    - [1.5 BRIN 索引](#15-brin-索引)
  - [4. 索引创建与管理](#4-索引创建与管理)
    - [2.1 索引创建最佳实践](#21-索引创建最佳实践)
    - [2.2 索引维护](#22-索引维护)
  - [5. 查询优化技巧](#5-查询优化技巧)
    - [3.1 使用 EXPLAIN 分析](#31-使用-explain-分析)
    - [3.2 查询优化原则](#32-查询优化原则)
  - [6. EXPLAIN 分析](#6-explain-分析)
    - [4.1 理解执行计划](#41-理解执行计划)
