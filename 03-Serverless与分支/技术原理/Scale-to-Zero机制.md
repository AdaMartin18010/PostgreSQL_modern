...
- [3.1.3 Scale-to-Zero 机制](#313-scale-to-zero-机制)
  - [📑 目录](#-目录)
  - [1. 概述](#1-概述)
    - [1.1 技术背景](#11-技术背景)
    - [1.2 技术定位](#12-技术定位)
...
2. **2022 年**: Neon 将 Scale-to-Zero 引入数据库领域
3. **2023 年**: Supabase 添加 Scale-to-Zero 支持
4. **2025 年**: Scale-to-Zero 成为 Serverless 数据库标准特性
...
2. **优雅关闭**: 保存状态后关闭计算节点
3. **零成本状态**: 只保留存储，计算成本为零
4. **快速恢复**: 收到查询时快速启动计算节点
