...
- [场景化全景论证](../../mvcc01.md) - 12个递进式场景
- [形式化证明与全景论证系统](../../mvcc02.md)

### 多维度视角

- [程序员视角驱动文档](../../02-多维度视角/程序员视角/README.md) - Python/Java/Go/Node.js/ORM
- [运维视角监控体系](../../02-多维度视角/运维视角/README.md) - 监控、故障处理
- [数据库设计视角](../../02-多维度视角/数据库设计视角/README.md) - 表设计、存储优化

### 形式化论证

- [理论体系总结](../../04-形式化论证/理论论证/理论体系总结.md)
- [性能模型](../../04-形式化论证/性能模型/README.md) - 吞吐量、延迟、资源消耗
