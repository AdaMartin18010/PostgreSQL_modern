...
class AuditLogger:
    ...
    def log_query(self, user_id: str, table_name: str, operation: str,
                  query_text: str, affected_rows: int = 0, ip_address: str = None):
        """记录查询日志"""
        self.cur.execute("""
    ...
    def get_audit_logs(self, user_id: str = None, table_name: str = None,
...
class CompliantQuery:
    ...
    def execute_compliant_query(self, user_id: str, query: str,
                               table_name: str, ip_address: str = None) -> List[Dict]:
        """执行合规查询（带审计）"""
        # 检查权限（简化示例）
        # 实际应该使用pg_dsr检查数据主权
    ...
    def query_social_security(self, user_id: str, region: str = None,
