...
- [向量数据模型设计](#向量数据模型设计)
  ...
  - [7. 实际应用案例](#7-实际应用案例)
    - [7.1 案例：大型电商平台向量数据模型设计](#71-案例大型电商平台向量数据模型设计)
    - [7.2 案例：RAG系统向量数据模型设计](#72-案例rag系统向量数据模型设计)
  - [8. 参考资料](#8-参考资料)
    - [7.1 官方文档](#71-官方文档)
    - [7.2 学术论文](#72-学术论文)
    - [7.3 技术博客](#73-技术博客)
...
| 指标 | 优化前 | 优化后 | 改善 |
|------|--------|--------|------|
| **查询延迟(P99)** | 200ms | **15ms** | **93%** ⬇️ |
| **搜索准确率** | 75% | **92%** | **+23%** |
| **查询吞吐量** | 2000 QPS | **5000+ QPS** | **2.5倍** ⬆️ |
| **系统成本** | 基准 | **-40%** | **降低** |

### 7.2 案例：RAG系统向量数据模型设计
...
- **[pgvector 官方文档](https://github.com/pgvector/pgvector)**
  - 版本: pgvector 0.7.0+
  - 内容: pgvector 扩展的完整文档，包括安装、配置、使用示例
  - GitHub: <https://github.com/pgvector/pgvector>

- **[PostgreSQL 向量类型文档](https://www.postgresql.org/docs/current/vector.html)**
  - 版本: PostgreSQL 18+
  - 内容: PostgreSQL 内置向量类型的官方文档
  - 最后更新: 2025年

- **[PostgreSQL 数据类型文档](https://www.postgresql.org/docs/current/datatype.html)**
  - 内容: PostgreSQL 所有数据类型的完整文档
...
- **[向量数据库对比研究](https://www.pinecone.io/learn/vector-database/)**
  - 来源: Pinecone
  - 内容: 向量数据库的对比分析和选型指南

- **[PostgreSQL 向量搜索最佳实践](https://www.postgresql.org/docs/current/vector.html)**
  - 内容: PostgreSQL 向量搜索的使用技巧和最佳实践

### 7.4 相关资源

- **[向量数据库生态系统](https://github.com/currentsapi/awesome-vector-databases)**
  - 内容: 向量数据库相关的工具、库和资源集合

- **[PostgreSQL 扩展开发指南](https://www.postgresql.org/docs/current/extend.html)**
  - 内容: 如何开发 PostgreSQL 扩展
...
for result in results:
    print(f"文档: {result['title']}, 相似度: {result['similarity']:.4f}")
