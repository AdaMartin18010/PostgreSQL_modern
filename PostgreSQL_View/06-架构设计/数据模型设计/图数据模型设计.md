...
- [图数据模型设计](#图数据模型设计)
  ...
  - [7. 参考资料](#7-参考资料)
    ...
    - [7.4 相关资源](#74-相关资源)
  - [8. 完整代码示例](#8-完整代码示例)
    - [8.1 Apache AGE 图数据创建](#81-apache-age-图数据创建)
...
图数据模型用于表示实体间的关系，适用于社交网络、推荐系统、知识图谱等场景。
需要设计合理的图模型以支持高效的图查询。
...
- **[Apache AGE 官方文档](https://age.apache.org/)**
  - 版本: Apache AGE 1.5.0+
  - 内容: Apache AGE 图数据库扩展的完整文档
  - GitHub: <https://github.com/apache/age>

- **[Cypher 查询语言文档](https://neo4j.com/developer/cypher/)**
  - 来源: Neo4j
  - 内容: Cypher 查询语言的完整语法和示例
  - 版本: Cypher 10+

- **[PostgreSQL 图数据库扩展](https://www.postgresql.org/docs/current/contrib.html)**
  - 内容: PostgreSQL 图数据库相关的扩展和工具
...
- **Angles, R., & Gutierrez, C. (2008). "Survey of graph database models."**
  ...
  - **重要性**: 图数据库模型的综述论文，为图数据模型设计提供了理论基础

- **Robinson, I., Webber, J., & Eifrem, E. (2015). "Graph Databases: New Opportunities for Connected Data."**
  - 出版社: O'Reilly Media
  - **重要性**: 图数据库的经典著作，介绍了图数据库的设计和应用

### 7.3 技术博客

- **[图数据库选型指南](https://www.neo4j.com/blog/graph-database-comparison/)**
  - 来源: Neo4j
  - 内容: 图数据库的对比分析和选型建议

- **[Apache AGE 使用指南](https://age.apache.org/age-manual/master/intro/agetype.html)**
  - 内容: Apache AGE 的详细使用教程和最佳实践

### 7.4 相关资源

- **[图算法库](https://networkx.org/)**
  - 内容: NetworkX - Python 图算法库

- **[Cypher 查询示例](https://neo4j.com/developer/cypher/guide-cypher-basics/)**
  - 内容: Cypher 查询语言的示例和教程

---

## 8. 完整代码示例

### 8.1 Apache AGE 图数据创建
