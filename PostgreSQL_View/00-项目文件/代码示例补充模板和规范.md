...
- ✅ **可运行**: 代码应该可以直接运行（需要适当的环境配置）
- ✅ **一致性**: 代码示例与文档描述的技术方案一致
- ✅ **最佳实践**: 体现PostgreSQL、TimescaleDB、pgvector等的最佳实践
- ✅ **注释说明**: 关键代码要有中文注释，便于理解
...
6. **环境配置**: 在代码注释中说明所需的环境配置（如扩展安装）

---

**最后更新**: 2025年1月
**维护者**: PostgreSQL Modern Team
**文档编号**: 00-项目文件-代码示例模板规范-001
