...
| [02-隔离级别选择器](./02-隔离级别选择器.md) | 交互式决策树 | ✅ Beta | P0 |
...
| 工具 | 功能 | 状态 | 优先级 |
|-----|------|------|--------|
| [07-MVCC可视化调试器](./07-MVCC可视化调试器.md) | 版本链可视化 | ✅ Beta | P1 |
