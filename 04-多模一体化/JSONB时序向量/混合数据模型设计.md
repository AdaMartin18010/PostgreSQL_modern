...
```sql
-- 1. 使用连续聚合（Continuous Aggregates）
...
1. **表设计**: 合理设计表结构，平衡查询性能和存储成本
2. **索引策略**: 为常用查询创建合适索引
3. **分区策略**: 使用 TimescaleDB 自动分区管理
4. **查询优化**: 优化查询顺序，先过滤后计算
