...
```mermaid
graph TD
    A[LangChain应用] --> B[PostgreSQL Vector Store]
...
flowchart TD
    ...
    E -->|向量数据| L[使用vector_fdw]
    E -->|AI服务| M[使用ai_service_fdw]
