...
1. **性能优化**: 查看[性能调优技巧](../../01-向量与混合搜索/最佳实践/性能调优技巧.md)
...
- [pgvector 技术原理](../../01-向量与混合搜索/技术原理/pgvector核心原理.md) - pgvector Core Principles
- [TimescaleDB 架构设计](../../04-多模一体化/JSONB时序向量/混合数据模型设计.md) - TimescaleDB Architecture
