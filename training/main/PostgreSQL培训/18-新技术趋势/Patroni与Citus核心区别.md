...
- [PostgreSQL Patroni 与 Citus 核心区别](#postgresql-patroni-与-citus-核心区别)
  ...
  - [一、核心定位与本质区别](#一核心定位与本质区别)
    - [0.0 Patroni与Citus核心区别知识体系思维导图](#00-patroni与citus核心区别知识体系思维导图)
  - [二、架构与工作原理](#二架构与工作原理)
  ...
  - [9. 常见问题（FAQ）](#9-常见问题faq)
    - [9.1 Patroni与Citus区别常见问题](#91-patroni与citus区别常见问题)
      - [Q1: Patroni和Citus有什么区别？](#q1-patroni和citus有什么区别)
      - [Q2: 可以同时使用Patroni和Citus吗？](#q2-可以同时使用patroni和citus吗)
    - [9.2 选型决策常见问题](#92-选型决策常见问题)
      - [Q3: 如何选择Patroni还是Citus？](#q3-如何选择patroni还是citus)
  - [八、参考资料](#八参考资料)
    - [8.1 官方文档](#81-官方文档)
    - [8.2 相关文档](#82-相关文档)
...
### 0.0 Patroni与Citus核心区别知识体系思维导图

```mermaid
mindmap
  root((Patroni与Citus核心区别))
    核心定位
      Patroni定位
        高可用性
        故障转移
...
### 9.1 Patroni与Citus区别常见问题

#### Q1: Patroni和Citus有什么区别？

**问题描述**：不清楚Patroni和Citus的区别。
...
|------|---------|-------|
| **定位** | 高可用管理工具 | 分布式数据库扩展 |
| **功能** | 自动故障转移、集群管理 | 水平扩展、分布式查询 |
| **适用场景** | 单机或小规模集群 | 大规模数据分布式存储 |
| **数据分布** | 不涉及数据分布 | 数据分片和分布 |
| **查询方式** | 标准PostgreSQL查询 | 分布式查询 |

**选择建议**：

- **需要高可用**：选择Patroni
- **需要水平扩展**：选择Citus
- **两者都需要**：同时使用Patroni和Citus

#### Q2: 可以同时使用Patroni和Citus吗？

**问题描述**：想知道是否可以同时使用Patroni和Citus。
...
- **同时使用**：Citus集群使用Patroni实现高可用
- **分层架构**：协调节点和工作节点都使用Patroni
- **监控管理**：统一监控和管理

### 9.2 选型决策常见问题

#### Q3: 如何选择Patroni还是Citus？

**问题描述**：不知道应该选择Patroni还是Citus。
