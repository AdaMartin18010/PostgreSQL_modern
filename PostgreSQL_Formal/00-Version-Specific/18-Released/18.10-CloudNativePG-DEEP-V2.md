...
- [CloudNativePG官方文档](https://cloudnative-pg.io/documentation/)
- [Kubernetes Operators](https://kubernetes.io/docs/concepts/extend-kubernetes/operator/)
- [PostgreSQL官方文档 - 高可用](https://www.postgresql.org/docs/18/high-availability.html)
- [CMU 15-721 - Cloud Databases](https://15721.courses.cs.cmu.edu/)
