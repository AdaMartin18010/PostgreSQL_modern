...
- [数据库测试框架深度分析 v2.0](#数据库测试框架深度分析-v20)
  - [目录](#目录)
  - [摘要](#摘要)
  - [1. 测试金字塔](#1-测试金字塔)
  - [2. pgTAP测试框架](#2-pgtap测试框架)
    - [2.1 安装与配置](#21-安装与配置)
    - [2.2 单元测试示例](#22-单元测试示例)
    - [2.3 测试组织](#23-测试组织)
  - [3. 测试数据管理](#3-测试数据管理)
    - [3.1  fixtures模式](#31--fixtures模式)
  - [4. 性能测试](#4-性能测试)
    - [4.1 pgbench基准测试](#41-pgbench基准测试)
    - [4.2 存储过程性能测试](#42-存储过程性能测试)
  - [5. 持续集成](#5-持续集成)
    - [5.1 GitLab CI配置](#51-gitlab-ci配置)
