...
本项目已配置**月度链接检查自动化机制**，确保文档链接的完整性和可用性：

| 检查项 | 说明 |
|--------|------|
| **检查频率** | 每月 1 日自动运行 + PR 触发 + 手动触发 |
| **检查范围** | 所有 Markdown 文件的内部链接和锚点 |
| **报告位置** | `reports/monthly-link-report-YYYY-MM.md` |
...
# 查看详细说明
cat tools/LINK_CHECK_README.md
```

**最新报告:** [查看链接检查报告](reports/monthly-link-report-$(date +%Y-%m).md)
