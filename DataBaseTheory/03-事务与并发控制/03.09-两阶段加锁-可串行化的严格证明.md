...
- 📖 [串行化证明](../../90-事务与并发设计理论体系/03-证明与形式化/03-串行化证明.md) - 串行化理论的完整数学证明，包括冲突串行化和视图串行化
- 📖 [公理系统证明](../../90-事务与并发设计理论体系/03-证明与形式化/01-公理系统证明.md) - 三大公理的严格数学证明

**实现机制**:

- 📖 [PostgreSQL 锁机制](../../90-事务与并发设计理论体系/05-实现机制/02-PostgreSQL-锁机制.md) - PostgreSQL锁机制源码分析，包括2PL实现

**可视化与思维模型**:

- 📖 [证明树图集](../../90-事务与并发设计理论体系/07-可视化与思维模型/08-证明树图集.md) - 47+个完整证明树，包括2PL正确性证明树（16.1节）
- 📖 [决策树图集](../../90-事务与并发设计理论体系/07-可视化与思维模型/03-决策树图集.md) - 31+个实用决策树

**核心理论模型**:

- 📖 [并发控制理论统一框架](../../90-事务与并发设计理论体系/01-核心理论模型/05-并发控制理论统一框架.md) - 并发控制理论的统一框架，包括2PL理论
