...
> **📖 概念词典引用**：本文档中涉及的 MVCC、Snapshot、Isolation Level 等概念定义与 [核心概念词典](../00-理论框架总览/01-核心概念词典.md) 保持一致。如发现不一致，请以核心概念词典为准。
...
- [04 | 实时分析系统](#04--实时分析系统)
  ...
  - [五、性能测试](#五性能测试)
    ...
    - [5.2 混合负载测试](#52-混合负载测试)
      - [5.2.1 不同OLTP负载下的性能表现](#521-不同oltp负载下的性能表现)
      - [5.2.2 不同OLAP查询复杂度性能对比](#522-不同olap查询复杂度性能对比)
      - [5.2.3 混合负载详细性能数据](#523-混合负载详细性能数据)
      - [5.2.4 资源隔离效果测试](#524-资源隔离效果测试)
    - [5.3 物化视图刷新性能](#53-物化视图刷新性能)
      - [5.3.1 物化视图刷新性能详细数据](#531-物化视图刷新性能详细数据)
      - [5.3.2 增量刷新性能测试](#532-增量刷新性能测试)
      - [5.3.3 物化视图刷新对OLTP影响详细分析](#533-物化视图刷新对oltp影响详细分析)
      - [5.3.4 性能瓶颈分析](#534-性能瓶颈分析)
  - [六、优化策略](#六优化策略)
    - [6.1 查询改写](#61-查询改写)
    - [6.2 分区表策略](#62-分区表策略)
    - [6.3 并行查询](#63-并行查询)
