...
- [01 | 分层状态演化模型 (LSEM)](#01--分层状态演化模型-lsem)
  ...
  - [一、LSEM理论背景与演进](#一lsem理论背景与演进)
    ...
    - [0.1 为什么需要LSEM理论？](#01-为什么需要lsem理论)
  ...
  - [三、形式化定义](#三形式化定义)
    ...
    - [3.2 时空戳系统 (Timestamp System)](#32-时空戳系统-timestamp-system)
    - [3.3 状态转换函数 (State Transition)](#33-状态转换函数-state-transition)
    - [3.4 可见性谓词 (Visibility Predicate)](#34-可见性谓词-visibility-predicate)
